...
namespace SkeletalMeshGizmoUtils
{
	 ...
	 */
	TLLRN_SKELETALMESHMODELINGTOOLS_API bool RegisterTransformGizmoContextObject(UInteractiveToolsContext* InToolsContext);
	 ...
	 */
	TLLRN_SKELETALMESHMODELINGTOOLS_API bool UnregisterTransformGizmoContextObject(UInteractiveToolsContext* InToolsContext);

	/**
	 * Spawn an editor like Transform Gizmo. ToolManager's ToolsContext must have a USkeletalMeshGizmoContextObject registered 
	 */
	TLLRN_SKELETALMESHMODELINGTOOLS_API UTransformGizmo* CreateTransformGizmo(UInteractiveToolManager* ToolManager, void* Owner = nullptr);
}
...
UCLASS()
class TLLRN_SKELETALMESHMODELINGTOOLS_API USkeletalMeshGizmoWrapper : public USkeletalMeshGizmoWrapperBase
{
	GENERATED_BODY()
public:
...
UCLASS()
class TLLRN_SKELETALMESHMODELINGTOOLS_API USkeletalMeshGizmoContextObject : public USkeletalMeshGizmoContextObjectBase
{
	GENERATED_BODY()
