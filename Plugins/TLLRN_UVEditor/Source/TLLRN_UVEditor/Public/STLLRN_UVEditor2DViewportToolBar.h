...
class STLLRN_UVEditor2DViewport;
class FTLLRN_UVEditor2DViewportClient;

/**
 * Toolbar that shows up at the top of the 2d viewport (has gizmo controls)
 */
class STLLRN_UVEditor2DViewportToolBar : public SViewportToolBar
{
public:
	SLATE_BEGIN_ARGS(STLLRN_UVEditor2DViewportToolBar) {}
		SLATE_ARGUMENT(TSharedPtr<FUICommandList>, CommandList)
		SLATE_ARGUMENT(TSharedPtr<FExtender>, Extenders)
		SLATE_ARGUMENT(TSharedPtr<FTLLRN_UVEditor2DViewportClient>, Viewport2DClient)
	SLATE_END_ARGS()
...
private:
	...
	TSharedPtr<FTLLRN_UVEditor2DViewportClient> Viewport2DClient;
