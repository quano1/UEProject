...
#include "TLLRN_UVEditorDistortionVisualization.generated.h"

UENUM()
enum class ETLLRN_DistortionMetric : uint8
{
...
/**
 * Visualization settings for the UTLLRN_UVEditorDistortionVisualization
 */
UCLASS()
class TLLRN_UVEDITOR_API UTLLRN_UVEditorDistortionVisualizationProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()
public:
	...
	ETLLRN_DistortionMetric Metric = ETLLRN_DistortionMetric::ReedBeta;
	...
	//~UPROPERTY(EditAnywhere, Category = "Distortion Visualization|Texel Density", meta = (DisplayName = "Use Average Baseline", EditCondition = "Metric == ETLLRN_DistortionMetric::TexelDensity"))
	...
	UPROPERTY(EditAnywhere, Category = "Distortion Visualization|Texel Density", meta = (DisplayName = "Use UDIM Resolutions", EditCondition = "Metric == ETLLRN_DistortionMetric::TexelDensity"))
	bool bRespectUDIMTextureResolutions = false;

	//~ TODO - Enable support for manual density specificaitons at a future date
	//~UPROPERTY(EditAnywhere, Category = "Distortion Visualization|Texel Density", meta = (DisplayName = "Texture Map Dimension", EditCondition = "!bCompareToAverageDensity && !bRespectUDIMTextureResolutions && Metric == ETLLRN_DistortionMetric::TexelDensity"))

	UPROPERTY()
	int32 MapSize;

	//~ TODO - Enable support for manual density specificaitons at a future date	
	//~UPROPERTY(EditAnywhere, Category = "Distortion Visualization|Texel Density", meta = (DisplayName = "Target Texel Density", EditCondition = "!bCompareToAverageDensity && Metric == ETLLRN_DistortionMetric::TexelDensity", ClampMin = 0.0, UIMin = 0.0))
 ...
 */
UCLASS(Transient)
class TLLRN_UVEDITOR_API UTLLRN_UVEditorDistortionVisualization : public UObject
{
	GENERATED_BODY()
...
public:
	...
	UPROPERTY()
	TObjectPtr<UTLLRN_UVEditorDistortionVisualizationProperties> Settings;
