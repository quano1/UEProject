...
#include "TLLRN_UVEditor.generated.h"
...
class UPreviewMesh;
class UTLLRN_UVEditorToolTargetManager;
class UToolTarget;
class UTLLRN_UVEditorMode;
class ITLLRN_UVUnwrapDynamicMesh;
 ...
 */
UCLASS()
class TLLRN_UVEDITOR_API UTLLRN_UVEditor : public UAssetEditor
{
	GENERATED_BODY()
...
protected:
	...
	friend class UTLLRN_UVEditorSubsystem;
};
