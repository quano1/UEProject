 ...
 */
UCLASS()
class TLLRN_UVEDITOR_API UTLLRN_UVEditorSubsystem : public UEditorSubsystem
{
	GENERATED_BODY()
...
public:
	 ...
	 * objects.
	 */
	virtual void StartTLLRN_UVEditor(TArray<TObjectPtr<UObject>> ObjectsToEdit);
	 ...
	 */
	virtual void NotifyThatTLLRN_UVEditorClosed(TArray<TObjectPtr<UObject>> ObjectsItWasEditing);
...
protected:
	...
	TMap<TObjectPtr<UObject>, TObjectPtr<UTLLRN_UVEditor>> OpenedEditorInstances;
};