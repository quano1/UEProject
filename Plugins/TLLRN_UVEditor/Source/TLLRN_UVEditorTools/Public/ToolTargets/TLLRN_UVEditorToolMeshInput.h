...
#include "TLLRN_UVEditorToolMeshInput.generated.h"
 ...
 */
UCLASS()
class TLLRN_UVEDITORTOOLS_API UTLLRN_UVEditorToolMeshInput : public UToolTarget
{
	GENERATED_BODY()
...
public:
	...
	*/
	 ...
	 */
	DECLARE_MULTICAST_DELEGATE_TwoParams(FOnObjectModified, UTLLRN_UVEditorToolMeshInput* InputObject, const FCanonicalModifiedInfo&);
	...
	//  need updating, respectively. Passing UTLLRN_UVEditorToolMeshInput::NONE_CHANGED_ARG is equivalent to passing a pointer 
