...
#include "TLLRN_UVEditorSeamTool.generated.h"
...
class UTLLRN_UVToolLivePreviewAPI;

PREDECLARE_GEOMETRY(class FDynamicMesh);

UENUM()
enum class ETLLRN_UVEditorSeamMode : uint8
{
...
UCLASS()
class TLLRN_UVEDITORTOOLS_API UTLLRN_UVEditorSeamToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()
...
public:
	...
	ETLLRN_UVEditorSeamMode Mode = ETLLRN_UVEditorSeamMode::Cut;
...
UCLASS()
class TLLRN_UVEDITORTOOLS_API UTLLRN_UVEditorSeamToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
public:
...
UCLASS()
class TLLRN_UVEDITORTOOLS_API UTLLRN_UVEditorSeamTool : public UInteractiveTool,
...
protected:
	...
	UPROPERTY()
	TObjectPtr< UTLLRN_UVEditorSeamToolProperties> Settings = nullptr;
...
private:
	void GetVidPath(const UTLLRN_UVEditorToolMeshInput& Target, bool bUnwrapMeshSource,
