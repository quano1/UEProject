...
#include "TLLRN_UVEditorToolBase.h" // ITLLRN_UVEditorGenericBuildableTool
...
#include "TLLRN_UVEditorBrushSelectTool.generated.h"
...
UCLASS()
class UTLLRN_UVEditorBrushSelectToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()
...
//~ We could potentially fold this tool's functionality into the TLLRN_UVSelectTool as a sub activity
//~  of some kind.
/**
 ...
 */
UCLASS()
class TLLRN_UVEDITORTOOLS_API UTLLRN_UVEditorBrushSelectTool : public UInteractiveTool
	, public IInteractiveToolNestedAcceptCancelAPI
	, public ITLLRN_UVToolSupportsSelection
	, public ITLLRN_UVEditorGenericBuildableTool
{
	GENERATED_BODY()
...
public:
	...
	// ITLLRN_UVEditorGenericBuildableTool
...
private:
	...
	TWeakObjectPtr<const UTLLRN_UVEditorMeshSelectionMechanic> SelectionMechanic = nullptr;
	...
	UPROPERTY()
	TObjectPtr<UTLLRN_UVEditorBrushSelectToolProperties> Settings = nullptr;
	...
	TArray<UTLLRN_UVEditorMeshSelectionMechanic::FRaycastResult> PendingLivePreviewHits;
