...
#include "TLLRN_BasicPointSetComponent.generated.h"

class FBasicPointSetSceneProxy;


/**
 * UTLLRN_Basic2DPointSetComponent and UTLLRN_Basic3DPointSetComponent are components that draw a set of points as small squares. The 2D version stores XY coordinates with
 ...
 *
 * To support both 2D and 3D with minimal code duplication, the point set components are composed from the UTLLRN_BasicPointSetComponentBase class for the component
 ...
 * functionality. The final derived classes UTLLRN_Basic2DPointSetComponent and UTLLRN_Basic3DPointSetComponent contain identical boilerplate code to facilitate calls that
...
UCLASS()
class TLLRN_UVEDITORTOOLS_API UTLLRN_BasicPointSetComponentBase : public UMeshComponent
{
	GENERATED_BODY()

public:

	UTLLRN_BasicPointSetComponentBase();
...
UCLASS()
class TLLRN_UVEDITORTOOLS_API UTLLRN_Basic2DPointSetComponent final : public UTLLRN_BasicPointSetComponentBase, public TBasicElementSet<FVector2f, 1>
{
	GENERATED_BODY()
...
UCLASS()
class TLLRN_UVEDITORTOOLS_API UTLLRN_Basic3DPointSetComponent final : public UTLLRN_BasicPointSetComponentBase, public TBasicElementSet<FVector3f, 1>
{
	GENERATED_BODY()
