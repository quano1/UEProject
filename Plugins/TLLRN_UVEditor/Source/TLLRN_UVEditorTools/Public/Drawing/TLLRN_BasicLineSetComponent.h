...
#include "TLLRN_BasicLineSetComponent.generated.h"

class FBasicLineSetSceneProxy;


/**
 * UTLLRN_Basic2DLineSetComponent and UTLLRN_Basic3DLineSetComponent are components that draw a set of lines as small squares. The 2D version stores XY coordinates with
 ...
 *
 * To support both 2D and 3D with minimal code duplication, the line set components are composed from the UTLLRN_TLLRN_BasicLineSetComponentBase class for the component
 ...
 * functionality. The final derived classes UTLLRN_Basic2DLineSetComponent and UTLLRN_Basic3DLineSetComponent contain identical boilerplate code to facilitate calls that
...
UCLASS()
class TLLRN_UVEDITORTOOLS_API UTLLRN_TLLRN_BasicLineSetComponentBase : public UMeshComponent
{
	GENERATED_BODY()

public:

	UTLLRN_TLLRN_BasicLineSetComponentBase();
...
UCLASS()
class TLLRN_UVEDITORTOOLS_API UTLLRN_Basic2DLineSetComponent final : public UTLLRN_TLLRN_BasicLineSetComponentBase, public TBasicElementSet<FVector2f, 2>
{
	GENERATED_BODY()
...
UCLASS()
class TLLRN_UVEDITORTOOLS_API UTLLRN_Basic3DLineSetComponent final : public UTLLRN_TLLRN_BasicLineSetComponentBase, public TBasicElementSet<FVector3f, 2>
{
	GENERATED_BODY()
