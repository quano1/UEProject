...
#include "TLLRN_BasicTriangleSetComponent.generated.h"

class FBasicTriangleSetSceneProxy;


/**
 * UTLLRN_Basic2DTriangleSetComponent and UTLLRN_Basic3DTriangleSetComponent are components that draw a set of lines as small squares. The 2D version stores XY coordinates with
 ...
 *
 * To support both 2D and 3D with minimal code duplication, the line set components are composed from the UTLLRN_BasicTriangleSetComponentBase class for the component
 ...
 * functionality. The final derived classes UTLLRN_Basic2DTriangleSetComponent and UTLLRN_Basic3DTriangleSetComponent contain identical boilerplate code to facilitate calls that
...
UCLASS()
class TLLRN_UVEDITORTOOLS_API UTLLRN_BasicTriangleSetComponentBase : public UMeshComponent
{
	GENERATED_BODY()

public:

	UTLLRN_BasicTriangleSetComponentBase();
...
UCLASS()
class TLLRN_UVEDITORTOOLS_API UTLLRN_Basic2DTriangleSetComponent final : public UTLLRN_BasicTriangleSetComponentBase, public TBasicElementSet<FVector2f, 3>
{
	GENERATED_BODY()
...
UCLASS()
class TLLRN_UVEDITORTOOLS_API UTLLRN_Basic3DTriangleSetComponent final : public UTLLRN_BasicTriangleSetComponentBase, public TBasicElementSet<FVector3f, 3>
{
	GENERATED_BODY()
