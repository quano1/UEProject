...
#include "TLLRN_UVEditorUVSnapshotTool.generated.h"


// Forward Declarations
class UTLLRN_UVEditorBakeUVShellProperties;

/**
 * ToolBuilder
 */
UCLASS()
class TLLRN_UVEDITORTOOLS_API UTLLRN_UVEditorUVSnapshotToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
public:
 ...
 */
UCLASS()
class TLLRN_UVEDITORTOOLS_API UTLLRN_UVEditorUVSnapshotTool : public UInteractiveTool, public ITLLRN_UVToolSupportsSelection, public UE::Geometry::IGenericDataOperatorFactory<UE::Geometry::FMeshMapBaker>
{
	GENERATED_BODY()
public:
	 ...
	 */
	virtual void SetTarget(const TObjectPtr<UTLLRN_UVEditorToolMeshInput>& TargetIn)
	{
		Target = TargetIn;
	}
private:
	...
	//
	UPROPERTY()
	TObjectPtr<UTLLRN_UVEditorToolMeshInput> Target;

	//
	// Property set for bake and result
	//
	UPROPERTY()
	TObjectPtr<UTLLRN_UVEditorBakeUVShellProperties> UVShellSettings;
...
UCLASS()
class TLLRN_UVEDITORTOOLS_API UTLLRN_UVEditorBakeUVShellProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()
public:
