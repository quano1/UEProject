...
#include "TLLRN_UVToolContextObjects.generated.h"
 ...
 */
UCLASS()
class TLLRN_UVEDITORTOOLS_API UTLLRN_UVToolContextObject : public UObject
{
	GENERATED_BODY()
public:
	/**
 ...
 */
UCLASS()
class TLLRN_UVEDITORTOOLS_API UTLLRN_UVToolEmitChangeAPI : public UTLLRN_UVToolContextObject
{
	GENERATED_BODY()
public:
	 ...
	 */
	virtual void EmitToolIndependentUnwrapCanonicalChange(UTLLRN_UVEditorToolMeshInput* InputObject,
 ...
 */
UCLASS()
class TLLRN_UVEDITORTOOLS_API UTLLRN_UVToolLivePreviewAPI : public UTLLRN_UVToolContextObject
{
	GENERATED_BODY()
public:
...
USTRUCT()
struct TLLRN_UVEDITORTOOLS_API FTLLRN_UDIMBlock
{
	GENERATED_BODY();
 ...
 */
UCLASS()
class TLLRN_UVEDITORTOOLS_API UTLLRN_UVTool2DViewportAPI : public UTLLRN_UVToolContextObject
{
	GENERATED_BODY()
public:

	void SetTLLRN_UDIMBlocks(TArray<FTLLRN_UDIMBlock>& BlocksIn, bool bBroadcast = true)
	{
		TLLRN_UDIMBlocks = BlocksIn;
		if (bBroadcast)
		{
			OnTLLRN_UDIMBlockChange.Broadcast(TLLRN_UDIMBlocks);
		}
	}

	const TArray<FTLLRN_UDIMBlock>& GetTLLRN_UDIMBlocks() const
	{
		return TLLRN_UDIMBlocks;
	}
	...
	DECLARE_MULTICAST_DELEGATE_OneParam(FOnTLLRN_UDIMBlockChange, const TArray<FTLLRN_UDIMBlock>& TLLRN_UDIMBlocks);
	FOnTLLRN_UDIMBlockChange OnTLLRN_UDIMBlockChange;
...
protected:
	...
	UPROPERTY(Transient)
	TArray<FTLLRN_UDIMBlock> TLLRN_UDIMBlocks;
...
*/
UCLASS()
class TLLRN_UVEDITORTOOLS_API UTLLRN_UVToolAssetAndChannelAPI : public UTLLRN_UVToolContextObject
{
	GENERATED_BODY()
public:
 ...
 */
UCLASS()
class TLLRN_UVEDITORTOOLS_API UTLLRN_UVToolAABBTreeStorage : public UTLLRN_UVToolContextObject
{
	GENERATED_BODY()
public:
...
protected:
	...
	using TreeInputObjectPair = TPair<TSharedPtr<FDynamicMeshAABBTree3>, TWeakObjectPtr<UTLLRN_UVEditorToolMeshInput>>;
...
/**
* Stores pointers to additional property sets for the active tool, used by the TLLRN_UVEditor Mode and Toolkit to 
* populate other settings menus, such as the Display menu.
*/

UCLASS()
class TLLRN_UVEDITORTOOLS_API UTLLRN_UVEditorToolPropertiesAPI : public UTLLRN_UVToolContextObject
{
	GENERATED_BODY()
public:
