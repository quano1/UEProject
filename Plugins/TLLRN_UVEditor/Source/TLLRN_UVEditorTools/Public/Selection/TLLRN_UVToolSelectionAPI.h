...
#include "TLLRN_UVToolSelectionAPI.generated.h"

class UTLLRN_UVEditorMechanicAdapterTool;
class UTLLRN_UVEditorMeshSelectionMechanic;
class UTLLRN_UVToolSelectionHighlightMechanic;
 ...
 */
UCLASS()
class TLLRN_UVEDITORTOOLS_API UTLLRN_UVToolSelectionAPI : public UTLLRN_UVToolContextObject
{
	GENERATED_BODY()
public:
	 ...
	 */
	enum class ETLLRN_UVEditorSelectionMode
	{
	 ...
	 */
	const UTLLRN_UVEditorMeshSelectionMechanic* GetSelectionMechanic() const { return SelectionMechanic; }
	 ...
	 */
	void SetSelectionMechanicMode(ETLLRN_UVEditorSelectionMode Mode, 
	 ...
	 * itself. Expects UTLLRN_UVToolSelectionAPI to be the associated UObject.
	 */
	...
	void Initialize(UInteractiveToolManager* ToolManagerIn, UWorld* UnwrapWorld,
		UInputRouter* UnwrapInputRouterIn, UTLLRN_UVToolLivePreviewAPI* LivePreviewAPI,
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UTLLRN_UVEditorMechanicAdapterTool> MechanicAdapter = nullptr;

	UPROPERTY()
	TObjectPtr<UTLLRN_UVToolSelectionHighlightMechanic> HighlightMechanic = nullptr;
...
// UInterface for ITLLRN_UVToolSupportsSelection
UINTERFACE(MinimalAPI)
class UTLLRN_UVToolSupportsSelection : public UInterface
{
	GENERATED_BODY()
};

/**
 * If a tool does not inherit from ITLLRN_UVToolSupportsSelection, then selection
 ...
 * If a tool does inherit from ITLLRN_UVToolSupportsSelection, then the UV editor will
 ...
 */
class ITLLRN_UVToolSupportsSelection
{
	GENERATED_BODY()
