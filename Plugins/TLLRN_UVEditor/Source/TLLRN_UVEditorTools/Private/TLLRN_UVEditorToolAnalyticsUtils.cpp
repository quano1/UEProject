...
FString TLLRN_UVEditorAnalyticsEventName(const FString& ToolEventName)
{
	return FString::Printf(TEXT("Editor.Usage.TLLRN_UVEditor.%s"), *ToolEventName);
}
...
FTargetAnalytics CollectTargetAnalytics(const TArray<TObjectPtr<UTLLRN_UVEditorToolMeshInput>>& Targets)
{
