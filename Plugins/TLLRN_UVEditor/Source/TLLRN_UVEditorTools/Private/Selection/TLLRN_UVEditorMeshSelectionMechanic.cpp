...
#include UE_INLINE_GENERATED_CPP_BY_NAME(TLLRN_UVEditorMeshSelectionMechanic)

using namespace UE::Geometry;

#define LOCTEXT_NAMESPACE "UTLLRN_UVEditorMeshSelectionMechanic"

namespace TLLRN_UVEditorMeshSelectionMechanicLocals
{
	...
	FAxisAlignedBox2d GetRectangleXY(const FCameraRectangle& CameraRectangle)
	{
		...
		// This works because we know the UV axes are aligned with the XY axes, see the comment in UTLLRN_UVEditorMode::InitializeTargets
	...
	*/ 
	...
	public:
		...
		{
			UTLLRN_UVEditorMeshSelectionMechanic* SelectionMechanic = Cast<UTLLRN_UVEditorMeshSelectionMechanic>(Object);
		...
		{
			return TEXT("TLLRN_UVEditorMeshSelectionMechanicLocals::FModeChange");
		}
...
void UTLLRN_UVEditorMeshSelectionMechanic::Setup(UInteractiveTool* ParentToolIn)
{
	...
	MarqueeMechanic->OnDragRectangleStarted.AddUObject(this, &UTLLRN_UVEditorMeshSelectionMechanic::OnDragRectangleStarted);
	...
	//MarqueeMechanic->OnDragRectangleChanged.AddUObject(this, &UTLLRN_UVEditorMeshSelectionMechanic::OnDragRectangleChanged);
	...
	ViewportButtonsAPI->OnSelectionModeChange.AddWeakLambda(this,
		[this](UTLLRN_UVToolSelectionAPI::ETLLRN_UVEditorSelectionMode NewMode) {
	...
	LivePreviewMarqueeMechanic->OnDragRectangleStarted.AddUObject(this, &UTLLRN_UVEditorMeshSelectionMechanic::OnDragRectangleStarted);
	// TODO(Performance) :DynamicMarqueeSelection It would be cool to have the marquee selection update dynamically as
	//  the rectangle gets changed, right now this isn't interactive for large meshes so we disabled it
	//LivePreviewMarqueeMechanic->OnDragRectangleChanged.AddUObject(this, &UTLLRN_UVEditorMeshSelectionMechanic::OnDragRectangleChanged);
...
void UTLLRN_UVEditorMeshSelectionMechanic::Initialize(UWorld* World, UWorld* LivePreviewWorld, UTLLRN_UVToolSelectionAPI* SelectionAPIIn)
{
...
void UTLLRN_UVEditorMeshSelectionMechanic::SetIsEnabled(bool bIsEnabledIn)
{
...
TArray<UE::Geometry::FUVToolSelection> UTLLRN_UVEditorMeshSelectionMechanic::GetAllCanonicalTrianglesInUnwrapRadius(
	const FVector2d& UnwrapWorldHitPoint, double Radius) const
{
	using namespace TLLRN_UVEditorMeshSelectionMechanicLocals;
...
void UTLLRN_UVEditorMeshSelectionMechanic::SetShowHoveredElements(bool bShow)
{
...
void UTLLRN_UVEditorMeshSelectionMechanic::Shutdown()
{
...
void UTLLRN_UVEditorMeshSelectionMechanic::SetTargets(const TArray<TObjectPtr<UTLLRN_UVEditorToolMeshInput>>& TargetsIn)
{
	Targets = TargetsIn;
...
TSharedPtr<FDynamicMeshAABBTree3> UTLLRN_UVEditorMeshSelectionMechanic::GetMeshSpatial(int32 TargetId, bool bUseUnwrap) const
{
	if (bUseUnwrap)
	{
...
void UTLLRN_UVEditorMeshSelectionMechanic::Render(IToolsContextRenderAPI* RenderAPI)
{
...
void UTLLRN_UVEditorMeshSelectionMechanic::DrawHUD(FCanvas* Canvas, IToolsContextRenderAPI* RenderAPI)
{
	MarqueeMechanic->DrawHUD(Canvas, RenderAPI);
}

void UTLLRN_UVEditorMeshSelectionMechanic::LivePreviewRender(IToolsContextRenderAPI* RenderAPI)
{
	LivePreviewMarqueeMechanic->Render(RenderAPI);
}

void UTLLRN_UVEditorMeshSelectionMechanic::LivePreviewDrawHUD(FCanvas* Canvas, IToolsContextRenderAPI* RenderAPI)
{
	LivePreviewMarqueeMechanic->DrawHUD(Canvas, RenderAPI);
}

FInputRayHit UTLLRN_UVEditorMeshSelectionMechanic::IsHitByClick(const FInputDeviceRay& ClickPos, bool bSourceIsLivePreview)
{
	FInputRayHit Hit;
...
void UTLLRN_UVEditorMeshSelectionMechanic::SetSelectionMode(
...
void UTLLRN_UVEditorMeshSelectionMechanic::ModifyExistingSelection(TSet<int32>& SelectionSetToModify, 
...
void UTLLRN_UVEditorMeshSelectionMechanic::OnClicked(const FInputDeviceRay& ClickPos, bool bSourceIsLivePreview)
{
...
bool UTLLRN_UVEditorMeshSelectionMechanic::GetHitTid(const FInputDeviceRay& ClickPos,
...
bool UTLLRN_UVEditorMeshSelectionMechanic::RaycastCanonicals(const FRay& WorldRay, bool bRaycastIsForUnwrap,
...
void UTLLRN_UVEditorMeshSelectionMechanic::OnDragRectangleStarted()
{
	using namespace TLLRN_UVEditorMeshSelectionMechanicLocals;
...
void UTLLRN_UVEditorMeshSelectionMechanic::OnDragRectangleChanged(const FCameraRectangle& CurrentRectangle, bool bSourceIsLivePreview)
{
...
void UTLLRN_UVEditorMeshSelectionMechanic::OnDragRectangleFinished(const FCameraRectangle& CurrentRectangle, bool bCancelled, bool bSourceIsLivePreview)
{
...
void UTLLRN_UVEditorMeshSelectionMechanic::OnUpdateModifierState(int ModifierID, bool bIsOn)
{
	switch (ModifierID)
	{
...
FInputRayHit UTLLRN_UVEditorMeshSelectionMechanic::BeginHoverSequenceHitTest(const FInputDeviceRay& PressPos, bool bSourceIsLivePreview)
{
	FInputRayHit Hit;
...
void UTLLRN_UVEditorMeshSelectionMechanic::OnBeginHover(const FInputDeviceRay& DevicePos)
{
}

bool UTLLRN_UVEditorMeshSelectionMechanic::OnUpdateHover(const FInputDeviceRay& DevicePos, bool bSourceIsLivePreview)
{
	using namespace TLLRN_UVEditorMeshSelectionMechanicLocals;
	...
	auto SetupVertexHighlight = [](TArray<int32>& IDs, FDynamicMesh3& Mesh, UPointSetComponent& PointSet, FTransform3d Transform = FTransform3d::Identity)
	{
		for (int32 ID : IDs)
		{
			...
			const FRenderablePoint PointToRender(P,
				FTLLRN_UVEditorUXSettings::SelectionHoverTriangleWireframeColor,
	...
	auto SetupEdgeHighlight = [](TArray<int32>& IDs, FDynamicMesh3& Mesh, ULineSetComponent& LineSet, FTransform3d Transform = FTransform3d::Identity)
	{
		for (int32 ID : IDs)
		{
			...
			LineSet.AddLine(A, B,
				...
				FTLLRN_UVEditorUXSettings::SelectionHoverWireframeDepthBias);
		}
	};
	...
	auto SetupTriangleHighlight = [this, &UnwrapMesh, &Tid](FDynamicMesh3& Mesh, ULineSetComponent& LineSet, UTriangleSetComponent& TriangleSet, FTransform3d Transform = FTransform3d::Identity)
	{
		...
		LineSet.AddLine(A, B, FTLLRN_UVEditorUXSettings::SelectionHoverTriangleWireframeColor,
			FTLLRN_UVEditorUXSettings::SelectionLineThickness, FTLLRN_UVEditorUXSettings::SelectionHoverWireframeDepthBias);
		LineSet.AddLine(B, C, FTLLRN_UVEditorUXSettings::SelectionHoverTriangleWireframeColor,
			FTLLRN_UVEditorUXSettings::SelectionLineThickness, FTLLRN_UVEditorUXSettings::SelectionHoverWireframeDepthBias);
		LineSet.AddLine(C, A, FTLLRN_UVEditorUXSettings::SelectionHoverTriangleWireframeColor,
			FTLLRN_UVEditorUXSettings::SelectionLineThickness, FTLLRN_UVEditorUXSettings::SelectionHoverWireframeDepthBias);
		TriangleSet.AddTriangle(A, B, C, FVector::ZAxisVector,
			FTLLRN_UVEditorUXSettings::SelectionHoverTriangleFillColor, HoverTriangleSetMaterial);
	};
...
void UTLLRN_UVEditorMeshSelectionMechanic::OnEndHover()
{
