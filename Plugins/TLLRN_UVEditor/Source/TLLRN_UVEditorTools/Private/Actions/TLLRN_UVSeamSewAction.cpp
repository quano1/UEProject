...
#include UE_INLINE_GENERATED_CPP_BY_NAME(TLLRN_UVSeamSewAction)


#define LOCTEXT_NAMESPACE "UTLLRN_UVSeamSewAction"

using namespace UE::Geometry;

int32 UTLLRN_UVSeamSewAction::FindSewEdgeOppositePairing(const FDynamicMesh3& UnwrapMesh, const FDynamicMesh3& AppliedMesh, 
...
bool UTLLRN_UVSeamSewAction::CanExecuteAction() const
{
	return SelectionAPI->HaveSelections()
		&& SelectionAPI->GetSelectionsType() == FUVToolSelection::EType::Edge;
}

bool UTLLRN_UVSeamSewAction::ExecuteAction()
{
	TRACE_CPUPROFILER_EVENT_SCOPE(TLLRN_UVSeamSewAction_ExecuteAction);
