...
#include UE_INLINE_GENERATED_CPP_BY_NAME(TLLRN_UVSplitAction)


#define LOCTEXT_NAMESPACE "UTLLRN_UVSplitAction"

using namespace UE::Geometry;

namespace TLLRN_UVSplitActionLocals
{
	bool ApplySplitEdges(const FUVToolSelection& Selection, FUVToolSelection& NewSelectionOut, 
		UTLLRN_UVToolEmitChangeAPI& EmitChangeAPI, const FText& TransactionName)
	{
		...
		FDynamicMeshUVEditor TLLRN_UVEditor(Target->AppliedCanonical.Get(),
			Target->UVLayerIndex, false);
		TLLRN_UVEditor.CreateSeamsAtEdges(AppliedEidSet, &UVEditResult);
...
bool UTLLRN_UVSplitAction::CanExecuteAction() const
{
...
bool UTLLRN_UVSplitAction::ExecuteAction()
{
	using namespace TLLRN_UVSplitActionLocals;
