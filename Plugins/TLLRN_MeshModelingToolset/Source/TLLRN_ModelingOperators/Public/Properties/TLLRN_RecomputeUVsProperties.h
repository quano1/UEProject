...
#include "TLLRN_RecomputeUVsProperties.generated.h"


UENUM()
enum class ETLLRN_RecomputeUVsPropertiesUnwrapType
{
...
UENUM()
enum class ETLLRN_RecomputeUVsPropertiesIslandMode
{
...
UENUM()
enum class ETLLRN_RecomputeUVsToolOrientationMode
{
...
UENUM()
enum class ETLLRN_RecomputeUVsPropertiesLayoutType
{
...
UCLASS()
class TLLRN_MODELINGOPERATORS_API UTLLRN_RecomputeUVsToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()
public:
	...
	ETLLRN_RecomputeUVsPropertiesIslandMode IslandGeneration = ETLLRN_RecomputeUVsPropertiesIslandMode::ExistingUVs;

	/** Type of UV flattening algorithm to use */
	UPROPERTY(EditAnywhere, Category = "UV Unwrap")
	ETLLRN_RecomputeUVsPropertiesUnwrapType UnwrapType = ETLLRN_RecomputeUVsPropertiesUnwrapType::SpectralConformal;

	/** Type of automatic rotation applied to each UV island */
	UPROPERTY(EditAnywhere, Category = "UV Unwrap")
	ETLLRN_RecomputeUVsToolOrientationMode AutoRotation = ETLLRN_RecomputeUVsToolOrientationMode::MinBounds;
	...
	UPROPERTY(EditAnywhere, Category = "UV Unwrap", meta = (EditCondition = "UnwrapType == ETLLRN_RecomputeUVsPropertiesUnwrapType::SpectralConformal", EditConditionHides, HideEditConditionToggle))
	...
	UPROPERTY(EditAnywhere, Category = "UV Unwrap", meta = (UIMin = "0", UIMax = "25", ClampMin = "0", ClampMax = "1000",
		EditCondition = "UnwrapType == ETLLRN_RecomputeUVsPropertiesUnwrapType::ExpMap || UnwrapType == ETLLRN_RecomputeUVsPropertiesUnwrapType::IslandMerging", EditConditionHides, HideEditConditionToggle))
	...
	UPROPERTY(EditAnywhere, Category = "UV Unwrap", meta = (DisplayName = "Distortion Threshold", UIMin = "1.0", UIMax = "5.0", ClampMin = "1.0",
		EditCondition = "UnwrapType == ETLLRN_RecomputeUVsPropertiesUnwrapType::IslandMerging", EditConditionHides, HideEditConditionToggle))
	...
	ETLLRN_RecomputeUVsPropertiesLayoutType LayoutType = ETLLRN_RecomputeUVsPropertiesLayoutType::Repack;
	...
	UPROPERTY(EditAnywhere, Category = "UV Layout", meta = (UIMin = "64", UIMax = "2048", ClampMin = "2", ClampMax = "4096",
		EditCondition = "LayoutType == ETLLRN_RecomputeUVsPropertiesLayoutType::Repack", EditConditionHides, HideEditConditionToggle))
	...
	UPROPERTY(EditAnywhere, Category = "UV Layout", meta = (UIMin = "0.001", UIMax = "10", ClampMin = "0.00001", ClampMax = "1000000.0",
		EditCondition = "LayoutType == ETLLRN_RecomputeUVsPropertiesLayoutType::NormalizeToBounds || LayoutType == ETLLRN_RecomputeUVsPropertiesLayoutType::NormalizeToWorld", EditConditionHides, HideEditConditionToggle))
