...
#include "TLLRN_UVLayoutProperties.generated.h"

/**
 * UV Layout Strategies for the UV Layout Tool
 */
UENUM()
enum class ETLLRN_UVLayoutType
{
 ...
 */
UCLASS()
class TLLRN_MODELINGOPERATORS_API UTLLRN_UVLayoutProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()
...
public:
	...
	ETLLRN_UVLayoutType LayoutType = ETLLRN_UVLayoutType::Repack;
	...
	UPROPERTY(EditAnywhere, Category = "UV Layout", meta = (EditCondition = "LayoutType == ETLLRN_UVLayoutType::Repack"))
	...
	UPROPERTY(EditAnywhere, Category = "UV Layout", meta = (EditCondition = "LayoutType == ETLLRN_UVLayoutType::Repack && bPreserveRotation == false"))
