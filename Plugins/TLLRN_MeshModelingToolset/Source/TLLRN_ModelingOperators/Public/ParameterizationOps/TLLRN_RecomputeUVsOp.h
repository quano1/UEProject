...
#include "TLLRN_RecomputeUVsOp.generated.h"

class UTLLRN_RecomputeUVsToolProperties;
...
class TLLRN_MODELINGOPERATORS_API FTLLRN_RecomputeUVsOp : public FDynamicMeshOperator
{
public:
	virtual ~FTLLRN_RecomputeUVsOp() {}
...
/**
 * Can be hooked up to a UTLLRN_MeshOpPreviewWithBackgroundCompute to perform UV solving operations.
 * 
 ...
 */
UCLASS()
class TLLRN_MODELINGOPERATORS_API UTLLRN_RecomputeUVsOpFactory : public UObject, public UE::Geometry::IDynamicMeshOperatorFactory
{
	GENERATED_BODY()
