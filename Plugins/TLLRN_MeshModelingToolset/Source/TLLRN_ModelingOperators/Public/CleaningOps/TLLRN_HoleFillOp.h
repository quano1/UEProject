...
#include "TLLRN_HoleFillOp.generated.h"

UENUM()
enum class ETLLRN_HoleFillOpFillType : uint8
{
...
class TLLRN_MODELINGOPERATORS_API FTLLRN_HoleFillOp : public FDynamicMeshOperator
{
public:
	...
	ETLLRN_HoleFillOpFillType FillType = ETLLRN_HoleFillOpFillType::Minimal;
