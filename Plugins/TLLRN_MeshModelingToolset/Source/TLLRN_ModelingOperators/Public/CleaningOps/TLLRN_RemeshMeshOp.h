...
#include "TLLRN_RemeshMeshOp.generated.h"

/** Remeshing modes */
UENUM()
enum class ETLLRN_RemeshType : uint8
{
...
/** Smoothing modes */
UENUM()
enum class ETLLRN_RemeshSmoothingType : uint8
{
	/** Uniform Smoothing */
...
class TLLRN_MODELINGOPERATORS_API FTLLRN_RemeshMeshOp : public FDynamicMeshOperator
{
public:
	virtual ~FTLLRN_RemeshMeshOp() {}

	// inputs
	TSharedPtr<FDynamicMesh3, ESPMode::ThreadSafe> OriginalMesh;
	TSharedPtr<FDynamicMeshAABBTree3, ESPMode::ThreadSafe> OriginalMeshSpatial;

	ETLLRN_RemeshType TLLRN_RemeshType = ETLLRN_RemeshType::Standard;
	...
	ETLLRN_RemeshSmoothingType SmoothingType;
...
protected:
	...
	TUniquePtr<FRemesher> CreateRemesher(ETLLRN_RemeshType Type, FDynamicMesh3* TargetMesh);
