...
#include "CompositionOps/TLLRN_VoxelMorphologyMeshesOp.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(TLLRN_VoxelMorphologyMeshesOp)

using namespace UE::Geometry;

void FTLLRN_VoxelMorphologyMeshesOp::SetTransform(const FTransformSRT3d& Transform) 
{
	ResultTransform = Transform;
}

void FTLLRN_VoxelMorphologyMeshesOp::CalculateResult(FProgressCancel* Progress)
{
