...
#include "TLLRN_SimplifyMeshOp.generated.h"

struct FMeshDescription;
class IMeshReduction;

UENUM()
enum class ETLLRN_SimplifyTargetType : uint8
{
...
UENUM()
enum class ETLLRN_SimplifyType : uint8
{
...
class TLLRN_MODELINGOPERATORSEDITORONLY_API FTLLRN_SimplifyMeshOp : public FDynamicMeshOperator
{
public:
	virtual ~FTLLRN_SimplifyMeshOp() {}

	//
	// Inputs
	// 
	ETLLRN_SimplifyTargetType TargetMode;
	ETLLRN_SimplifyType SimplifierType;
