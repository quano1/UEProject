...
#include "TLLRN_ParameterizeMeshOp.generated.h"
...
class TLLRN_MODELINGOPERATORSEDITORONLY_API FTLLRN_ParameterizeMeshOp : public FDynamicMeshOperator
{
public:
	virtual ~FTLLRN_ParameterizeMeshOp() {}
...
/**
 * Can be hooked up to a UTLLRN_MeshOpPreviewWithBackgroundCompute to perform UV parameterization operations.
 *
 ...
 */
UCLASS()
class TLLRN_MODELINGOPERATORSEDITORONLY_API UTLLRN_ParameterizeMeshOperatorFactory : public UObject, public UE::Geometry::IDynamicMeshOperatorFactory
{
	GENERATED_BODY()
