...
#include "TLLRN_ParameterizeMeshProperties.generated.h"


UENUM()
enum class ETLLRN_ParameterizeMeshUVMethod
{
...
UCLASS()
class TLLRN_MODELINGOPERATORSEDITORONLY_API UTLLRN_ParameterizeMeshToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()
public:
	/** Automatic UV generation technique to use */
	UPROPERTY(EditAnywhere, Category = AutoUV)
	ETLLRN_ParameterizeMeshUVMethod Method = ETLLRN_ParameterizeMeshUVMethod::PatchBuilder;
};
 ...
 */
UCLASS()
class TLLRN_MODELINGOPERATORSEDITORONLY_API UTLLRN_ParameterizeMeshToolUVAtlasProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()
public:
...
UCLASS()
class TLLRN_MODELINGOPERATORSEDITORONLY_API UTLLRN_ParameterizeMeshToolXAtlasProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()
public:
...
UCLASS()
class TLLRN_MODELINGOPERATORSEDITORONLY_API UTLLRN_ParameterizeMeshToolPatchBuilderProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()
public:
