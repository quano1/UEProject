...
#include UE_INLINE_GENERATED_CPP_BY_NAME(TLLRN_ParameterizeMeshOp)
...
#define LOCTEXT_NAMESPACE "TLLRN_ParameterizeMeshOp"

FTLLRN_ParameterizeMeshOp::FLinearMesh::FLinearMesh(const FDynamicMesh3& Mesh, UE::Geometry::FPolygroupSet* InputGroups)
{
...
void FTLLRN_ParameterizeMeshOp::CopyNewUVsToMesh(
	FDynamicMesh3& Mesh,
...
void FTLLRN_ParameterizeMeshOp::LayoutToUDIMByPolygroup(FDynamicMesh3& InOutMesh, UE::Geometry::FPolygroupSet& PolygroupSet)
{
...
bool FTLLRN_ParameterizeMeshOp::ComputeUVs_UVAtlas(FDynamicMesh3& Mesh, TFunction<bool(float)>& Interrupter)
{
#if NO_UVATLAS
	...
	TRACE_CPUPROFILER_EVENT_SCOPE(TLLRN_ParameterizeMeshOp_ComputeUVs_UVAtlas);
...
bool FTLLRN_ParameterizeMeshOp::ComputeUVs_XAtlas(FDynamicMesh3& Mesh, TFunction<bool(float)>& Interrupter)
{
	TRACE_CPUPROFILER_EVENT_SCOPE(TLLRN_ParameterizeMeshOp_ComputeUVs_XAtlas);
...
bool FTLLRN_ParameterizeMeshOp::ComputeUVs_PatchBuilder(FDynamicMesh3& InOutMesh, FProgressCancel* ProgressCancel)
{
	TRACE_CPUPROFILER_EVENT_SCOPE(TLLRN_ParameterizeMeshOp_ComputeUVs_PatchBuilder);
...
void FTLLRN_ParameterizeMeshOp::CalculateResult(FProgressCancel* Progress)
{
	TRACE_CPUPROFILER_EVENT_SCOPE(TLLRN_ParameterizeMeshOp_CalculateResult);
...
TUniquePtr<FDynamicMeshOperator> UTLLRN_ParameterizeMeshOperatorFactory::MakeNewOperator()
{
	TUniquePtr<FTLLRN_ParameterizeMeshOp> Op = MakeUnique<FTLLRN_ParameterizeMeshOp>();
	...
	{
	case ETLLRN_ParameterizeMeshUVMethod::PatchBuilder:
		...
		break;
	case ETLLRN_ParameterizeMeshUVMethod::UVAtlas:
		...
		break;
	case ETLLRN_ParameterizeMeshUVMethod::XAtlas:
