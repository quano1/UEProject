...
#include "ParameterizationOps/TLLRN_CalculateTangentsOp.h"
#include "VectorUtil.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(TLLRN_CalculateTangentsOp)
...
void FTLLRN_CalculateTangentsOp::CalculateResult(FProgressCancel* Progress)
{
	...
	default:
	case ETLLRN_MeshTangentsType::FastMikkTSpace:
		CalculateStandard(Progress, Tangents);
		break;

	case ETLLRN_MeshTangentsType::PerTriangle:
		CalculateStandard(Progress, Tangents);
		break;

	case ETLLRN_MeshTangentsType::MikkTSpace:
#if WITH_MIKKTSPACE
	...
	case ETLLRN_MeshTangentsType::CopyExisting:
...
void FTLLRN_CalculateTangentsOp::CalculateStandard(FProgressCancel* Progress, TUniquePtr<FMeshTangentsd>& Tangents)
{
	...
	Options.bAveraged = (CalculationMethod != ETLLRN_MeshTangentsType::PerTriangle);

	Tangents->ComputeTriVertexTangents(NormalOverlay, UVOverlay, Options);
}


void FTLLRN_CalculateTangentsOp::CopyFromSource(FProgressCancel* Progress, TUniquePtr<FMeshTangentsd>& Tangents)
{
...
void FTLLRN_CalculateTangentsOp::CalculateMikkT(FProgressCancel* Progress, TUniquePtr<FMeshTangentsd>& Tangents)
{
	Tangents->InitializeTriVertexTangents(true);
