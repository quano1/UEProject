...
#include "TLLRN_SubdividePoly.generated.h"
 ...
 */
UENUM()
enum class ETLLRN_SubdivisionScheme : uint8
{
...
UENUM()
enum class ETLLRN_SubdivisionBoundaryScheme : uint8
{
 ...
 */
UENUM()
enum class ETLLRN_SubdivisionOutputNormals : uint8
{
 ...
 */
UENUM()
enum class ETLLRN_SubdivisionOutputUVs : uint8
{
 ...
 */
class TLLRN_MODELINGCOMPONENTSEDITORONLY_API FTLLRN_SubdividePoly
{
public:

	FTLLRN_SubdividePoly(const FGroupTopology& InTopology,
				   const FDynamicMesh3& InOriginalMesh,
				   int InLevel);

	~FTLLRN_SubdividePoly();
	...
	ETLLRN_SubdivisionScheme TLLRN_SubdivisionScheme = ETLLRN_SubdivisionScheme::CatmullClark;

	ETLLRN_SubdivisionBoundaryScheme BoundaryScheme = ETLLRN_SubdivisionBoundaryScheme::SharpCorners;

	ETLLRN_SubdivisionOutputNormals NormalComputationMethod = ETLLRN_SubdivisionOutputNormals::Generated;

	ETLLRN_SubdivisionOutputUVs UVComputationMethod = ETLLRN_SubdivisionOutputUVs::Interpolated;
