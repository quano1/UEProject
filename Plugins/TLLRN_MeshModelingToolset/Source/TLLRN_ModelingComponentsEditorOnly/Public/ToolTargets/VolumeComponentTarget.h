...
class TLLRN_MODELINGCOMPONENTSEDITORONLY_API FVolumeComponentTargetFactory : public FComponentTargetFactory
{
public:
...
class TLLRN_MODELINGCOMPONENTSEDITORONLY_API FVolumeComponentTarget : public FPrimitiveComponentTarget
{
public:
