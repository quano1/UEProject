...
#include "TLLRN_StaticMeshToolTarget.generated.h"
 ...
 */
UCLASS(Transient)
class TLLRN_MODELINGCOMPONENTSEDITORONLY_API UTLLRN_StaticMeshToolTarget : 
	public UToolTarget,
...
protected:
	...
	friend class UTLLRN_StaticMeshToolTargetFactory;

	friend class UTLLRN_StaticMeshComponentToolTarget;
...
/** Factory for UTLLRN_StaticMeshToolTarget to be used by the target manager. */
UCLASS(Transient)
class TLLRN_MODELINGCOMPONENTSEDITORONLY_API UTLLRN_StaticMeshToolTargetFactory : public UToolTargetFactory
{
	GENERATED_BODY()
