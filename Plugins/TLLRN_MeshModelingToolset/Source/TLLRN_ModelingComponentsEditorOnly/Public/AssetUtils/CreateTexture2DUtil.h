...
namespace AssetUtils
{
	 ...
	 */
	struct TLLRN_MODELINGCOMPONENTSEDITORONLY_API FTexture2DAssetOptions
	{
	 ...
	 */
	struct TLLRN_MODELINGCOMPONENTSEDITORONLY_API FTexture2DAssetResults
	{
	 ...
	 */
	TLLRN_MODELINGCOMPONENTSEDITORONLY_API ECreateTexture2DResult SaveGeneratedTexture2DAsset(
