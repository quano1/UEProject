...
namespace AssetUtils
{
	 ...
	 */
	struct TLLRN_MODELINGCOMPONENTSEDITORONLY_API FStaticMeshAssetMeshes
	{
	 ...
	 */
	struct TLLRN_MODELINGCOMPONENTSEDITORONLY_API FStaticMeshAssetOptions
	{
	 ...
	 */
	struct TLLRN_MODELINGCOMPONENTSEDITORONLY_API FStaticMeshResults
	{
	 ...
	 */
	TLLRN_MODELINGCOMPONENTSEDITORONLY_API ECreateStaticMeshResult CreateStaticMeshAsset(
