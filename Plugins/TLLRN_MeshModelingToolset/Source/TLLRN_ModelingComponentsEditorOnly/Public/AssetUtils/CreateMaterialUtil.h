...
namespace AssetUtils
{
	 ...
	 */
	struct TLLRN_MODELINGCOMPONENTSEDITORONLY_API FMaterialAssetOptions
	{
	 ...
	 */
	struct TLLRN_MODELINGCOMPONENTSEDITORONLY_API FMaterialAssetResults
	{
	 ...
	 */
	TLLRN_MODELINGCOMPONENTSEDITORONLY_API ECreateMaterialResult CreateDuplicateMaterial(
	 ...
	 * @return Ok, or error flag if some part of the creation process failed. On failure, no Asset is created.
	 */
	TLLRN_MODELINGCOMPONENTSEDITORONLY_API ECreateMaterialResult CreateDerivedMaterialInstance(
		UMaterialInterface* BaseMaterial,
		FMaterialAssetOptions& Options,
		FMaterialAssetResults& ResultsOut);
