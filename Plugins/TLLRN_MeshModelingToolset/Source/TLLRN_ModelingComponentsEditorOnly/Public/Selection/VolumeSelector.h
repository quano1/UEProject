...
class TLLRN_MODELINGCOMPONENTSEDITORONLY_API FVolumeSelector : public FBaseDynamicMeshSelector, public FEditorUndoClient
{
public:
 ...
 */
class TLLRN_MODELINGCOMPONENTSEDITORONLY_API FBrushComponentSelectorFactory : public IGeometrySelectorFactory
{
public:
