...
class TLLRN_MODELINGCOMPONENTSEDITORONLY_API FStaticMeshSelector : public FBaseDynamicMeshSelector
{
public:
 ...
 */
class TLLRN_MODELINGCOMPONENTSEDITORONLY_API FStaticMeshComponentSelectorFactory : public IGeometrySelectorFactory
{
public:
