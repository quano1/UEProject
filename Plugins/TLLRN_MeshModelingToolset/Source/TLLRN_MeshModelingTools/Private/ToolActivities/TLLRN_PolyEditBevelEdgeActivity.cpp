...
#include UE_INLINE_GENERATED_CPP_BY_NAME(TLLRN_PolyEditBevelEdgeActivity)

#define LOCTEXT_NAMESPACE "UTLLRN_PolyEditBevelEdgeActivity"
...
TUniquePtr<FDynamicMeshOperator> UTLLRN_PolyEditBevelEdgeActivity::MakeNewOperator()
{
	...
	{
		UE_LOG(LogGeometry, Warning, TEXT("UTLLRN_PolyEditBevelEdgeActivity::MakeNewOperator : empty selection"));
	}
...
void UTLLRN_PolyEditBevelEdgeActivity::Setup(UInteractiveTool* ParentToolIn)
{
	...
	BevelProperties = NewObject<UTLLRN_PolyEditBevelEdgeProperties>();
...
void UTLLRN_PolyEditBevelEdgeActivity::Shutdown(EToolShutdownType ShutdownType)
{
	if (bIsRunning)
	{
		End(ShutdownType);
...
bool UTLLRN_PolyEditBevelEdgeActivity::CanStart() const
{
	if (ActivityContext)
	{
...
EToolActivityStartResult UTLLRN_PolyEditBevelEdgeActivity::Start()
{
	if (!CanStart())
	{
...
void UTLLRN_PolyEditBevelEdgeActivity::BeginBevel()
{
...
bool UTLLRN_PolyEditBevelEdgeActivity::CanAccept() const
{
	return true;
}

EToolActivityEndResult UTLLRN_PolyEditBevelEdgeActivity::End(EToolShutdownType ShutdownType)
{
...
void UTLLRN_PolyEditBevelEdgeActivity::EndInternal()
{
...
void UTLLRN_PolyEditBevelEdgeActivity::ApplyBevel()
{
...
void UTLLRN_PolyEditBevelEdgeActivity::Render(IToolsContextRenderAPI* RenderAPI)
{
}

void UTLLRN_PolyEditBevelEdgeActivity::Tick(float DeltaTime)
{
}
