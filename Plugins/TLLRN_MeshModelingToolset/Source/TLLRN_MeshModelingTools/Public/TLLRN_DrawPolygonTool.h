...
#include "TLLRN_DrawPolygonTool.generated.h"
 ...
 */
UCLASS()
class TLLRN_MESHMODELINGTOOLS_API UTLLRN_DrawPolygonToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
...
UENUM()
enum class ETLLRN_DrawPolygonDrawMode : uint8
{
...
UENUM()
enum class ETLLRN_DrawPolygonExtrudeMode : uint8
{
...
UCLASS()
class TLLRN_MESHMODELINGTOOLS_API UTLLRN_DrawPolygonToolStandardProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	UTLLRN_DrawPolygonToolStandardProperties();
	...
	ETLLRN_DrawPolygonDrawMode PolygonDrawMode = ETLLRN_DrawPolygonDrawMode::Freehand;

	/** Allow freehand drawn polygons to self-intersect */
	UPROPERTY(EditAnywhere, NonTransactional, Category = Polygon,
		meta = (DisplayName ="Self-Intersections", EditCondition = "PolygonDrawMode == ETLLRN_DrawPolygonDrawMode::Freehand"))
	...
	UPROPERTY(EditAnywhere, NonTransactional, Category = Polygon, meta = (UIMin = "0.01", UIMax = "0.99", ClampMin = "0.01", ClampMax = "0.99",
		EditCondition = "PolygonDrawMode == ETLLRN_DrawPolygonDrawMode::RoundedRectangle || PolygonDrawMode == ETLLRN_DrawPolygonDrawMode::Ring"))
	...
	UPROPERTY(EditAnywhere, NonTransactional, Category = Polygon, meta = (UIMin = "3", UIMax = "100", ClampMin = "3", ClampMax = "10000",
		EditCondition =	"PolygonDrawMode == ETLLRN_DrawPolygonDrawMode::Circle || PolygonDrawMode == ETLLRN_DrawPolygonDrawMode::RoundedRectangle || PolygonDrawMode == ETLLRN_DrawPolygonDrawMode::Ring"))
	int RadialSlices = 16;
	...
	ETLLRN_DrawPolygonExtrudeMode ExtrudeMode = ETLLRN_DrawPolygonExtrudeMode::Interactive;
	...
	UPROPERTY(EditAnywhere, NonTransactional, Category = Extrude, meta = (UIMin = "-1000", UIMax = "1000", ClampMin = "-10000", ClampMax = "10000",
		EditCondition = "ExtrudeMode == ETLLRN_DrawPolygonExtrudeMode::Fixed"))
	float ExtrudeHeight = 100.0f;
};

UCLASS()
class TLLRN_MESHMODELINGTOOLS_API UTLLRN_DrawPolygonToolSnapProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class TLLRN_MESHMODELINGTOOLS_API UTLLRN_DrawPolygonTool : public UInteractiveTool, public IClickSequenceBehaviorTarget
{
	GENERATED_BODY()
public:
	UTLLRN_DrawPolygonTool();
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UTLLRN_DrawPolygonToolStandardProperties> PolygonProperties;

	UPROPERTY()
	TObjectPtr<UTLLRN_DrawPolygonToolSnapProperties> SnapProperties;
	...
	UPROPERTY()
	TObjectPtr<UTLLRN_PlaneDistanceFromHitMechanic> HeightMechanic;
...
// Change event used by TLLRN_DrawPolygonTool to undo draw state.
// Currently does not redo.
class TLLRN_MESHMODELINGTOOLS_API FDrawPolygonStateChange : public FToolCommandChange
{
public:
