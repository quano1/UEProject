...
#include "TLLRN_PolyEditActivityContext.generated.h"
...
class UTLLRN_PolyEditCommonProperties;
class UTLLRN_PolygonSelectionMechanic;
class UTLLRN_MeshOpPreviewWithBackgroundCompute;

UCLASS()
class TLLRN_MESHMODELINGTOOLS_API UTLLRN_PolyEditActivityContext : public UObject
{
	GENERATED_BODY()
...
public:
	...
	UPROPERTY()
	TObjectPtr<UTLLRN_PolyEditCommonProperties> CommonProperties;
	 ...
	 */
	UPROPERTY()
	TObjectPtr<UTLLRN_PolygonSelectionMechanic> SelectionMechanic;
