...
#include "TLLRN_RevolveProperties.generated.h"

class UTLLRN_NewTLLRN_MeshMaterialProperties;
PREDECLARE_GEOMETRY(class FCurveSweepOp);

UENUM()
enum class ETLLRN_RevolvePropertiesCapFillMode : uint8
{
...
UENUM()
enum class ETLLRN_RevolvePropertiesPolygroupMode : uint8
{
...
UENUM()
enum class ETLLRN_RevolvePropertiesQuadSplit : uint8
{
 ...
 */
UCLASS()
class TLLRN_MESHMODELINGTOOLS_API UTLLRN_RevolveProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()
public:

	UTLLRN_RevolveProperties()
	{
	...
	ETLLRN_RevolvePropertiesPolygroupMode PolygroupMode = ETLLRN_RevolvePropertiesPolygroupMode::PerFace;

	/** How generated quads are split into triangles. */
	UPROPERTY(EditAnywhere, Category = Revolve, AdvancedDisplay)
	ETLLRN_RevolvePropertiesQuadSplit QuadSplitMode = ETLLRN_RevolvePropertiesQuadSplit::Compact;
	...
	// 	EditCondition = "QuadSplitMode == ETLLRN_RevolvePropertiesQuadSplit::Compact"))
	 ...
	 */
	void ApplyToCurveSweepOp(const UTLLRN_NewTLLRN_MeshMaterialProperties& MaterialProperties,
	...
	protected:
		virtual ETLLRN_RevolvePropertiesCapFillMode GetCapFillMode() const
		{
			return ETLLRN_RevolvePropertiesCapFillMode::Delaunay;
		}
