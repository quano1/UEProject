...
{
	UTLLRN_GeometrySelectionManager* SelectionManager = SceneState.ToolManager->GetContextObjectStore()->FindContext<UTLLRN_GeometrySelectionManager>();
...
{
	UTLLRN_GeometrySelectionManager* SelectionManager = ToolManager->GetContextObjectStore()->FindContext<UTLLRN_GeometrySelectionManager>();
...
{
	UTLLRN_GeometrySelectionManager* SelectionManager = Tool->GetToolManager()->GetContextObjectStore()->FindContext<UTLLRN_GeometrySelectionManager>();
	if (SelectionManager == nullptr)
	{
		return false;
	}
