...
#include UE_INLINE_GENERATED_CPP_BY_NAME(TLLRN_MeshWireframeComponent)
...
/** Class for the TLLRN_MeshWireframeComponent data passed to the render thread. */
class FMeshWireframeSceneProxy final : public FPrimitiveSceneProxy
{
public:

	FMeshWireframeSceneProxy(UTLLRN_MeshWireframeComponent* Component, const IMeshWireframeSource* WireSource)
...
UTLLRN_MeshWireframeComponent::UTLLRN_MeshWireframeComponent()
{
	CastShadow = false;
	bSelectable = false;
...
void UTLLRN_MeshWireframeComponent::SetWireframeSourceProvider(TSharedPtr<IMeshWireframeSourceProvider> Provider)
{
	SourceProvider = Provider;
	UpdateWireframe();
}

void UTLLRN_MeshWireframeComponent::UpdateWireframe()
{
	if (SourceProvider)
	{
...
void UTLLRN_MeshWireframeComponent::SetLineMaterial(UMaterialInterface* InLineMaterial)
{
...
FPrimitiveSceneProxy* UTLLRN_MeshWireframeComponent::CreateSceneProxy()
{
	if (SourceProvider)
	{
...
int32 UTLLRN_MeshWireframeComponent::GetNumMaterials() const
{
	return 1;
}

FBoxSphereBounds UTLLRN_MeshWireframeComponent::CalcBounds(const FTransform& LocalToWorld) const
{
