...
#include "Drawing/TLLRN_MeshWireframeComponent.h"
#include "ToolSetupUtil.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(TLLRN_MeshElementsVisualizer)
...
{
public:
	TUniqueFunction<void(UTLLRN_MeshElementsVisualizer::ProcessDynamicMeshFunc)> MeshAccessFunction;

	FDynamicMeshWireframeSourceProvider(TUniqueFunction<void(UTLLRN_MeshElementsVisualizer::ProcessDynamicMeshFunc)>&& MeshAccessFuncIn)
	{
...
void UTLLRN_MeshElementsVisualizer::OnCreated()
{
	Settings = NewObject<UTLLRN_MeshElementsVisualizerProperties>(this);
	...
	WireframeComponent = NewObject<UTLLRN_MeshWireframeComponent>(GetActor());
...
void UTLLRN_MeshElementsVisualizer::SetMeshAccessFunction(TUniqueFunction<void(ProcessDynamicMeshFunc)>&& MeshAccessFunctionIn)
{
...
void UTLLRN_MeshElementsVisualizer::UpdateLineDepthBiasScale()
{
...
void UTLLRN_MeshElementsVisualizer::OnTick(float DeltaTime)
{
...
void UTLLRN_MeshElementsVisualizer::UpdateVisibility()
{
...
void UTLLRN_MeshElementsVisualizer::NotifyMeshChanged()
{
	WireframeComponent->UpdateWireframe();
}

void UTLLRN_MeshElementsVisualizerProperties::ShowAllElements(bool bShow)
{
