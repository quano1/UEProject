...
UMaterialInstanceDynamic* ToolSetupUtil::GetVertexColorMaterial(UInteractiveToolManager* ToolManager, bool bTwoSided)
{
	...
	UMaterial* Material = bTwoSided ? LoadObject<UMaterial>(nullptr, TEXT("/TLLRN_MeshModelingToolsetExp/Materials/MeshVertexColorMaterialTwoSided"))
		: LoadObject<UMaterial>(nullptr, TEXT("/TLLRN_MeshModelingToolsetExp/Materials/MeshVertexColorMaterial"));
...
{
	UMaterialInterface* Material = LoadObject<UMaterial>(nullptr, TEXT("/TLLRN_MeshModelingToolsetExp/Materials/InProgressMaterial"));
...
{
	UMaterial* Material = LoadObject<UMaterial>(nullptr, TEXT("/TLLRN_MeshModelingToolsetExp/Materials/BrushIndicatorMaterial"));
	if (Material != nullptr)
	{
		UMaterialInstanceDynamic* MatInstance = UMaterialInstanceDynamic::Create(Material, ToolManager);
		return MatInstance;
...
{
	UMaterial* Material = LoadObject<UMaterial>(nullptr, TEXT("/TLLRN_MeshModelingToolsetExp/Materials/BrushAlphaIndicatorMaterial"));
	if (Material != nullptr)
	{
		UMaterialInstanceDynamic* MatInstance = UMaterialInstanceDynamic::Create(Material, ToolManager);
		return MatInstance;
...
{
	UMaterialInterface* Material = LoadObject<UMaterial>(nullptr, TEXT("/TLLRN_MeshModelingToolsetExp/Materials/SculptMaterial"));
	if (Material == nullptr && ToolManager != nullptr)
	{
		return ToolManager->GetContextQueriesAPI()->GetStandardMaterial(EStandardToolContextMaterials::VertexColorMaterial);
	}
...
UMaterialInstanceDynamic* ToolSetupUtil::GetTransparentSculptMaterial(UInteractiveToolManager* ToolManager, const FLinearColor& Color, double Opacity, bool bTwoSided)
{
	// Unfortunately the two-sided flag is not something that we can give as a runtime 
	// parameter, so we need separate versions of the material.
	UMaterial* Material = bTwoSided ? LoadObject<UMaterial>(nullptr, TEXT("/TLLRN_MeshModelingToolsetExp/Materials/SculptMaterial_TransparentTwoSided"))
		: LoadObject<UMaterial>(nullptr, TEXT("/TLLRN_MeshModelingToolsetExp/Materials/SculptMaterial_Transparent"));
...
UMaterialInterface* ToolSetupUtil::GetImageBasedSculptMaterial(UInteractiveToolManager* ToolManager, ImageMaterialType Type)
{
	...
	{
		Material = LoadObject<UMaterialInstance>(nullptr, TEXT("/TLLRN_MeshModelingToolsetExp/Materials/SculptMaterial_Basic"));
	}
	else if (Type == ImageMaterialType::DefaultSoft)
	{
		Material = LoadObject<UMaterialInstance>(nullptr, TEXT("/TLLRN_MeshModelingToolsetExp/Materials/SculptMaterial_Soft"));
	}
	else if (Type == ImageMaterialType::TangentNormalFromView)
	{
		Material = LoadObject<UMaterial>(nullptr, TEXT("/TLLRN_MeshModelingToolsetExp/Materials/SculptMaterial_TangentNormalFromView"));
	}
...
{
	UMaterial* Material = LoadObject<UMaterial>(nullptr, TEXT("/TLLRN_MeshModelingToolsetExp/Materials/ImageBasedMaterial_Master"));
	if (Material != nullptr)
	{
		UMaterialInstanceDynamic* MatInstance = UMaterialInstanceDynamic::Create(Material, ToolManager);
		if (SetImage != nullptr)
...
{
	UMaterialInterface* Material = LoadObject<UMaterial>(nullptr, TEXT("/TLLRN_MeshModelingToolsetExp/Materials/SelectionMaterial"));
	if (Material == nullptr && ToolManager != nullptr)
	{
		return ToolManager->GetContextQueriesAPI()->GetStandardMaterial(EStandardToolContextMaterials::VertexColorMaterial);
	}
...
{
	UMaterialInterface* Material = LoadObject<UMaterial>(nullptr, TEXT("/TLLRN_MeshModelingToolsetExp/Materials/SimpleBaseMaterial_Transparent"));
	if (Material != nullptr)
	{
		UMaterialInstanceDynamic* MatInstance = UMaterialInstanceDynamic::Create(Material, ToolManager);
		MatInstance->SetVectorParameterValue(TEXT("Color"), Color);
...
TLLRN_MODELINGCOMPONENTS_API UMaterialInstanceDynamic* ToolSetupUtil::GetSimpleCustomMaterial(UInteractiveToolManager* ToolManager, const FLinearColor& Color)
{
	UMaterialInterface* Material = LoadObject<UMaterial>(nullptr, TEXT("/TLLRN_MeshModelingToolsetExp/Materials/SimpleBaseMaterial"));
	if (Material != nullptr)
	{
		UMaterialInstanceDynamic* MatInstance = UMaterialInstanceDynamic::Create(Material, ToolManager);
		MatInstance->SetVectorParameterValue(TEXT("Color"), Color);
...
{
	UMaterialInterface* Material = LoadObject<UMaterial>(nullptr, TEXT("/TLLRN_MeshModelingToolsetExp/Materials/SimpleTwoSidedOffsetMaterial_Transparent"));
	if (Material != nullptr)
	{
		UMaterialInstanceDynamic* MatInstance = UMaterialInstanceDynamic::Create(Material, ToolManager);
		MatInstance->SetVectorParameterValue(TEXT("Color"), Color);
...
TLLRN_MODELINGCOMPONENTS_API UMaterialInstanceDynamic* ToolSetupUtil::GetCustomTwoSidedDepthOffsetMaterial(UInteractiveToolManager* ToolManager, const FLinearColor& Color, float DepthBias)
{
	UMaterialInterface* Material = LoadObject<UMaterial>(nullptr, TEXT("/TLLRN_MeshModelingToolsetExp/Materials/SimpleTwoSidedOffsetMaterial"));
	if (Material != nullptr)
	{
		UMaterialInstanceDynamic* MatInstance = UMaterialInstanceDynamic::Create(Material, ToolManager);
		MatInstance->SetVectorParameterValue(TEXT("Color"), Color);
...
{
	UMaterialInterface* Material = LoadObject<UMaterial>(nullptr, TEXT("/TLLRN_MeshModelingToolsetExp/Materials/SimpleOffsetMaterial_Transparent"));
	if (Material != nullptr)
	{
		UMaterialInstanceDynamic* MatInstance = UMaterialInstanceDynamic::Create(Material, ToolManager);
		MatInstance->SetVectorParameterValue(TEXT("Color"), Color);
...
TLLRN_MODELINGCOMPONENTS_API UMaterialInstanceDynamic* ToolSetupUtil::GetCustomDepthOffsetMaterial(UInteractiveToolManager* ToolManager, const FLinearColor& Color, float DepthBias)
{
	UMaterialInterface* Material = LoadObject<UMaterial>(nullptr, TEXT("/TLLRN_MeshModelingToolsetExp/Materials/SimpleOffsetMaterial"));
	if (Material != nullptr)
	{
		UMaterialInstanceDynamic* MatInstance = UMaterialInstanceDynamic::Create(Material, ToolManager);
		MatInstance->SetVectorParameterValue(TEXT("Color"), Color);
...
{
	return LoadObject<UMaterial>(nullptr, TEXT("/TLLRN_MeshModelingToolsetExp/Materials/VolumeEditMaterial"));
}
...
UMaterialInterface* ToolSetupUtil::GetDefaultPointComponentMaterial(UInteractiveToolManager* ToolManager, bool bDepthTested)
{
	UMaterialInterface* Material = (bDepthTested) ?
		LoadObject<UMaterial>(nullptr, TEXT("/TLLRN_MeshModelingToolsetExp/Materials/TLLRN_PointSetComponentMaterial"))
		: LoadObject<UMaterial>(nullptr, TEXT("/TLLRN_MeshModelingToolsetExp/Materials/PointSetOverlaidComponentMaterial"));
	if (Material == nullptr && ToolManager != nullptr)
	{
		return ToolManager->GetContextQueriesAPI()->GetStandardMaterial(EStandardToolContextMaterials::VertexColorMaterial);
	}
...
{
	UMaterialInterface* Material = (bDepthTested) ?
		LoadObject<UMaterial>(nullptr, TEXT("/TLLRN_MeshModelingToolsetExp/Materials/TLLRN_PointSetComponentMaterial_Round"))
		: LoadObject<UMaterial>(nullptr, TEXT("/TLLRN_MeshModelingToolsetExp/Materials/PointSetOverlaidComponentMaterial_Round"));
	if (Material == nullptr && ToolManager != nullptr)
	{
		return ToolManager->GetContextQueriesAPI()->GetStandardMaterial(EStandardToolContextMaterials::VertexColorMaterial);
	}
...
{
	UMaterialInterface* Material = (bDepthTested) ?
		LoadObject<UMaterial>(nullptr, TEXT("/TLLRN_MeshModelingToolsetExp/Materials/TLLRN_LineSetComponentMaterial"))
		: LoadObject<UMaterial>(nullptr, TEXT("/TLLRN_MeshModelingToolsetExp/Materials/LineSetOverlaidComponentMaterial"));
	if (Material == nullptr && ToolManager != nullptr)
	{
...
UCurveFloat* ToolSetupUtil::GetContrastAdjustmentCurve(UInteractiveToolManager* ToolManager)
{
	...
	UCurveFloat* Curve = LoadObject<UCurveFloat>(nullptr, TEXT("/TLLRN_MeshModelingToolsetExp/Curves/ContrastAdjustmentCurve"));
...
{
	UTLLRN_ModelingComponentsSettings* Settings = GetMutableDefault<UTLLRN_ModelingComponentsSettings>();
...
void ToolSetupUtil::ApplyRenderingConfigurationToPreview(UTLLRN_PreviewMesh* TLLRN_PreviewMesh, UToolTarget* SourceTarget)
{
	UBaseDynamicMeshComponent* Component = Cast<UBaseDynamicMeshComponent>(TLLRN_PreviewMesh->GetRootComponent());
	if (!Component)
	{
		return;
	}
