...
#include "Snapping/TLLRN_ModelingSceneSnappingManager.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(TLLRN_ModelingSceneSnappingManager)
...
void UTLLRN_ModelingSceneSnappingManager::Initialize(TObjectPtr<UInteractiveToolsContext> ToolsContext)
{
...
void UTLLRN_ModelingSceneSnappingManager::Shutdown()
{
#if WITH_EDITOR
...
bool UTLLRN_ModelingSceneSnappingManager::IsComponentTypeSupported(const UPrimitiveComponent* Component) const
{
	// supported types
...
void UTLLRN_ModelingSceneSnappingManager::OnActorAdded(AActor* Actor, TFunctionRef<bool(UPrimitiveComponent*)> PrimitiveFilter)
{
...
void UTLLRN_ModelingSceneSnappingManager::OnActorRemoved(AActor* Actor)
{
...
void UTLLRN_ModelingSceneSnappingManager::OnComponentAdded(UPrimitiveComponent* Component)
{
	...
	{
		DynamicMeshComponent->OnMeshChanged.AddUObject(this, &UTLLRN_ModelingSceneSnappingManager::HandleDynamicMeshModifiedDelegate, DynamicMeshComponent);
...
void UTLLRN_ModelingSceneSnappingManager::OnComponentRemoved(UPrimitiveComponent* Component)
{
...
void UTLLRN_ModelingSceneSnappingManager::HandleGlobalObjectModifiedDelegate(UObject* Object)
{
...
void UTLLRN_ModelingSceneSnappingManager::OnComponentModified(UActorComponent* Component)
{
...
void UTLLRN_ModelingSceneSnappingManager::HandleGlobalComponentTransformChangedDelegate(USceneComponent* Component)
{
	UPrimitiveComponent* PrimComponent = Cast<UPrimitiveComponent>(Component);
...
void UTLLRN_ModelingSceneSnappingManager::HandleDynamicMeshModifiedDelegate(UDynamicMeshComponent* Component)
{
...
void UTLLRN_ModelingSceneSnappingManager::PauseSceneGeometryUpdates()
{
...
void UTLLRN_ModelingSceneSnappingManager::UnPauseSceneGeometryUpdates(bool bImmediateRebuilds)
{
...
void UTLLRN_ModelingSceneSnappingManager::BuildSpatialCacheForWorld(
	UWorld* World,
...
bool UTLLRN_ModelingSceneSnappingManager::ExecuteSceneSnapQuery(const FSceneSnapQueryRequest& Request, TArray<FSceneSnapQueryResult>& Results) const
{
...
bool UTLLRN_ModelingSceneSnappingManager::ExecuteSceneSnapQueryRotation(const FSceneSnapQueryRequest& Request, TArray<FSceneSnapQueryResult>& Results) const
{
	if (!QueriesAPI)
	{
		return false;
...
bool UTLLRN_ModelingSceneSnappingManager::ExecuteSceneHitQuery(const FSceneHitQueryRequest& Request, FSceneHitQueryResult& ResultOut) const
{
	if (!QueriesAPI)
	{
		return false;
...
bool UTLLRN_ModelingSceneSnappingManager::ExecuteSceneSnapQueryPosition(const FSceneSnapQueryRequest& Request, TArray<FSceneSnapQueryResult>& Results) const
{
	if (!QueriesAPI)
	{
		return false;
...
bool UE::Geometry::RegisterSceneSnappingManager(UInteractiveToolsContext* ToolsContext)
{
	...
	{
		UTLLRN_ModelingSceneSnappingManager* Found = ToolsContext->ContextObjectStore->FindContext<UTLLRN_ModelingSceneSnappingManager>();
		if (Found == nullptr)
		{
			UTLLRN_ModelingSceneSnappingManager* SelectionManager = NewObject<UTLLRN_ModelingSceneSnappingManager>(ToolsContext->ToolManager);
...
UTLLRN_ModelingSceneSnappingManager* UE::Geometry::FindTLLRN_ModelingSceneSnappingManager(UInteractiveToolManager* ToolManager)
{
	if (ensure(ToolManager))
	{
		UTLLRN_ModelingSceneSnappingManager* Found = ToolManager->GetContextObjectStore()->FindContext<UTLLRN_ModelingSceneSnappingManager>();
		if (Found != nullptr)
		{
			return Found;
		}
