...
#include "Components/TLLRN_OctreeDynamicMeshComponent.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(TLLRN_OctreeDynamicMeshComponent)

using namespace UE::Geometry;



UTLLRN_OctreeDynamicMeshComponent::UTLLRN_OctreeDynamicMeshComponent(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer)
{
	...
	MeshObjectChangedHandle = MeshObject->OnMeshChanged().AddUObject(this, &UTLLRN_OctreeDynamicMeshComponent::OnMeshObjectChanged);
	PreMeshChangeHandle = MeshObject->OnPreMeshChanged().AddUObject(this, &UTLLRN_OctreeDynamicMeshComponent::OnPreMeshObjectChanged);
...
void UTLLRN_OctreeDynamicMeshComponent::SetMesh(UE::Geometry::FDynamicMesh3&& MoveMesh)
{
...
void UTLLRN_OctreeDynamicMeshComponent::ApplyTransform(const FTransform3d& Transform, bool bInvert)
{
	if (bInvert)
	{
...
void UTLLRN_OctreeDynamicMeshComponent::NotifyMeshUpdated()
{
	if (GetCurrentSceneProxy() != nullptr)
	{
...
FPrimitiveSceneProxy* UTLLRN_OctreeDynamicMeshComponent::CreateSceneProxy()
{
...
void UTLLRN_OctreeDynamicMeshComponent::NotifyMaterialSetUpdated()
{
	if (GetCurrentSceneProxy() != nullptr)
	{
...
FColor UTLLRN_OctreeDynamicMeshComponent::GetTriangleColor(int TriangleID)
{
	if (TriangleColorFunc != nullptr)
	{
...
FBoxSphereBounds UTLLRN_OctreeDynamicMeshComponent::CalcBounds(const FTransform& LocalToWorld) const
{
...
void UTLLRN_OctreeDynamicMeshComponent::ApplyChange(const FMeshVertexChange* Change, bool bRevert)
{
...
void UTLLRN_OctreeDynamicMeshComponent::ApplyChange(const FMeshChange* Change, bool bRevert)
{
...
void UTLLRN_OctreeDynamicMeshComponent::ApplyChange(const FMeshReplacementChange* Change, bool bRevert)
{
...
void UTLLRN_OctreeDynamicMeshComponent::OnPreMeshObjectChanged(UDynamicMesh* ChangedMeshObject, FDynamicMeshChangeInfo ChangeInfo)
{
...
void UTLLRN_OctreeDynamicMeshComponent::OnMeshObjectChanged(UDynamicMesh* ChangedMeshObject, FDynamicMeshChangeInfo ChangeInfo)
{
	if (ChangeInfo.Type == EDynamicMeshChangeType::MeshChange && ensure(ChangeInfo.MeshChange != nullptr))
	{
...
void UTLLRN_OctreeDynamicMeshComponent::SetDynamicMesh(UDynamicMesh* NewMesh)
{
