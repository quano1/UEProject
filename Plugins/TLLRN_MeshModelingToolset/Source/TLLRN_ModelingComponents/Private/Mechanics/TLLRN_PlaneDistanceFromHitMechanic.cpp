...
#include UE_INLINE_GENERATED_CPP_BY_NAME(TLLRN_PlaneDistanceFromHitMechanic)

using namespace UE::Geometry;


void UTLLRN_PlaneDistanceFromHitMechanic::Setup(UInteractiveTool* ParentToolIn)
{
	UInteractionMechanic::Setup(ParentToolIn);

	//Properties = NewObject<UTLLRN_PolygonSelectionMechanicProperties>(this);
...
void UTLLRN_PlaneDistanceFromHitMechanic::Initialize(FDynamicMesh3&& HitTargetMesh, const FFrame3d& PlaneFrameWorld, bool bMeshInWorldCoords)
{
...
void UTLLRN_PlaneDistanceFromHitMechanic::Initialize(FDynamicMesh3&& HitTargetMesh, const FFrame3d& PlaneFrameWorld, const FTransform& MeshToPlaneFrame)
{
	PreviewHeightFrame = PlaneFrameWorld;
...
void UTLLRN_PlaneDistanceFromHitMechanic::UpdateCurrentDistance(const FRay& WorldRay)
{
...
void UTLLRN_PlaneDistanceFromHitMechanic::Render(IToolsContextRenderAPI* RenderAPI)
{
