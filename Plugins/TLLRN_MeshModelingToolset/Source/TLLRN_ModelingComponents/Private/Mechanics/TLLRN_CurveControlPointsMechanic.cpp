...
#include UE_INLINE_GENERATED_CPP_BY_NAME(TLLRN_CurveControlPointsMechanic)

using namespace UE::Geometry;

#define LOCTEXT_NAMESPACE "UTLLRN_CurveControlPointsMechanic"
...
UTLLRN_CurveControlPointsMechanic::~UTLLRN_CurveControlPointsMechanic()
{
	checkf(TLLRN_PreviewGeometryActor == nullptr, TEXT("Shutdown() should be called before UTLLRN_CurveControlPointsMechanic is destroyed."));
}

void UTLLRN_CurveControlPointsMechanic::Setup(UInteractiveTool* ParentToolIn)
{
	...
	DrawnControlSegments = NewObject<UTLLRN_LineSetComponent>();
	...
	PreviewPoint = NewObject<UTLLRN_PointSetComponent>();
	PreviewPoint->SetPointMaterial(
		ToolSetupUtil::GetDefaultPointComponentMaterial(GetParentTool()->GetToolManager(), /*bDepthTested*/ false));
	PreviewSegment = NewObject<UTLLRN_LineSetComponent>();
	...
	PointTransformGizmo = UE::TransformGizmoUtil::CreateCustomTransformGizmo(GizmoManager,
		...
		this);
	PointTransformProxy->OnTransformChanged.AddUObject(this, &UTLLRN_CurveControlPointsMechanic::GizmoTransformChanged);
	PointTransformProxy->OnBeginTransformEdit.AddUObject(this, &UTLLRN_CurveControlPointsMechanic::GizmoTransformStarted);
	PointTransformProxy->OnEndTransformEdit.AddUObject(this, &UTLLRN_CurveControlPointsMechanic::GizmoTransformEnded);
...
void UTLLRN_CurveControlPointsMechanic::SetWorld(UWorld* World)
{
	...
	DrawnControlPoints->Rename(nullptr, TLLRN_PreviewGeometryActor); // Changes the "outer"
	...
	DrawnControlSegments->Rename(nullptr, TLLRN_PreviewGeometryActor); // Changes the "outer"
	...
	PreviewPoint->Rename(nullptr, TLLRN_PreviewGeometryActor); // Changes the "outer"
	...
	PreviewSegment->Rename(nullptr, TLLRN_PreviewGeometryActor); // Changes the "outer"
...
void UTLLRN_CurveControlPointsMechanic::Shutdown()
{
...
void UTLLRN_CurveControlPointsMechanic::Render(IToolsContextRenderAPI* RenderAPI)
{
...
void UTLLRN_CurveControlPointsMechanic::Initialize(const TArray<FVector3d>& Points, bool bIsLoopIn)
{
...
void UTLLRN_CurveControlPointsMechanic::ClearPoints()
{
	ClearSelection();
	ClearHover();
...
int32 UTLLRN_CurveControlPointsMechanic::AppendPoint(const FVector3d& Point)
{
	return InsertPointAt(ControlPoints.Num(), Point);
}

int32 UTLLRN_CurveControlPointsMechanic::InsertPointAt(int32 SequencePosition, const FVector3d& NewPointCoordinates, const int32* KnownPointID)
{
	// Add the point
...
void UTLLRN_CurveControlPointsMechanic::SetIsLoop(bool bIsLoopIn)
{
...
void UTLLRN_CurveControlPointsMechanic::ExtractPointPositions(TArray<FVector3d>& PositionsOut)
{
...
void UTLLRN_CurveControlPointsMechanic::SetInteractiveInitialization(bool bOn)
{
...
void UTLLRN_CurveControlPointsMechanic::GizmoTransformStarted(UTransformProxy* Proxy)
{
...
void UTLLRN_CurveControlPointsMechanic::GizmoTransformChanged(UTransformProxy* Proxy, FTransform Transform)
{
...
void UTLLRN_CurveControlPointsMechanic::GizmoTransformEnded(UTransformProxy* Proxy)
{
	for (int32 i = 0; i < SelectedPointIDs.Num(); ++i)
	{
		ParentTool->GetToolManager()->EmitObjectChange(this, MakeUnique<FTLLRN_CurveControlPointsMechanicMovementChange>(
...
void UTLLRN_CurveControlPointsMechanic::UpdatePointLocation(int32 PointID, const FVector3d& NewLocation)
{
...
bool UTLLRN_CurveControlPointsMechanic::HitTest(const FInputDeviceRay& ClickPos, FInputRayHit& ResultOut)
{
...
FInputRayHit UTLLRN_CurveControlPointsMechanic::IsHitByClick(const FInputDeviceRay& ClickPos)
{
	FInputRayHit Result;
...
void UTLLRN_CurveControlPointsMechanic::OnClicked(const FInputDeviceRay& ClickPos)
{
	FGeometrySet3::FNearest Nearest;
	...
	if (bInteractiveInitializationMode)
	{
		...
		if (SnapEngine.HaveActiveSnap())
		{
				...
				|| (ControlPoints.Num() >= MinPointsForNonLoop && SnapEngine.GetActiveSnapTargetID() == LastPointSnapID))
			{
				...
				ParentTool->GetToolManager()->EmitObjectChange(this, MakeUnique<FTLLRN_CurveControlPointsMechanicModeChange>(
		...
		else
		{
			...
			ParentTool->GetToolManager()->EmitObjectChange(this, MakeUnique<FTLLRN_CurveControlPointsMechanicInsertionChange>(
...
void UTLLRN_CurveControlPointsMechanic::ChangeSelection(int32 NewPointID, bool bAddToSelection)
{
	...
	if (!bAddToSelection && SelectedPointIDs.Num() > 0)
	{
		for (int32 PointID : SelectedPointIDs)
		{
			...
			if (DrawnControlPoints->IsPointValid(PointID))
			{
				...
				ParentTool->GetToolManager()->EmitObjectChange(this, MakeUnique<FTLLRN_CurveControlPointsMechanicSelectionChange>(
...
void UTLLRN_CurveControlPointsMechanic::UpdateGizmoVisibility()
{
...
void UTLLRN_CurveControlPointsMechanic::UpdateGizmoLocation()
{
	if (!PointTransformGizmo)
	{
		return;
...
void UTLLRN_CurveControlPointsMechanic::SetPlane(const FFrame3d& DrawPlaneIn)
{
...
void UTLLRN_CurveControlPointsMechanic::SetSnappingEnabled(bool bOn)
{
	bSnappingEnabled = bOn;
}

void UTLLRN_CurveControlPointsMechanic::AddSnapLine(int32 LineID, const FLine3d& Line)
{
	SnapEngine.AddLineTarget(Line, LineSnapIDMin + LineID, LineSnapPriority);
}

void UTLLRN_CurveControlPointsMechanic::RemoveSnapLine(int32 LineID)
{
	SnapEngine.RemoveLineTargetsByID(LineSnapIDMin + LineID);
}

bool UTLLRN_CurveControlPointsMechanic::DeselectPoint(int32 PointID)
{
...
void UTLLRN_CurveControlPointsMechanic::SelectPoint(int32 PointID)
{
...
void UTLLRN_CurveControlPointsMechanic::ClearSelection()
{
	ChangeSelection(-1, false);
}

FInputRayHit UTLLRN_CurveControlPointsMechanic::BeginHoverSequenceHitTest(const FInputDeviceRay& PressPos)
{
	FInputRayHit Result;
...
void UTLLRN_CurveControlPointsMechanic::OnBeginHover(const FInputDeviceRay& DevicePos)
{
	OnUpdateHover(DevicePos);
}

void UTLLRN_CurveControlPointsMechanic::ClearHover()
{
	if (HoveredPointID >= 0)
	{
...
void UTLLRN_CurveControlPointsMechanic::UpdateSnapTargetsForHover()
{
	if (ControlPoints.Num() == 0)
	{
		// Clear targets
...
void UTLLRN_CurveControlPointsMechanic::UpdateSnapHistoryPoint(int32 Index, FVector3d NewPosition)
{
	SnapEngine.RemoveHistoryPoint(Index);
	SnapEngine.InsertHistoryPoint(NewPosition, Index);
}

bool UTLLRN_CurveControlPointsMechanic::OnUpdateHover(const FInputDeviceRay& DevicePos)
{
	FGeometrySet3::FNearest Nearest;
...
void UTLLRN_CurveControlPointsMechanic::OnEndHover()
{
	ClearHover();
	SnapEngine.ResetActiveSnap();
}
...
void UTLLRN_CurveControlPointsMechanic::OnUpdateModifierState(int ModifierID, bool bIsOn)
{
...
void UTLLRN_CurveControlPointsMechanic::DeleteSelectedPoints()
{
	if (SelectedPointIDs.Num() == 0)
	{
		return;
...
int32 UTLLRN_CurveControlPointsMechanic::DeletePoint(int32 PointID)
{
	int32 SequencePosition = ControlPoints.GetSequencePosition(PointID);
...
FTLLRN_CurveControlPointsMechanicSelectionChange::FTLLRN_CurveControlPointsMechanicSelectionChange(int32 PointIDIn, 
...
void FTLLRN_CurveControlPointsMechanicSelectionChange::Apply(UObject* Object)
{
	UTLLRN_CurveControlPointsMechanic* Mechanic = Cast<UTLLRN_CurveControlPointsMechanic>(Object);
	if (Added)
	{
...
void FTLLRN_CurveControlPointsMechanicSelectionChange::Revert(UObject* Object)
{
	UTLLRN_CurveControlPointsMechanic* Mechanic = Cast<UTLLRN_CurveControlPointsMechanic>(Object);
	if (Added)
	{
...
FString FTLLRN_CurveControlPointsMechanicSelectionChange::ToString() const
{
	return TEXT("FTLLRN_CurveControlPointsMechanicSelectionChange");
}


FTLLRN_CurveControlPointsMechanicInsertionChange::FTLLRN_CurveControlPointsMechanicInsertionChange(int32 SequencePositionIn,
...
void FTLLRN_CurveControlPointsMechanicInsertionChange::Apply(UObject* Object)
{
	UTLLRN_CurveControlPointsMechanic* Mechanic = Cast<UTLLRN_CurveControlPointsMechanic>(Object);
	if (Added)
	{
...
void FTLLRN_CurveControlPointsMechanicInsertionChange::Revert(UObject* Object)
{
	UTLLRN_CurveControlPointsMechanic* Mechanic = Cast<UTLLRN_CurveControlPointsMechanic>(Object);
	if (Added)
	{
...
FString FTLLRN_CurveControlPointsMechanicInsertionChange::ToString() const
{
	return TEXT("FTLLRN_CurveControlPointsMechanicSelectionChange");
}

FTLLRN_CurveControlPointsMechanicModeChange::FTLLRN_CurveControlPointsMechanicModeChange(bool bDoneWithInitializationIn, bool bIsLoopIn, int32 ChangeStampIn)
	: bDoneWithInitialization(bDoneWithInitializationIn)
	, bIsLoop(bIsLoopIn)
	, ChangeStamp(ChangeStampIn)
{}

void FTLLRN_CurveControlPointsMechanicModeChange::Apply(UObject* Object)
{
	UTLLRN_CurveControlPointsMechanic* Mechanic = Cast<UTLLRN_CurveControlPointsMechanic>(Object);
...
void FTLLRN_CurveControlPointsMechanicModeChange::Revert(UObject* Object)
{
	UTLLRN_CurveControlPointsMechanic* Mechanic = Cast<UTLLRN_CurveControlPointsMechanic>(Object);
	if (bDoneWithInitialization)
	{
...
FString FTLLRN_CurveControlPointsMechanicModeChange::ToString() const
{
	return TEXT("FTLLRN_CurveControlPointsMechanicModeChange");
}


FTLLRN_CurveControlPointsMechanicMovementChange::FTLLRN_CurveControlPointsMechanicMovementChange(int32 PointIDIn,
...
void FTLLRN_CurveControlPointsMechanicMovementChange::Apply(UObject* Object)
{
	UTLLRN_CurveControlPointsMechanic* Mechanic = Cast<UTLLRN_CurveControlPointsMechanic>(Object);
...
void FTLLRN_CurveControlPointsMechanicMovementChange::Revert(UObject* Object)
{
	UTLLRN_CurveControlPointsMechanic* Mechanic = Cast<UTLLRN_CurveControlPointsMechanic>(Object);
...
FString FTLLRN_CurveControlPointsMechanicMovementChange::ToString() const
{
	return TEXT("FTLLRN_CurveControlPointsMechanicMovementChange");
}
...
UTLLRN_CurveControlPointsMechanic::FOrderedPoints::FOrderedPoints(const FOrderedPoints& ToCopy)
	: Vertices(ToCopy.Vertices)
	, Sequence(ToCopy.Sequence)
{
}

UTLLRN_CurveControlPointsMechanic::FOrderedPoints::FOrderedPoints(const TArray<FVector3d>& PointSequence)
{
	ReInitialize(PointSequence);
}

int32 UTLLRN_CurveControlPointsMechanic::FOrderedPoints::AppendPoint(const FVector3d& PointCoordinates)
{
...
int32 UTLLRN_CurveControlPointsMechanic::FOrderedPoints::InsertPointAt(int32 SequencePosition, 
...
int32 UTLLRN_CurveControlPointsMechanic::FOrderedPoints::RemovePointAt(int32 SequencePosition)
{
...
void UTLLRN_CurveControlPointsMechanic::FOrderedPoints::Empty()
{
	Vertices.Empty();
	Sequence.Empty();
...
void UTLLRN_CurveControlPointsMechanic::FOrderedPoints::ReInitialize(const TArray<FVector3d>& PointSequence)
{
	Empty();
