...
#include UE_INLINE_GENERATED_CPP_BY_NAME(TLLRN_ConstructionPlaneMechanic)

using namespace UE::Geometry;

void UTLLRN_ConstructionPlaneMechanic::Setup(UInteractiveTool* ParentToolIn)
{
	UInteractionMechanic::Setup(ParentToolIn);
}

void UTLLRN_ConstructionPlaneMechanic::Shutdown()
{
...
void UTLLRN_ConstructionPlaneMechanic::Initialize(UWorld* TargetWorld, const FFrame3d& InitialPlane)
{
	Plane = InitialPlane;
	...
	PlaneTransformProxy->OnTransformChanged.AddUObject(this, &UTLLRN_ConstructionPlaneMechanic::TransformChanged);
...
void UTLLRN_ConstructionPlaneMechanic::UpdateClickPriority(FInputCapturePriority NewPriority)
{
...
void UTLLRN_ConstructionPlaneMechanic::TransformChanged(UTransformProxy* Proxy, FTransform Transform)
{
...
void UTLLRN_ConstructionPlaneMechanic::SetDrawPlaneFromWorldPos(const FVector3d& Position, const FVector3d& Normal, bool bIgnoreNormal)
{
...
void UTLLRN_ConstructionPlaneMechanic::SetPlaneWithoutBroadcast(const FFrame3d &PlaneIn)
{
	Plane = PlaneIn;
	PlaneTransformGizmo->ReinitializeGizmoTransform(Plane.ToFTransform());
}
...
void UTLLRN_ConstructionPlaneMechanic::Tick(float DeltaTime)
{
...
void UTLLRN_ConstructionPlaneMechanic::Render(IToolsContextRenderAPI* RenderAPI)
{
	const UTLLRN_ModelingComponentsEditorSettings* Settings = GetMutableDefault<UTLLRN_ModelingComponentsEditorSettings>();
	if (bShowGrid && Settings != nullptr)
	{
		...
		{
		case ETLLRN_ModelingComponentsPlaneVisualizationMode::SimpleGrid:
		{
		...
		case ETLLRN_ModelingComponentsPlaneVisualizationMode::HierarchicalGrid:
		{
		...
		case ETLLRN_ModelingComponentsPlaneVisualizationMode::FixedScreenAreaGrid:
		{
