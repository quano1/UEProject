...
#include UE_INLINE_GENERATED_CPP_BY_NAME(TLLRN_DragAlignmentMechanic)
...
void UTLLRN_DragAlignmentMechanic::Setup(UInteractiveTool* ParentToolIn)
{	
...
void UTLLRN_DragAlignmentMechanic::Shutdown()
{
}


void UTLLRN_DragAlignmentMechanic::Render(IToolsContextRenderAPI* RenderAPI)
{
	RenderInternal(RenderAPI);
}

USceneSnappingManager* UTLLRN_DragAlignmentMechanic::GetSnappingManager()
{
	return USceneSnappingManager::Find(GetParentTool()->GetToolManager());
}

FViewCameraState UTLLRN_DragAlignmentMechanic::GetCameraState()
{
...
void UTLLRN_DragAlignmentMechanic::OnUpdateModifierState(int ModifierID, bool bIsOn)
{
...
void UTLLRN_DragAlignmentInteraction::Setup(USceneSnappingManager* SnappingManager)
{
	this->SceneSnappingManager = SnappingManager;
	SetupInternal();
}

void UTLLRN_DragAlignmentInteraction::RegisterAsBehaviorTarget(UKeyAsModifierInputBehavior* KeyModifierBehavior)
{
	KeyModifierBehavior->Initialize(this, AlignmentModifierID, FInputDeviceState::IsCtrlKeyDown);
}


void UTLLRN_DragAlignmentInteraction::OnUpdateModifierState(int ModifierID, bool bIsOn)
{
	if (ModifierID == AlignmentModifierID)
	{
		bAlignmentToggle = bIsOn;
...
void UTLLRN_DragAlignmentInteraction::Render(IToolsContextRenderAPI* RenderAPI)
{
