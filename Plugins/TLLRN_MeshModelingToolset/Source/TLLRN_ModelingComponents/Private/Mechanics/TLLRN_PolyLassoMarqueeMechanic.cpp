...
#include "Mechanics/TLLRN_PolyLassoMarqueeMechanic.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(TLLRN_PolyLassoMarqueeMechanic)

using namespace UE::Geometry;


#define LOCTEXT_NAMESPACE "UTLLRN_PolyLassoMarqueeMechanic"
...
void UTLLRN_PolyLassoMarqueeMechanic::Setup(UInteractiveTool* ParentToolIn)
{
...
bool UTLLRN_PolyLassoMarqueeMechanic::IsEnabled() const
{
	return bIsEnabled;
}

void UTLLRN_PolyLassoMarqueeMechanic::SetIsEnabled(bool bOn)
{
...
void UTLLRN_PolyLassoMarqueeMechanic::SetBasePriority(const FInputCapturePriority& Priority)
{
...
TPair<FInputCapturePriority, FInputCapturePriority> UTLLRN_PolyLassoMarqueeMechanic::GetPriorityRange() const
{
...
FInputRayHit UTLLRN_PolyLassoMarqueeMechanic::CanBeginClickDragSequence(const FInputDeviceRay& PressPos)
{
...
void UTLLRN_PolyLassoMarqueeMechanic::OnClickPress(const FInputDeviceRay& PressPos)
{
	if (!PressPos.bHas2D)
	{
		bIsDragging = false;
...
void UTLLRN_PolyLassoMarqueeMechanic::OnClickDrag(const FInputDeviceRay& DragPos)
{
	if (!DragPos.bHas2D)
	{
		return;
...
void UTLLRN_PolyLassoMarqueeMechanic::OnClickRelease(const FInputDeviceRay& ReleasePos)
{
...
void UTLLRN_PolyLassoMarqueeMechanic::OnTerminateDragSequence()
{
	bIsDragging = false;
	if (bIsInMultiClickPolygon)
	{
...
FInputRayHit UTLLRN_PolyLassoMarqueeMechanic::BeginHoverSequenceHitTest(const FInputDeviceRay& PressPos)
{
	if (bIsInMultiClickPolygon)
	{
...
bool UTLLRN_PolyLassoMarqueeMechanic::OnUpdateHover(const FInputDeviceRay& DevicePos)
{
	if (bIsInMultiClickPolygon)
	{
...
bool UTLLRN_PolyLassoMarqueeMechanic::WillCloseCurrentLasso(const FInputDeviceRay& DevicePos) const
{
...
void UTLLRN_PolyLassoMarqueeMechanic::DrawHUD(FCanvas* Canvas, IToolsContextRenderAPI* RenderAPI)
{
...
bool UTLLRN_PolyLassoMarqueeMechanic::ApproximateSelfClipPolyline(TArray<FVector2D>& Polyline)
{
	int32 N = Polyline.Num();
