...
namespace ToolSelectionUtil
{
	 ...
	 */
	TLLRN_MODELINGCOMPONENTS_API void SetNewActorSelection(UInteractiveToolManager* ToolManager, AActor* Actor);

	/**
	 * Change the active selection to the given Actors, via given ToolManager. Replaces existing selection.
	 */
	TLLRN_MODELINGCOMPONENTS_API void SetNewActorSelection(UInteractiveToolManager* ToolManager, const TArray<AActor*>& Actors);
	...
	TLLRN_MODELINGCOMPONENTS_API bool AccumulateSelectionElements(
	 ...
	 */
	TLLRN_MODELINGCOMPONENTS_API void DebugRenderGeometrySelectionElements(
		IToolsContextRenderAPI* RenderAPI,
		const UE::Geometry::FGeometrySelectionElements& Elements,
		bool bIsPreview = false);

	// todo [nickolas.drake]: remove this function when no longer used by TLLRN_GeometrySelectionManager
	void DebugRender(
		IToolsContextRenderAPI* RenderAPI,
		const UE::Geometry::FGeometrySelectionElements& Elements,
		float LineThickness,
...
struct TLLRN_MODELINGCOMPONENTS_API FSelectionRenderHelper
{
