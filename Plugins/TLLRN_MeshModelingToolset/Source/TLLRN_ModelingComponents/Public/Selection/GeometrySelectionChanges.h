 ...
 * changes to a FGeometrySelection. The point of the interface is to allow UTLLRN_GeometrySelectionManager
 * to execute the ApplyChange() and RevertChange() with the FGeometrySelectionEditor it provides.
 * So the call pattern is that the FToolCommandChange::Apply(), with the UTLLRN_GeometrySelectionManager
 * as the UObject target, will call UTLLRN_GeometrySelectionManager::ApplyChange(), which then in turn
 * will call IGeometrySelectionChange::ApplyChange()
 */
class TLLRN_MODELINGCOMPONENTS_API IGeometrySelectionChange
{
public:
 ...
 */
class TLLRN_MODELINGCOMPONENTS_API FGeometrySelectionDeltaChange : public FToolCommandChange, public IGeometrySelectionChange
{
public:
 ...
 */
class TLLRN_MODELINGCOMPONENTS_API FGeometrySelectionReplaceChange : public FToolCommandChange, public IGeometrySelectionChange
{
public:
	FGeometryIdentifier Identifier;
