...
#include "Mechanics/TLLRN_RectangleMarqueeMechanic.h"
#include "Components/DynamicMeshComponent.h"
#include "Selection/GroupTopologySelector.h"
#include "TransformTypes.h"
#include "ToolDataVisualizer.h"
#include "InteractionMechanic.h"
#include "TLLRN_MeshTopologySelectionMechanic.generated.h"

class FTLLRN_MeshTopologySelectionMechanicSelectionChange;
class UPersistentMeshSelection;
class UMouseHoverBehavior;
class UTLLRN_MeshTopologySelectionMechanic;
class UTLLRN_RectangleMarqueeMechanic;
...
UCLASS()
class TLLRN_MODELINGCOMPONENTS_API UTLLRN_MeshTopologySelectionMechanicProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()
...
public:
	...
	void Initialize(UTLLRN_MeshTopologySelectionMechanic* MechanicIn)
	{
		Mechanic = MechanicIn;
	}
...
protected:
	...
	TWeakObjectPtr<UTLLRN_MeshTopologySelectionMechanic> Mechanic;
};
...
UENUM()
enum class ETLLRN_MarqueeSelectionUpdateType
{
	OnDrag,
	OnTickAndRelease,
	OnRelease
...
UCLASS(Abstract)
class TLLRN_MODELINGCOMPONENTS_API UTLLRN_MeshTopologySelectionMechanic : public UInteractionMechanic, public IClickBehaviorTarget, public IHoverBehaviorTarget
{
	GENERATED_BODY()
...
public:
	...
	virtual ~UTLLRN_MeshTopologySelectionMechanic();
	 ...
	 */
	void SetTLLRN_MarqueeSelectionUpdateType(ETLLRN_MarqueeSelectionUpdateType InType);
	 ...
	 */
	virtual bool UpdateHighlight(const FRay& WorldRay) PURE_VIRTUAL(UTLLRN_MeshTopologySelectionMechanic::UpdateHighlight, return false; );
	 ...
	 */
	virtual bool UpdateSelection(const FRay& WorldRay, FVector3d& LocalHitPositionOut, FVector3d& LocalHitNormalOut) PURE_VIRTUAL(UTLLRN_MeshTopologySelectionMechanic::UpdateSelection, return false; );
	...
	UE_DEPRECATED(5.5, "Calling this function on the base class is not supported. It can be called on UTLLRN_PolygonSelectionMechanic.")
	void GrowSelection() {};
	UE_DEPRECATED(5.5, "Calling this function on the base class is not supported. It can be called on UTLLRN_PolygonSelectionMechanic.")
...
public:
	...
	*/
	...
	UPROPERTY()
	TObjectPtr<UTLLRN_MeshTopologySelectionMechanicProperties> Properties;
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UTLLRN_RectangleMarqueeMechanic> MarqueeMechanic;
	 ...
	 */
	UPROPERTY()
	ETLLRN_MarqueeSelectionUpdateType TLLRN_MarqueeSelectionUpdateType = ETLLRN_MarqueeSelectionUpdateType::OnDrag;
	...
	TUniquePtr<FTLLRN_MeshTopologySelectionMechanicSelectionChange> ActiveChange;
	...
	/** The actor we create internally to own the DrawnTLLRN_TriangleSetComponent */
	UPROPERTY()
	TObjectPtr<ATLLRN_PreviewGeometryActor> TLLRN_PreviewGeometryActor;

	UPROPERTY()
	TObjectPtr<UTLLRN_TriangleSetComponent> DrawnTLLRN_TriangleSetComponent;
...
public:
	...
	friend class FTLLRN_MeshTopologySelectionMechanicSelectionChange;
...
class TLLRN_MODELINGCOMPONENTS_API FTLLRN_MeshTopologySelectionMechanicSelectionChange : public FToolCommandChange
{
public:
