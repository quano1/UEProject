 ...
 */
struct TLLRN_MODELINGCOMPONENTS_API FGeometryIdentifier
{
	/**
 ...
 */
struct TLLRN_MODELINGCOMPONENTS_API FGeometrySelectionHandle
{
	FGeometryIdentifier Identifier;
 ...
 */
class TLLRN_MODELINGCOMPONENTS_API IGeometrySelectionTransformer
{
public:
 ...
 * implmentation, a IGeometrySelectorFactory is registered with the UTLLRN_GeometrySelectionManager,
 * and it creates instances based on the active selection.
 * 
 * Where possible, the UTLLRN_GeometrySelectionManager will also "sleep" a IGeometrySelector for a given
 ...
 * 
 */
class TLLRN_MODELINGCOMPONENTS_API IGeometrySelector
{
public:
 ...
 */
class TLLRN_MODELINGCOMPONENTS_API IGeometrySelectorFactory
{
public:
