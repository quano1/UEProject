...
#include "TLLRN_ToolHostCustomizationAPI.generated.h"

class UInteractiveToolManager;
struct FSlateBrush;

UINTERFACE(MinimalAPI)
class UTLLRN_ToolHostCustomizationAPI : public UInterface
{
	GENERATED_BODY()
};
 ...
 */
class ITLLRN_ToolHostCustomizationAPI
{
	GENERATED_BODY()
public:
...
public:
	/**
	 * @return existing ITLLRN_ToolHostCustomizationAPI registered in context store via the ToolManager, or nullptr if not found
	 */
	static TLLRN_MODELINGCOMPONENTS_API TScriptInterface<ITLLRN_ToolHostCustomizationAPI> Find(UInteractiveToolManager* ToolManager);
};