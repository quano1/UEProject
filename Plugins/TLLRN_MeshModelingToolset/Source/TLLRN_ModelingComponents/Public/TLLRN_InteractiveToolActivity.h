...
#include "TLLRN_InteractiveToolActivity.generated.h"
 ...
 */
UCLASS()
class TLLRN_MODELINGCOMPONENTS_API UTLLRN_InteractiveToolActivity : public UInteractionMechanic
{
	GENERATED_BODY()
...
public:
	...
	virtual ~UTLLRN_InteractiveToolActivity() {}
...
UINTERFACE()
class TLLRN_MODELINGCOMPONENTS_API UTLLRN_ToolActivityHost : public UInterface
{
	GENERATED_BODY()
};

class TLLRN_MODELINGCOMPONENTS_API ITLLRN_ToolActivityHost
{
	GENERATED_BODY()
public:
	 ...
	 */
	virtual void NotifyActivitySelfEnded(UTLLRN_InteractiveToolActivity* Activity) = 0;
};