...
#include "TLLRN_GeometrySelectionVisualizationProperties.generated.h"

//~Keep this synchronised with EGeometryElementType
UENUM()
enum class ETLLRN_GeometrySelectionElementType : uint8
{
	Vertex = 1,
	Edge = 2,
	Face = 4
...
UENUM()
enum class ETLLRN_GeometrySelectionTopologyType : uint8
{
	Triangle = 1,
	Polygroup = 2
};
...
UCLASS()
class TLLRN_MODELINGCOMPONENTS_API UTLLRN_GeometrySelectionVisualizationProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()
...
public:
	 ...
	 */
	UPROPERTY(Transient, meta=(TransientToolProperty))
	ETLLRN_GeometrySelectionElementType SelectionElementType;

	/**
	 * Topology type of the geometry selection
	 */
	UPROPERTY(Transient, meta=(TransientToolProperty))
	ETLLRN_GeometrySelectionTopologyType SelectionTopologyType;
	...
	UPROPERTY(EditAnywhere, Category = "Selection Visualization", AdvancedDisplay, meta = (HideEditConditionToggle, EditConditionHides,
		EditCondition = "SelectionElementType == ETLLRN_GeometrySelectionElementType::Edge && bEnableShowEdgeSelectionVertices"))
	bool bShowEdgeSelectionVertices = false;

	/** Line thickness used to render the geometry selection */
	UPROPERTY(EditAnywhere, Category = "Selection Visualization", AdvancedDisplay, meta = (HideEditConditionToggle, EditConditionHides,
		EditCondition = "SelectionElementType == ETLLRN_GeometrySelectionElementType::Edge || (bEnableShowTriangleROIBorder && bShowTriangleROIBorder)"))
	...
	UPROPERTY(EditAnywhere, Category = "Selection Visualization", AdvancedDisplay, meta = (HideEditConditionToggle, EditConditionHides,
		EditCondition = "SelectionElementType == ETLLRN_GeometrySelectionElementType::Vertex || (SelectionElementType == ETLLRN_GeometrySelectionElementType::Edge && bShowEdgeSelectionVertices && bEnableShowEdgeSelectionVertices)"))
	...
	UPROPERTY(EditAnywhere, Category = "Selection Visualization", AdvancedDisplay, meta = (UIMin = -2.0, UIMax = 2.0, HideEditConditionToggle, EditConditionHides,
		EditCondition = "(bEnableShowTriangleROIBorder && bShowTriangleROIBorder) || (bShowSelection && SelectionElementType != ETLLRN_GeometrySelectionElementType::Face)"))
	...
	UPROPERTY(EditAnywhere, Category = "Selection Visualization", AdvancedDisplay, meta = (HideEditConditionToggle, EditConditionHides,
		EditCondition = "false && SelectionElementType == ETLLRN_GeometrySelectionElementType::Face"),
	...
	/** Color used to render the geometry selection */
	UPROPERTY(EditAnywhere, Category = "Selection Visualization", AdvancedDisplay, meta = (HideEditConditionToggle, EditConditionHides,
		EditCondition = "SelectionElementType == ETLLRN_GeometrySelectionElementType::Edge"),
		DisplayName = "Selection Color")
	FColor LineColor = DefaultLineColor;

	/** Color used to render the geometry selection */
	UPROPERTY(EditAnywhere, Category = "Selection Visualization", AdvancedDisplay, meta = (HideEditConditionToggle, EditConditionHides,
		EditCondition = "SelectionElementType == ETLLRN_GeometrySelectionElementType::Vertex"),
		DisplayName = "Selection Color")
