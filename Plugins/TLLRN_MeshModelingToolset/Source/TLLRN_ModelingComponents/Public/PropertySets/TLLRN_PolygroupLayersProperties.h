...
#include "TLLRN_PolygroupLayersProperties.generated.h"
 ...
 */
UCLASS()
class TLLRN_MODELINGCOMPONENTS_API UTLLRN_PolygroupLayersProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()
public:
