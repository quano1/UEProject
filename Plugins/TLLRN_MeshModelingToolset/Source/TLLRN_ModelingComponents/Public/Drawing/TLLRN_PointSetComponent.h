...
#include "TLLRN_PointSetComponent.generated.h"
...
/**
 * UTLLRN_PointSetComponent is a Component that draws a set of points, as small squares.
 ...
 */
UCLASS()
class TLLRN_MODELINGCOMPONENTS_API UTLLRN_PointSetComponent : public UMeshComponent
{
	GENERATED_BODY()

public:
	UTLLRN_PointSetComponent();
