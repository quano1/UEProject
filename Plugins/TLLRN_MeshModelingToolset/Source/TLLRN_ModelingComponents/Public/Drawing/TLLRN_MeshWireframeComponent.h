...
#include "TLLRN_MeshWireframeComponent.generated.h"
 ...
 * to populate/update a UTLLRN_MeshWireframeComponent when necessary.
 */
...
/**
 * UTLLRN_MeshWireframeComponent draws a mesh wireframe as lines, with line color/thickness
 ...
 */
UCLASS()
class TLLRN_MODELINGCOMPONENTS_API UTLLRN_MeshWireframeComponent : public UMeshComponent
{
	GENERATED_BODY()

public:
	UTLLRN_MeshWireframeComponent();
...
public:
	 ...
	 * Client of UTLLRN_MeshWireframeComponent can set this if desired, eg to fraction of target object bounding box size, etc.
	 */
	UPROPERTY(EditAnywhere, Category=MeshWireframe)
