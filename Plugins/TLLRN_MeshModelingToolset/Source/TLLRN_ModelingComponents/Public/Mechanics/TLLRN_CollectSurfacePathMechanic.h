...
#include "TLLRN_CollectSurfacePathMechanic.generated.h"
 ...
 */
UCLASS()
class TLLRN_MODELINGCOMPONENTS_API UTLLRN_CollectSurfacePathMechanic : public UInteractionMechanic
{
	GENERATED_BODY()
public:
...
public:
	UTLLRN_CollectSurfacePathMechanic();
