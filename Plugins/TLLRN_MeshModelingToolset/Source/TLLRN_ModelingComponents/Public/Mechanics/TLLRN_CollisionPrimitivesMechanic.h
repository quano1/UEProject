...
#include "TLLRN_CollisionPrimitivesMechanic.generated.h"
...
UCLASS()
class TLLRN_MODELINGCOMPONENTS_API UTLLRN_CollisionPrimitivesMechanic : 
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UTLLRN_LineSetComponent> DrawnPrimitiveEdges;
	...
	class FTLLRN_CollisionPrimitivesMechanicSelectionChange : public FToolCommandChange
	{
	public:
		FTLLRN_CollisionPrimitivesMechanicSelectionChange(int32 PrimitiveIDIn, bool bAddedIn, const FTransform& PreviousTransformIn,
													 const FTransform& NewTransformIn, int32 ChangeStampIn);

		FTLLRN_CollisionPrimitivesMechanicSelectionChange(const TSet<int32>& PrimitiveIDsIn, bool bAddedIn, const FTransform& PreviousTransformIn,
													 const FTransform& NewTransformIn, int32 ChangeStampIn);
		...
		{
			return Cast<UTLLRN_CollisionPrimitivesMechanic>(Object)->CurrentChangeStamp != ChangeStamp;
		}
	...
	class FTLLRN_CollisionPrimitivesMechanicGeometryChange : public FToolCommandChange
	{
	public:

		FTLLRN_CollisionPrimitivesMechanicGeometryChange(
