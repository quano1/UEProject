...
#include "TLLRN_SpatialCurveDistanceMechanic.generated.h"

/**
 *
 */
UCLASS()
class TLLRN_MODELINGCOMPONENTS_API UTLLRN_SpatialCurveDistanceMechanic : public UInteractionMechanic
{
	GENERATED_BODY()
public:
