...
#include "TLLRN_PolyLassoMarqueeMechanic.generated.h"
...
/// 
struct TLLRN_MODELINGCOMPONENTS_API FCameraPolyLasso
{
 ...
 */
UCLASS()
class TLLRN_MODELINGCOMPONENTS_API UTLLRN_PolyLassoMarqueeMechanic : public UInteractionMechanic, public IClickDragBehaviorTarget, public IHoverBehaviorTarget
{
	GENERATED_BODY()
