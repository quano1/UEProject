...
#include "TLLRN_ConstructionPlaneMechanic.generated.h"
...
/**
 * UTLLRN_ConstructionPlaneMechanic implements an interaction in which a 3D plane can be
 ...
 */
UCLASS()
class TLLRN_MODELINGCOMPONENTS_API UTLLRN_ConstructionPlaneMechanic : public UInteractionMechanic
{
	GENERATED_BODY()
public:
