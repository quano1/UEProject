...
#include "TLLRN_PlaneDistanceFromHitMechanic.generated.h"

/**
 * UTLLRN_PlaneDistanceFromHitMechanic implements an interaction where a Height/Distance from a plane
 ...
 */
UCLASS()
class TLLRN_MODELINGCOMPONENTS_API UTLLRN_PlaneDistanceFromHitMechanic : public UInteractionMechanic
{
	GENERATED_BODY()
