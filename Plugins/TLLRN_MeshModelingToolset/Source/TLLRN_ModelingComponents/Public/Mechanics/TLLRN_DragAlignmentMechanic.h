...
#include "TLLRN_DragAlignmentMechanic.generated.h"
...
/**
 * FDragAlignmentBase is a base class for shared functionality of UTLLRN_DragAlignmentMechanic and UTLLRN_DragAlignmentInteraction.
 ...
 */
class TLLRN_MODELINGCOMPONENTS_API FDragAlignmentBase
{
public:
 ...
 */
UCLASS()
class TLLRN_MODELINGCOMPONENTS_API UTLLRN_DragAlignmentMechanic : public UInteractionMechanic, public FDragAlignmentBase, public IModifierToggleBehaviorTarget
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class TLLRN_MODELINGCOMPONENTS_API UTLLRN_DragAlignmentInteraction : public UObject, public FDragAlignmentBase, public IModifierToggleBehaviorTarget
{
	GENERATED_BODY()
