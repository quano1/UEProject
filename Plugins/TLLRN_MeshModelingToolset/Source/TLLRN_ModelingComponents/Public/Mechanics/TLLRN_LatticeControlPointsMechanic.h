...
#include "TLLRN_RectangleMarqueeMechanic.h"
...
#include "TLLRN_LatticeControlPointsMechanic.generated.h"
...
UCLASS()
class TLLRN_MODELINGCOMPONENTS_API UTLLRN_LatticeControlPointsMechanic : 
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UTLLRN_LineSetComponent> DrawnLatticeEdges;
	...
	// Default modifier key behavior is consistent with TLLRN_PolygonSelectionMechanic
	...
	friend class FTLLRN_LatticeControlPointsMechanicSelectionChange;
	friend class FTLLRN_LatticeControlPointsMechanicMovementChange;
...
class TLLRN_MODELINGCOMPONENTS_API FTLLRN_LatticeControlPointsMechanicSelectionChange : public FToolCommandChange
{
public:
	FTLLRN_LatticeControlPointsMechanicSelectionChange(int32 PointIDIn, bool bAddedIn, const FTransform& PreviousTransformIn,
												 const FTransform& NewTransformIn, int32 ChangeStampIn);

	FTLLRN_LatticeControlPointsMechanicSelectionChange(const TSet<int32>& PointIDsIn, bool bAddedIn, const FTransform& PreviousTransformIn,
												 const FTransform& NewTransformIn, int32 ChangeStampIn);
	...
	{
		return Cast<UTLLRN_LatticeControlPointsMechanic>(Object)->CurrentChangeStamp != ChangeStamp;
	}
...
class TLLRN_MODELINGCOMPONENTS_API FTLLRN_LatticeControlPointsMechanicMovementChange : public FToolCommandChange
{
public:

	FTLLRN_LatticeControlPointsMechanicMovementChange(
