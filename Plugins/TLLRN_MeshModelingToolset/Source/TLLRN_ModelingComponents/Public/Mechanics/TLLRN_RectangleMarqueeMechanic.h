...
#include "TLLRN_RectangleMarqueeMechanic.generated.h"
...
///		  left or vice-versa
/// 
struct TLLRN_MODELINGCOMPONENTS_API FCameraRectangle
{
 ...
 */
UCLASS()
class TLLRN_MODELINGCOMPONENTS_API UTLLRN_RectangleMarqueeMechanic : public UInteractionMechanic, public IClickDragBehaviorTarget
{
	GENERATED_BODY()

public:
	/** 
	 * If true, then the UTLLRN_RectangleMarqueeMechanic will not create an internal UClickDragInputBehavior in ::Setup(), allowing
	...
	/**
	 * If true, then the UTLLRN_RectangleMarqueeMechanic will not query the tool manager for the current camera view state,
...
/*
 * UTLLRN_RectangleMarqueeInteraction is a simplified version of UTLLRN_RectangleMarqueeMechanic that is not a UInteractionMechanic,
 ...
 */
UCLASS()
class TLLRN_MODELINGCOMPONENTS_API UTLLRN_RectangleMarqueeInteraction : public UObject, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
