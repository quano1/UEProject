...
#include "TLLRN_CurveControlPointsMechanic.generated.h"
 ...
 * - Lump the point/line set components into TLLRN_PreviewGeometryActor.
 */
UCLASS()
class TLLRN_MODELINGCOMPONENTS_API UTLLRN_CurveControlPointsMechanic : public UInteractionMechanic, public IClickBehaviorTarget, public IHoverBehaviorTarget
{
	GENERATED_BODY()
...
public:
	...
	virtual ~UTLLRN_CurveControlPointsMechanic();
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UTLLRN_PointSetComponent> DrawnControlPoints;
	UPROPERTY()
	TObjectPtr<UTLLRN_LineSetComponent> DrawnControlSegments;
	...
	UPROPERTY()
	TObjectPtr<UTLLRN_PointSetComponent> PreviewPoint;
	UPROPERTY()
	TObjectPtr<UTLLRN_LineSetComponent> PreviewSegment;
	...
	friend class FTLLRN_CurveControlPointsMechanicSelectionChange;
	friend class FTLLRN_CurveControlPointsMechanicInsertionChange;
	friend class FTLLRN_CurveControlPointsMechanicMovementChange;
	friend class FTLLRN_CurveControlPointsMechanicModeChange;
};


// Undo/redo support:

class TLLRN_MODELINGCOMPONENTS_API FTLLRN_CurveControlPointsMechanicSelectionChange : public FToolCommandChange
{
public:
	FTLLRN_CurveControlPointsMechanicSelectionChange(int32 SequencePositionIn, bool AddedIn, int32 ChangeStampIn);

	virtual void Apply(UObject* Object) override;
	virtual void Revert(UObject* Object) override;
	virtual bool HasExpired(UObject* Object) const override
	{
		return Cast<UTLLRN_CurveControlPointsMechanic>(Object)->CurrentChangeStamp != ChangeStamp;
	}
...
class TLLRN_MODELINGCOMPONENTS_API FTLLRN_CurveControlPointsMechanicInsertionChange : public FToolCommandChange
{
public:
	FTLLRN_CurveControlPointsMechanicInsertionChange(int32 SequencePositionIn, int32 PointID, 
...
class TLLRN_MODELINGCOMPONENTS_API FTLLRN_CurveControlPointsMechanicModeChange : public FToolCommandChange
{
public:
	FTLLRN_CurveControlPointsMechanicModeChange(bool bDoneWithInitializationIn, bool bIsLoopIn, int32 ChangeStampIn);
...
class TLLRN_MODELINGCOMPONENTS_API FTLLRN_CurveControlPointsMechanicMovementChange : public FToolCommandChange
{
public:
	FTLLRN_CurveControlPointsMechanicMovementChange(int32 PointIDIn, const FVector3d& OriginalPositionIn, 
