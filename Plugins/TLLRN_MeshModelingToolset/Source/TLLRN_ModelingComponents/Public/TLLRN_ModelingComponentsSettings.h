...
#include "TLLRN_ModelingComponentsSettings.generated.h"
...
class TLLRN_MODELINGCOMPONENTS_API UTLLRN_ModelingComponentsSettings : public UDeveloperSettings
{
	GENERATED_BODY()
...
public:
	...
	static void ApplyDefaultsToTLLRN_CreateMeshObjectParams(FTLLRN_CreateMeshObjectParams& Params);
...
UENUM()
enum class ETLLRN_ModelingComponentsPlaneVisualizationMode : uint8
{
...
class TLLRN_MODELINGCOMPONENTS_API UTLLRN_ModelingComponentsEditorSettings : public UDeveloperSettings
{
	GENERATED_BODY()
...
public:
	...
	ETLLRN_ModelingComponentsPlaneVisualizationMode GridMode = ETLLRN_ModelingComponentsPlaneVisualizationMode::SimpleGrid;

	/** The number of lines to be drawn for the plane */
	UPROPERTY(EditAnywhere, NonTransactional, Category = "Modeling Tools|Work Plane Configuration", meta = (ClampMin = 2, EditCondition = "GridMode != ETLLRN_ModelingComponentsPlaneVisualizationMode::HierarchicalGrid", EditConditionHides))
	int NumGridLines = 21;

	/** The space between grid lines in world space */
	UPROPERTY(EditAnywhere, NonTransactional, Category = "Modeling Tools|Work Plane Configuration", meta = (ClampMin = 0, EditCondition = "GridMode == ETLLRN_ModelingComponentsPlaneVisualizationMode::SimpleGrid", EditConditionHides))
	float GridSpacing = 100.0f;

	/** The base scale used to determine the size of the hierarchical plane */
	UPROPERTY(EditAnywhere, NonTransactional, Category = "Modeling Tools|Work Plane Configuration", meta = (ClampMin = 1, EditCondition = "GridMode == ETLLRN_ModelingComponentsPlaneVisualizationMode::HierarchicalGrid", EditConditionHides))
	float GridScale = 1.0f;

	/** The fraction of the viewport that the grid should occupy if looking at the plane's center */
	UPROPERTY(EditAnywhere, NonTransactional, Category = "Modeling Tools|Work Plane Configuration", meta = (ClampMin = 0, ClampMax = 2, EditCondition = "GridMode == ETLLRN_ModelingComponentsPlaneVisualizationMode::FixedScreenAreaGrid", EditConditionHides))
	float GridSize = 0.5;
