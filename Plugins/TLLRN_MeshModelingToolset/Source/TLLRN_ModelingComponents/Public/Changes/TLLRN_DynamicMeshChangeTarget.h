...
#include "TLLRN_DynamicMeshChangeTarget.generated.h"
 ...
 */
UCLASS(Transient)
class TLLRN_MODELINGCOMPONENTS_API UTLLRN_DynamicMeshReplacementChangeTarget : public UObject, public IMeshReplacementCommandChangeTarget
{
	GENERATED_BODY()
...
public:
	UTLLRN_DynamicMeshReplacementChangeTarget() = default;
	UTLLRN_DynamicMeshReplacementChangeTarget(TSharedPtr<const FDynamicMesh3, ESPMode::ThreadSafe> Mesh) : Mesh(Mesh)
	{}
	virtual ~UTLLRN_DynamicMeshReplacementChangeTarget() = default;
