 ...
 */
struct TLLRN_MODELINGCOMPONENTS_API FComponentCollisionSettings
{
 ...
 */
TLLRN_MODELINGCOMPONENTS_API bool ComponentTypeSupportsCollision(
 ...
 */
TLLRN_MODELINGCOMPONENTS_API FComponentCollisionSettings GetCollisionSettings(
	const UPrimitiveComponent* Component);

/**
 * Get current Component collision shapes 
 */
TLLRN_MODELINGCOMPONENTS_API bool GetCollisionShapes(const UPrimitiveComponent* Component, FKAggregateGeom& AggGeomOut);

/**
 * Get current Component collision shapes 
 */
TLLRN_MODELINGCOMPONENTS_API bool GetCollisionShapes(const UPrimitiveComponent* Component, FSimpleShapeSet3d& ShapeSetOut);
 ...
 */
TLLRN_MODELINGCOMPONENTS_API bool TransformSimpleCollision(
 ...
 */
TLLRN_MODELINGCOMPONENTS_API bool SetSimpleCollision(
	UPrimitiveComponent* Component,
 ...
 */
TLLRN_MODELINGCOMPONENTS_API bool AppendSimpleCollision(
 ...
 */
TLLRN_MODELINGCOMPONENTS_API void UpdateSimpleCollision(
 ...
 */
TLLRN_MODELINGCOMPONENTS_API const UBodySetup* GetBodySetup(const UPrimitiveComponent* SourceComponent);
/**
 * @return BodySetup on the given SourceComponent, or nullptr if no BodySetup was found
 */
TLLRN_MODELINGCOMPONENTS_API UBodySetup* GetBodySetup(UPrimitiveComponent* SourceComponent);
 ...
 */
TLLRN_MODELINGCOMPONENTS_API void ConvertSimpleCollisionToMeshes(
...
TLLRN_MODELINGCOMPONENTS_API void ConvertSimpleCollisionToDynamicMeshes(
 ...
 * @param bSetToPerTriangleNormals if true and the mesh has a normals attribute overlay, the mesh is set to face normals, otherwise averaged vertex normals
 */
TLLRN_MODELINGCOMPONENTS_API bool ConvertComplexCollisionToMeshes(
