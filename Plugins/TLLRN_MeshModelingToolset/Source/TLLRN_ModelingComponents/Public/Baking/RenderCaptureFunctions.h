...
#include "Baking/TLLRN_BakingTypes.h"
...
class TLLRN_MODELINGCOMPONENTS_API FRenderCaptureOcclusionHandler
{
public:
...
class TLLRN_MODELINGCOMPONENTS_API FSceneCapturePhotoSetSampler : public FMeshBakerDynamicMeshSampler
{
public:
...
struct TLLRN_MODELINGCOMPONENTS_API FSceneCaptureConfig
{
...
TUniquePtr<FMeshMapBaker> MakeRenderCaptureBaker(
	...
	int32 TargetUVLayer,
	ETLLRN_BakeTextureResolution TextureImageSize,
	ETLLRN_BakeTextureSamplesPerPixel SamplesPerPixel,
	FRenderCaptureOcclusionHandler* OcclusionHandler);

struct TLLRN_MODELINGCOMPONENTS_API FRenderCaptureTextures
{
...
struct UE_DEPRECATED(5.3, "FRenderCaptureOptions is only used by deprecated functions, see those deprecation notes for more info.") TLLRN_MODELINGCOMPONENTS_API FRenderCaptureOptions
{
	//
...
struct UE_DEPRECATED(5.3, "FRenderCaptureUpdate is only used by deprecated functions, see those deprecation notes for more info.") TLLRN_MODELINGCOMPONENTS_API FRenderCaptureUpdate
{
