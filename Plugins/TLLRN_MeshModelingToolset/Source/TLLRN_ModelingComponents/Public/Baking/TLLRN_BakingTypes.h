...
#include "TLLRN_BakingTypes.generated.h"

UENUM()
enum class ETLLRN_BakeTextureResolution 
{
...
UENUM()
enum class ETLLRN_BakeTextureBitDepth
{
...
UENUM()
enum class ETLLRN_BakeTextureSamplesPerPixel
{
