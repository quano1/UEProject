...
#include "TLLRN_DynamicMeshCommitter.generated.h"

PREDECLARE_GEOMETRY(class FDynamicMesh3);


UINTERFACE()
class TLLRN_MODELINGCOMPONENTS_API UTLLRN_DynamicMeshCommitter : public UInterface
{
	GENERATED_BODY()
};

class TLLRN_MODELINGCOMPONENTS_API ITLLRN_DynamicMeshCommitter
{
	GENERATED_BODY()
...
public:
	 ...
	 */
	struct TLLRN_MODELINGCOMPONENTS_API FDynamicMeshCommitInfo
	{
