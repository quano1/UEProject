...
#include "TLLRN_DynamicMeshSource.generated.h"

class UDynamicMesh;
class UDynamicMeshComponent;

UINTERFACE()
class TLLRN_MODELINGCOMPONENTS_API UPersistentTLLRN_DynamicMeshSource : public UInterface
{
	GENERATED_BODY()
};

class TLLRN_MODELINGCOMPONENTS_API IPersistentTLLRN_DynamicMeshSource
{
	GENERATED_BODY()
