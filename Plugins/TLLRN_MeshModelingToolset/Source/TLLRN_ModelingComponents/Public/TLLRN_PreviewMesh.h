...
#include "TLLRN_PreviewMesh.generated.h"
...
/**
 * UTLLRN_PreviewMesh internally spawns a ATLLRN_PreviewMeshActor to hold the preview mesh object.
...
class TLLRN_MODELINGCOMPONENTS_API ATLLRN_PreviewMeshActor : public AInternalToolFrameworkActor
{
	GENERATED_BODY()
private:
	ATLLRN_PreviewMeshActor();
public:
...
/** 
 * UTLLRN_PreviewMesh is a utility object that spawns and owns a transient mesh object in the World.
 ...
 * 
 * The intention with UTLLRN_PreviewMesh is to provide a higher-level interface than the Component.
 * In future the internal Component may be replaced with another class (eg TLLRN_OctreeDynamicMeshComponent),
 ...
 */
UCLASS(Transient)
class TLLRN_MODELINGCOMPONENTS_API UTLLRN_PreviewMesh : public UObject, public IMeshVertexCommandChangeTarget, public IMeshCommandChangeTarget, public IMeshReplacementCommandChangeTarget
{
	GENERATED_BODY()
public:
	UTLLRN_PreviewMesh();
	virtual ~UTLLRN_PreviewMesh();
	...
	/**
	 * @return internal Actor created by this UTLLRN_PreviewMesh
	 */
	...
	*/
	 ...
	 */
	TUniquePtr<FDynamicMesh3> ExtractTLLRN_PreviewMesh() const;
...
protected:
	...
	ATLLRN_PreviewMeshActor* TemporaryParentActor = nullptr;
