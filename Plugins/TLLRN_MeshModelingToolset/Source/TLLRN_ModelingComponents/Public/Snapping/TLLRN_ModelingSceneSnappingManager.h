...
#include "TLLRN_ModelingSceneSnappingManager.generated.h"
...
/**
 * UTLLRN_ModelingSceneSnappingManager is an implementation of snapping suitable for use in
 ...
 */
UCLASS()
class TLLRN_MODELINGCOMPONENTS_API UTLLRN_ModelingSceneSnappingManager : public USceneSnappingManager
{
	GENERATED_BODY()
...
{
	//
	// The functions below are helper functions that simplify usage of a UTLLRN_ModelingSceneSnappingManager 
	// that is registered as a ContextStoreObject in an InteractiveToolsContext
	//

	/**
	 * If one does not already exist, create a new instance of UTLLRN_ModelingSceneSnappingManager and add it to the
	 * ToolsContext's ContextObjectStore
	 * @return true if the ContextObjectStore now has a UTLLRN_ModelingSceneSnappingManager (whether it already existed, or was created)
	 */
	TLLRN_MODELINGCOMPONENTS_API bool RegisterSceneSnappingManager(UInteractiveToolsContext* ToolsContext);

	/**
	 * Remove any existing UTLLRN_ModelingSceneSnappingManager from the ToolsContext's ContextObjectStore
	 * @return true if the ContextObjectStore no longer has a UTLLRN_ModelingSceneSnappingManager (whether it was removed, or did not exist)
	 */
	TLLRN_MODELINGCOMPONENTS_API bool DeregisterSceneSnappingManager(UInteractiveToolsContext* ToolsContext);


	/**
	 * Find an existing UTLLRN_ModelingSceneSnappingManager in the ToolsContext's ContextObjectStore
	 * @return SelectionManager pointer or nullptr if not found
	 */
	TLLRN_MODELINGCOMPONENTS_API UTLLRN_ModelingSceneSnappingManager* FindTLLRN_ModelingSceneSnappingManager(UInteractiveToolManager* ToolManager);
