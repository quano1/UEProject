...
namespace SplineUtil {
	...
	// Used for DrawSpline()
	struct TLLRN_MODELINGCOMPONENTS_API FDrawSplineSettings
	{
		FDrawSplineSettings();
	...
	TLLRN_MODELINGCOMPONENTS_API void DrawSpline(const USplineComponent& SplineComp, IToolsContextRenderAPI& RenderAPI, const FDrawSplineSettings& Settings);
