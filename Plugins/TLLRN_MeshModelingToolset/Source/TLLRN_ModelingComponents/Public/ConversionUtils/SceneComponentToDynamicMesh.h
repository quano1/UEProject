...
namespace Conversion {
	 ...
	 */
	TArray<int32> TLLRN_MODELINGCOMPONENTS_API GetPolygonGroupToMaterialIndexMap(const UStaticMesh* StaticMesh, EMeshLODType LODType, int32 LODIndex);
	...
	*/
	bool TLLRN_MODELINGCOMPONENTS_API SceneComponentToDynamicMesh(
	 ...
	 */
	bool TLLRN_MODELINGCOMPONENTS_API StaticMeshToDynamicMesh(
	 ...
	 */
	bool TLLRN_MODELINGCOMPONENTS_API CanConvertSceneComponentToDynamicMesh(USceneComponent* SceneComponent);
