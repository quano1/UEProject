...
namespace ToolSetupUtil
{
	 ...
	 */
	TLLRN_MODELINGCOMPONENTS_API UMaterialInterface* GetDefaultMaterial();
	 ...
	 */
	TLLRN_MODELINGCOMPONENTS_API UMaterialInterface* GetDefaultMaterial(UInteractiveToolManager* ToolManager, UMaterialInterface* SourceMaterial = nullptr);

	/**
	 * @return configurable vertex color material
	 */
	TLLRN_MODELINGCOMPONENTS_API UMaterialInstanceDynamic* GetVertexColorMaterial(UInteractiveToolManager* ToolManager, bool bTwoSided = false);


	/**
	 * @return default material to use for "Working"/In-Progress animations
	 */
	TLLRN_MODELINGCOMPONENTS_API UMaterialInterface* GetDefaultWorkingMaterial(UInteractiveToolManager* ToolManager);

	/**
	 * @return default material instance to use for "Working"/In-Progress animations
	 */
	TLLRN_MODELINGCOMPONENTS_API UMaterialInstanceDynamic* GetDefaultWorkingMaterialInstance(UInteractiveToolManager* ToolManager);

	/**
	 * @return default material instance to use for "Error" animations
	 */
	TLLRN_MODELINGCOMPONENTS_API UMaterialInstanceDynamic* GetDefaultErrorMaterial(UInteractiveToolManager* ToolManager);
	 ...
	 */
	TLLRN_MODELINGCOMPONENTS_API UMaterialInstanceDynamic* GetUVCheckerboardMaterial(double CheckerDensity = 20.0);


	/**
	 * @return default material to use for brush volume indicators (for instance, a spherical sculpt brush).
	 */
	TLLRN_MODELINGCOMPONENTS_API UMaterialInstanceDynamic* GetDefaultBrushVolumeMaterial(UInteractiveToolManager* ToolManager);
	 ...
	 */
	TLLRN_MODELINGCOMPONENTS_API UMaterialInstanceDynamic* GetDefaultBrushAlphaMaterial(UInteractiveToolManager* ToolManager);
	 ...
	 */
	TLLRN_MODELINGCOMPONENTS_API UMaterialInterface* GetDefaultSculptMaterial(UInteractiveToolManager* ToolManager);
	 ...
	 */
	TLLRN_MODELINGCOMPONENTS_API UMaterialInstanceDynamic* GetTransparentSculptMaterial(UInteractiveToolManager* ToolManager, 
	 ...
	 */
	TLLRN_MODELINGCOMPONENTS_API UMaterialInterface* GetImageBasedSculptMaterial(UInteractiveToolManager* ToolManager, ImageMaterialType Type);

	/**
	 * @return Image-based sculpt material that supports changing the image
	 */
	TLLRN_MODELINGCOMPONENTS_API UMaterialInstanceDynamic* GetCustomImageBasedSculptMaterial(UInteractiveToolManager* ToolManager, UTexture* SetImage);


	/**
	 * @return Selection Material 1
	 */
	TLLRN_MODELINGCOMPONENTS_API UMaterialInterface* GetSelectionMaterial(UInteractiveToolManager* ToolManager);

	/**
	 * @return Selection Material 1 with custom color and optional depth bias (depth bias moves vertices towards the camera)
	 */
	TLLRN_MODELINGCOMPONENTS_API UMaterialInterface* GetSelectionMaterial(const FLinearColor& UseColor, UInteractiveToolManager* ToolManager, float DepthBias = 0.0f);
	 ...
	 */
	TLLRN_MODELINGCOMPONENTS_API UMaterialInstanceDynamic* GetSimpleCustomMaterial(UInteractiveToolManager* ToolManager, const FLinearColor& Color, float Opacity);

	/**
	 * @return Simple material with configurable color. The material will have opaque blend mode.
	 */
	TLLRN_MODELINGCOMPONENTS_API UMaterialInstanceDynamic* GetSimpleCustomMaterial(UInteractiveToolManager* ToolManager, const FLinearColor& Color);
	  ...
	  *  objects, so use the other overload if you do not need opacity control.
	  */
	TLLRN_MODELINGCOMPONENTS_API UMaterialInstanceDynamic* GetCustomDepthOffsetMaterial(UInteractiveToolManager* ToolManager, const FLinearColor& Color, float DepthBias, float Opacity);

	/**
	 * @return Simple material with configurable depth bias and color. The material will have opaque blend mode.
	 */
	TLLRN_MODELINGCOMPONENTS_API UMaterialInstanceDynamic* GetCustomDepthOffsetMaterial(UInteractiveToolManager* ToolManager, const FLinearColor& Color, float DepthBias);
	 ...
	 * @return Simple two-sided material with configurable depth bias, color, and opacity. Note that 
	  ...
	  *  objects, so use the other overload if you do not need opacity control.
	 */
	TLLRN_MODELINGCOMPONENTS_API UMaterialInstanceDynamic* GetCustomTwoSidedDepthOffsetMaterial(UInteractiveToolManager* ToolManager, const FLinearColor& Color, float DepthBias, float Opacity);

	/**
	 * @return Simple two-sided material with configurable depth bias and color. The material will have opaque blend mode.
	 */
	TLLRN_MODELINGCOMPONENTS_API UMaterialInstanceDynamic* GetCustomTwoSidedDepthOffsetMaterial(UInteractiveToolManager* ToolManager, const FLinearColor& Color, float DepthBias);

	/**
	 * @return Material used when editing AVolume objects using our tools.
	 */
	TLLRN_MODELINGCOMPONENTS_API UMaterialInterface* GetDefaultEditVolumeMaterial();

	/**
	 * Gets a custom material suitable for use with UTLLRN_PointSetComponent for square points.
	 * 
	 ...
	 */
	TLLRN_MODELINGCOMPONENTS_API UMaterialInterface* GetDefaultPointComponentMaterial(UInteractiveToolManager* ToolManager, bool bDepthTested = true);

	/**
	 * Gets a custom material suitable for use with UTLLRN_PointSetComponent for round points.
	 ...
	 */
	TLLRN_MODELINGCOMPONENTS_API UMaterialInterface* GetRoundPointComponentMaterial(UInteractiveToolManager* ToolManager, bool bDepthTested = true);

	/**
	 * Gets a custom material suitable for use with UTLLRN_LineSetComponent.
	 * 
	 * @param bDepthTested If true, the material will be depth tested as normal. If false, occluded portions of lines
	 *  will still be displayed, but dashed and dimmed. 
	 *  Note that the current implementations of the depth-tested and non-depth-tested modes use opaque and translucent 
	 ...
	 *  that depth bias cannot reliably order lines within a non-depth-tested line set component.
	 */
	TLLRN_MODELINGCOMPONENTS_API UMaterialInterface* GetDefaultLineComponentMaterial(UInteractiveToolManager* ToolManager, bool bDepthTested = true);

	/**
	 * @return a curve asset used for contrast adjustments when using a texture map for displacements.
	 */
	TLLRN_MODELINGCOMPONENTS_API UCurveFloat* GetContrastAdjustmentCurve(UInteractiveToolManager* ToolManager);
	 ...
	 */
	TLLRN_MODELINGCOMPONENTS_API UE::Geometry::FFrame3d GetDefaultWorldReferenceFrame(UInteractiveToolManager* ToolManager, UE::Geometry::FQuaterniond DefaultOrientation = UE::Geometry::FQuaterniond(), double NoSelectionPlacementDistance = 500);
	...
	TLLRN_MODELINGCOMPONENTS_API void ApplyRenderingConfigurationToPreview(UBaseDynamicMeshComponent* Component, UToolTarget* SourceTarget = nullptr);
	TLLRN_MODELINGCOMPONENTS_API void ApplyRenderingConfigurationToPreview(UTLLRN_PreviewMesh* TLLRN_PreviewMesh, UToolTarget* SourceTarget = nullptr);
