...
namespace UE
{
	namespace MeshDescription
	{
		 ...
		 */
		TLLRN_MODELINGCOMPONENTS_API void InitializeAutoGeneratedAttributes(FMeshDescription& Mesh, const FMeshBuildSettings* BuildSettings);
		 ...
		 */
		TLLRN_MODELINGCOMPONENTS_API void InitializeAutoGeneratedAttributes(FMeshDescription& Mesh, UStaticMesh* StaticMesh, int32 SourceLOD);
		 ...
		 * @param SourceLOD BuildSettings from this LOD Index are used
		 */
		TLLRN_MODELINGCOMPONENTS_API void InitializeAutoGeneratedAttributes(FMeshDescription& Mesh, UActorComponent* StaticMeshComponent, int32 SourceLOD);
		...
		struct TLLRN_MODELINGCOMPONENTS_API FStaticMeshBuildSettingChange
		{
		...
		TLLRN_MODELINGCOMPONENTS_API void ConfigureBuildSettings(UStaticMesh* StaticMesh, int32 SourceLOD,
