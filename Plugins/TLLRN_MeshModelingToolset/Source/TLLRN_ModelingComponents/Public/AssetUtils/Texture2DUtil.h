...
namespace AssetUtils
{
	 ...
	 */
	TLLRN_MODELINGCOMPONENTS_API bool ReadTexture(
	 ...
	 * @return true on success
	 */
	TLLRN_MODELINGCOMPONENTS_API bool ConvertToSingleChannel(UTexture2D* TextureMap);
	 ...
	 * @return true on success
	 */
	TLLRN_MODELINGCOMPONENTS_API bool ForceVirtualTexturePrefetch(FImageDimensions ScreenSpaceDimensions, bool bWaitForPrefetchToComplete = true);
	 ...
	 */
	TLLRN_MODELINGCOMPONENTS_API bool SaveDebugImage(
