...
namespace AssetUtils
{
	 ...
	 */
	struct TLLRN_MODELINGCOMPONENTS_API FStaticMeshMaterialSlot
	{
	 ...
	 */
	struct TLLRN_MODELINGCOMPONENTS_API FStaticMeshLODMaterialSetInfo
	{
	 ...
	 */
	TLLRN_MODELINGCOMPONENTS_API bool GetStaticMeshLODAssetMaterials(
	 ...
	 */
	TLLRN_MODELINGCOMPONENTS_API bool GetStaticMeshLODMaterialListBySection(
		UStaticMesh* StaticMeshAsset,
		int32 LODIndex,
	 ...
	 */
	TLLRN_MODELINGCOMPONENTS_API FName GenerateNewMaterialSlotName(
