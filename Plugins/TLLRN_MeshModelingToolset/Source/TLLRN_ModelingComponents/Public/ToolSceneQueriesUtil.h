...
namespace ToolSceneQueriesUtil
{
	 ...
	 */
	TLLRN_MODELINGCOMPONENTS_API double GetDefaultVisualAngleSnapThreshD();
	 ...
	 */
	TLLRN_MODELINGCOMPONENTS_API bool PointSnapQuery(const UInteractiveTool* Tool, const FVector3d& Point1, const FVector3d& Point2, double VisualAngleThreshold = 0);
	 ...
	 * @param VisualAngleThreshold visual angle threshold to use. If 0, GetDefaultVisualAngleSnapThresh() is used
	 */
	TLLRN_MODELINGCOMPONENTS_API bool PointSnapQuery(const FViewCameraState& CameraState, const FVector3d& Point1, const FVector3d& Point2, double VisualAngleThreshold = 0);
	 ...
	 */
	TLLRN_MODELINGCOMPONENTS_API double PointSnapMetric(const FViewCameraState& CameraState, const FVector3d& Point1, const FVector3d& Point2);

	/**
	 * @return visual angle between two 3D points, relative to the current camera position
	 */
	TLLRN_MODELINGCOMPONENTS_API double CalculateViewVisualAngleD(const UInteractiveTool* Tool, const FVector3d& Point1, const FVector3d& Point2);


	/**
	 * @return visual angle between two 3D points, relative to the current camera position
	 */
	TLLRN_MODELINGCOMPONENTS_API double CalculateViewVisualAngleD(const FViewCameraState& CameraState, const FVector3d& Point1, const FVector3d& Point2);

	/**
	 * @return visual angle between two 3D points, relative to the current camera position, normalized relative to 90-degree FOV
	 */
	TLLRN_MODELINGCOMPONENTS_API double CalculateNormalizedViewVisualAngleD(const FViewCameraState& CameraState, const FVector3d& Point1, const FVector3d& Point2);
	 ...
	 */
	TLLRN_MODELINGCOMPONENTS_API double CalculateDimensionFromVisualAngleD(const UInteractiveTool* Tool, const FVector3d& Point, double TargetVisualAngleDeg);

	/**
	 * @return (approximate) 3D dimension that corresponds to a radius of target visual angle around Point
	 */
	TLLRN_MODELINGCOMPONENTS_API double CalculateDimensionFromVisualAngleD(const FViewCameraState& CameraState, const FVector3d& Point, double TargetVisualAngleDeg);
	 ...
	 */
	TLLRN_MODELINGCOMPONENTS_API bool IsPointVisible(const FViewCameraState& CameraState, const FVector3d& Point);
	 ...
	 */
	TLLRN_MODELINGCOMPONENTS_API bool FindSceneSnapPoint(FFindSceneSnapPointParams& Params);
	 ...
	 */
	TLLRN_MODELINGCOMPONENTS_API bool FindSceneSnapPoint(const UInteractiveTool* Tool, const FVector3d& Point, FVector3d& SnapPointOut,
	 ...
	 */
	TLLRN_MODELINGCOMPONENTS_API bool FindWorldGridSnapPoint(const UInteractiveTool* Tool, const FVector3d& QueryPoint, FVector3d& GridSnapPointOut);

	/**
	 * Round the given distance to the nearest multiple of the world grid cell size
	 */
	TLLRN_MODELINGCOMPONENTS_API double SnapDistanceToWorldGridSize(const UInteractiveTool* Tool, const double Distance);

	/**
	 * @return true if HitResult is a hit on a visible Component of a visible Actor (provides correct result in Editor)
	 */
	TLLRN_MODELINGCOMPONENTS_API bool IsVisibleObjectHit(const FHitResult& HitResult);
	 ...
	 */
	TLLRN_MODELINGCOMPONENTS_API bool FindNearestVisibleObjectHit(UWorld* World, FHitResult& HitResultOut, const FVector& Start, const FVector& End,
	 ...
	 * @return true if a visible hit was found
	 */
	TLLRN_MODELINGCOMPONENTS_API bool FindNearestVisibleObjectHit(UWorld* World, FHitResult& HitResultOut, const FRay& Ray,
		const TArray<const UPrimitiveComponent*>* IgnoreComponents = nullptr, 
		const TArray<const UPrimitiveComponent*>* InvisibleComponentsToInclude = nullptr);
	...
	* @return true if a visible hit was found
	*/
	TLLRN_MODELINGCOMPONENTS_API bool FindNearestVisibleObjectHit(USceneSnappingManager* SnappingManager, 
	...
	* @return true if a visible hit was found
	*/
	TLLRN_MODELINGCOMPONENTS_API bool FindNearestVisibleObjectHit(const UInteractiveTool* Tool, FHitResult& HitResultOut, const FVector& Start, const FVector& End,
		const TArray<const UPrimitiveComponent*>* IgnoreComponents = nullptr, 
		const TArray<const UPrimitiveComponent*>* InvisibleComponentsToInclude = nullptr);
	...
	* @return true if a visible hit was found
	*/
	TLLRN_MODELINGCOMPONENTS_API bool FindNearestVisibleObjectHit(const UInteractiveTool* Tool, FHitResult& HitResultOut, const FRay& Ray,
		const TArray<const UPrimitiveComponent*>* IgnoreComponents = nullptr, 
		const TArray<const UPrimitiveComponent*>* InvisibleComponentsToInclude = nullptr);
