...
struct TLLRN_MODELINGCOMPONENTS_API FSceneGeometryPoint
{
...
struct TLLRN_MODELINGCOMPONENTS_API FSceneGeometryID
{
	int32 UniqueID;
...
class TLLRN_MODELINGCOMPONENTS_API FSceneGeometrySpatialCache
{
public:
