...
struct TLLRN_MODELINGCOMPONENTS_API FRenderCaptureConfig
{
...
FRenderCaptureConfig TLLRN_MODELINGCOMPONENTS_API GetDefaultRenderCaptureConfig(ERenderCaptureType CaptureType);

/**
 * FRenderCaptureTypeFlags is a set of per-capture-type booleans
 */
struct TLLRN_MODELINGCOMPONENTS_API FRenderCaptureTypeFlags
{
...
template <typename T>
struct TLLRN_MODELINGCOMPONENTS_API TRenderCaptureTypeData
{
 ...
 */
class TLLRN_MODELINGCOMPONENTS_API FWorldRenderCapture
{
public:
