 ...
 */
struct TLLRN_MODELINGCOMPONENTS_API FMeshTypeContainer
{
 ...
 */
struct TLLRN_MODELINGCOMPONENTS_API FMeshSceneRayHit
{
 ...
 */
class TLLRN_MODELINGCOMPONENTS_API IMeshSpatialWrapper
{
public:
 ...
 */
struct TLLRN_MODELINGCOMPONENTS_API FActorChildMesh
{
public:
	FActorChildMesh() {}
 ...
 */
struct TLLRN_MODELINGCOMPONENTS_API FActorAdapter
{
public:
	FActorAdapter() {}
 ...
 */
class TLLRN_MODELINGCOMPONENTS_API FMeshSceneAdapter
{
public:
