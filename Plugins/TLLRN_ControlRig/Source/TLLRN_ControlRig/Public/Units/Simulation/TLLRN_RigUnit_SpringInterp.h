...
#include "TLLRN_RigUnit_SpringInterp.generated.h"
...
struct TLLRN_CONTROLRIG_API FTLLRN_RigUnit_SpringInterp : public FRigVMFunction_SimBase
{
	GENERATED_BODY()
 
	FTLLRN_RigUnit_SpringInterp()
	{
...
struct TLLRN_CONTROLRIG_API FTLLRN_RigUnit_SpringInterpVector : public FRigVMFunction_SimBase
{
	GENERATED_BODY()
	
	FTLLRN_RigUnit_SpringInterpVector()
	{
...
struct TLLRN_CONTROLRIG_API FTLLRN_RigUnit_SpringInterpV2 : public FRigVMFunction_SimBase
{
	GENERATED_BODY()

	FTLLRN_RigUnit_SpringInterpV2()
	{
...
struct TLLRN_CONTROLRIG_API FTLLRN_RigUnit_SpringInterpVectorV2 : public FRigVMFunction_SimBase
{
	GENERATED_BODY()
	
	FTLLRN_RigUnit_SpringInterpVectorV2()
	{
		bUseCurrentInput = false;
...
struct TLLRN_CONTROLRIG_API FTLLRN_RigUnit_SpringInterpQuaternionV2 : public FRigVMFunction_SimBase
{
	GENERATED_BODY()
	
	// TLLRN_RigUnit_SpringInterpQuaternion is redirected to TLLRN_RigUnit_SpringInterpQuaternionV2
	FTLLRN_RigUnit_SpringInterpQuaternionV2()
	{
		bUseCurrentInput = false;
