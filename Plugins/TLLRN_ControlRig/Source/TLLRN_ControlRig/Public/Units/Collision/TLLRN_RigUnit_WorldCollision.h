...
#include "TLLRN_RigUnit_WorldCollision.generated.h"

USTRUCT()
struct TLLRN_CONTROLRIG_API FTLLRN_RigUnit_SphereTrace_WorkData
{
	GENERATED_BODY()

	FTLLRN_RigUnit_SphereTrace_WorkData()
	: Hash(INDEX_NONE)
	, bHit(false)
...
struct TLLRN_CONTROLRIG_API FTLLRN_RigUnit_SphereTraceWorld : public FTLLRN_RigUnit
{
	GENERATED_BODY()

	FTLLRN_RigUnit_SphereTraceWorld()
	...
	/** Cache / workstate */
	UPROPERTY()
	FTLLRN_RigUnit_SphereTrace_WorkData WorkData;
...
struct TLLRN_CONTROLRIG_API FTLLRN_RigUnit_SphereTraceByTraceChannel : public FTLLRN_RigUnit
{
	GENERATED_BODY()

	FTLLRN_RigUnit_SphereTraceByTraceChannel()
		: Start(EForceInit::ForceInitToZero)
		, End(EForceInit::ForceInitToZero)
...
struct TLLRN_CONTROLRIG_API FTLLRN_RigUnit_SphereTraceByObjectTypes : public FTLLRN_RigUnit
{
	GENERATED_BODY()

		FTLLRN_RigUnit_SphereTraceByObjectTypes()
		: Start(EForceInit::ForceInitToZero)
		, End(EForceInit::ForceInitToZero)
		, ObjectTypes()
		, Radius(5.f)
