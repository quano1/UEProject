...
#include "TLLRN_RigUnit_ProfilingBracket.generated.h"
...
struct TLLRN_CONTROLRIG_API FTLLRN_RigUnit_StartProfilingTimer : public FRigVMFunction_DebugBaseMutable
{
	GENERATED_BODY()

	FTLLRN_RigUnit_StartProfilingTimer()
	{
	}
...
struct TLLRN_CONTROLRIG_API FTLLRN_RigUnit_EndProfilingTimer : public FRigVMFunction_DebugBaseMutable
{
	GENERATED_BODY()

	FTLLRN_RigUnit_EndProfilingTimer()
	{
