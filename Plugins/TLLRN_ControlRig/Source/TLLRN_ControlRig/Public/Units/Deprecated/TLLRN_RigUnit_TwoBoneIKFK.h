...
#include "TLLRN_RigUnit_TwoBoneIKFK.generated.h"


USTRUCT(meta=(DisplayName="TwoBoneIK/FK", Category="Transforms", Deprecated = "4.23.0"))
struct TLLRN_CONTROLRIG_API FTLLRN_RigUnit_TwoBoneIKFK : public FTLLRN_RigUnitMutable
{
	GENERATED_BODY()
