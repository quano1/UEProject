...
#include "TLLRN_RigUnit_SpringIK.generated.h"

USTRUCT()
struct TLLRN_CONTROLRIG_API FTLLRN_RigUnit_SpringIK_DebugSettings
{
	GENERATED_BODY()

	FTLLRN_RigUnit_SpringIK_DebugSettings()
	{
		bEnabled = false;
		Scale = 1.f;
...
USTRUCT()
struct TLLRN_CONTROLRIG_API FTLLRN_RigUnit_SpringIK_WorkData
{
	GENERATED_BODY()

	FTLLRN_RigUnit_SpringIK_WorkData()
	{
		CachedPoleVector = FTLLRN_CachedTLLRN_RigElement();
	}

	UPROPERTY(transient)
	TArray<FTLLRN_CachedTLLRN_RigElement> CachedBones;

	UPROPERTY()
	FTLLRN_CachedTLLRN_RigElement CachedPoleVector;
...
struct TLLRN_CONTROLRIG_API FTLLRN_RigUnit_SpringIK : public FTLLRN_RigUnit_HighlevelBaseMutable
{
	GENERATED_BODY()

	FTLLRN_RigUnit_SpringIK()
	{
		...
		DebugSettings = FTLLRN_RigUnit_SpringIK_DebugSettings();
	}
	...
	FTLLRN_RigUnit_SpringIK_DebugSettings DebugSettings;

	UPROPERTY(transient)
	FTLLRN_RigUnit_SpringIK_WorkData WorkData;
};
