...
#include "Units/Animation/TLLRN_RigUnit_AnimAttribute.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(TLLRN_RigUnit_AnimAttribute)

bool FTLLRN_RigDispatch_AnimAttributeBase::IsTypeSupported(const TRigVMTypeIndex& InTypeIndex)
{
...
const TArray<FRigVMTemplateArgument::ETypeCategory>& FTLLRN_RigDispatch_AnimAttributeBase::GetValueTypeCategory()
{
...
void FTLLRN_RigDispatch_GetAnimAttribute::GetAnimAttributeDispatch(FRigVMExtendedExecuteContext& InContext,
...
void FTLLRN_RigDispatch_SetAnimAttribute::SetAnimAttributeDispatch(FRigVMExtendedExecuteContext& InContext,
	FRigVMMemoryHandleArray Handles, FRigVMPredicateBranchArray Predicates)
{
...
void FTLLRN_RigDispatch_AnimAttributeBase::RegisterDependencyTypes_NoLock(FRigVMRegistry_NoLock& InRegistry) const
{
...
#if WITH_EDITOR
FString FTLLRN_RigDispatch_AnimAttributeBase::GetNodeTitle(const FRigVMTemplateTypeMap& InTypes) const
{
...
const TArray<FRigVMTemplateArgumentInfo>& FTLLRN_RigDispatch_AnimAttributeBase::GetArgumentInfos() const
{
	if (Infos.IsEmpty())
	{
...
#if WITH_EDITOR
FText FTLLRN_RigDispatch_AnimAttributeBase::GetArgumentTooltip(const FName& InArgumentName, TRigVMTypeIndex InTypeIndex) const
{
	if(InArgumentName == NameArgName)
	{
		return NSLOCTEXT("FTLLRN_RigDispatch_AnimAttributeBase", "NameArgTooltip", "The name of the animation attribute");
	}
	if(InArgumentName == BoneNameArgName)
	{
		return NSLOCTEXT("FTLLRN_RigDispatch_AnimAttributeBase", "BoneNameArgTooltip", "The name of the bone that stores the attribute, default to root bone if set to none");
	}
	if(InArgumentName == DefaultArgName)
	{
		return NSLOCTEXT("FTLLRN_RigDispatch_AnimAttributeBase", "DefaultArgTooltip", "The default value used as a fallback if the animation attribute does not exist");
	}
	if(InArgumentName == ValueArgName)
	{
		return NSLOCTEXT("FTLLRN_RigDispatch_AnimAttributeBase", "ValueArgTooltip", "The value to get / set");
	}
	if(InArgumentName == FoundArgName)
	{
		return NSLOCTEXT("FTLLRN_RigDispatch_AnimAttributeBase", "FoundArgTooltip", "Returns true if the animation attribute exists with the specific type");
	}
	if(InArgumentName == SuccessArgName)
	{
		return NSLOCTEXT("FTLLRN_RigDispatch_AnimAttributeBase", "SuccessArgTooltip", "Returns true if the animation attribute was successfully stored");
	}
...
const TArray<FRigVMTemplateArgumentInfo>& FTLLRN_RigDispatch_GetAnimAttribute::GetArgumentInfos() const
{
	if (ValueArgIndex == INDEX_NONE)
	{
		...
		DefaultArgIndex = Infos.Emplace(DefaultArgName, ERigVMPinDirection::Input, Categories, [](const TRigVMTypeIndex& Type) { return FTLLRN_RigDispatch_AnimAttributeBase::IsTypeSupported(Type); });
		ValueArgIndex = Infos.Emplace(ValueArgName, ERigVMPinDirection::Output, Categories, [](const TRigVMTypeIndex& Type) { return FTLLRN_RigDispatch_AnimAttributeBase::IsTypeSupported(Type); });
...
FRigVMTemplateTypeMap FTLLRN_RigDispatch_GetAnimAttribute::OnNewArgumentType(const FName& InArgumentName,
...
FRigVMFunctionPtr FTLLRN_RigDispatch_GetAnimAttribute::GetDispatchFunctionImpl(const FRigVMTemplateTypeMap& InTypes) const
{
	const FRigVMRegistry_NoLock& Registry = FRigVMRegistry_NoLock::GetForRead();
	...
	{
		return &FTLLRN_RigDispatch_GetAnimAttribute::GetAnimAttributeDispatch<float>;
	}
	if (ValueTypeIndex == RigVMTypeUtils::TypeIndex::Int32)
	{
		return &FTLLRN_RigDispatch_GetAnimAttribute::GetAnimAttributeDispatch<int32>;
	}
	if (ValueTypeIndex == RigVMTypeUtils::TypeIndex::FString)
	{
		return &FTLLRN_RigDispatch_GetAnimAttribute::GetAnimAttributeDispatch<FString>;
	}
	if (ValueTypeIndex == Registry.GetTypeIndex_NoLock<FTransform>(false))
	{
		return &FTLLRN_RigDispatch_GetAnimAttribute::GetAnimAttributeDispatch<FTransform>;
	}
	if (ValueTypeIndex == Registry.GetTypeIndex_NoLock<FQuat>(false))
	{
		return &FTLLRN_RigDispatch_GetAnimAttribute::GetAnimAttributeDispatch<FQuat>;
	}
	if (ValueTypeIndex == Registry.GetTypeIndex_NoLock<FVector>(false))
	{
		return &FTLLRN_RigDispatch_GetAnimAttribute::GetAnimAttributeDispatch<FVector>;
	}
	...
	{
		return &FTLLRN_RigDispatch_GetAnimAttribute::GetAnimAttributeDispatch;
	}

	return nullptr;
}

const TArray<FRigVMTemplateArgumentInfo>& FTLLRN_RigDispatch_SetAnimAttribute::GetArgumentInfos() const
{
	if (ValueArgIndex == INDEX_NONE)
	{
		Infos = Super::GetArgumentInfos();
		...
		ValueArgIndex = Infos.Emplace(ValueArgName, ERigVMPinDirection::Input, Categories, [](const TRigVMTypeIndex& Type) { return FTLLRN_RigDispatch_AnimAttributeBase::IsTypeSupported(Type); });		
...
const TArray<FRigVMExecuteArgument>& FTLLRN_RigDispatch_SetAnimAttribute::GetExecuteArguments_Impl(const FRigVMDispatchContext& InContext) const
{
...
FRigVMTemplateTypeMap FTLLRN_RigDispatch_SetAnimAttribute::OnNewArgumentType(const FName& InArgumentName,
                                                                       TRigVMTypeIndex InTypeIndex) const
{
	FRigVMTemplateTypeMap Types;
...
FRigVMFunctionPtr FTLLRN_RigDispatch_SetAnimAttribute::GetDispatchFunctionImpl(const FRigVMTemplateTypeMap& InTypes) const
{
	const FRigVMRegistry_NoLock& Registry = FRigVMRegistry_NoLock::GetForRead();
	const TRigVMTypeIndex& ValueTypeIndex = InTypes.FindChecked(TEXT("Value"));
	...
	if (ValueTypeIndex == RigVMTypeUtils::TypeIndex::Float)
	{
		return &FTLLRN_RigDispatch_SetAnimAttribute::SetAnimAttributeDispatch<float>;
	}
	if (ValueTypeIndex == RigVMTypeUtils::TypeIndex::Int32)
	{
		return &FTLLRN_RigDispatch_SetAnimAttribute::SetAnimAttributeDispatch<int32>;
	}
	if (ValueTypeIndex == RigVMTypeUtils::TypeIndex::FString)
	{
		return &FTLLRN_RigDispatch_SetAnimAttribute::SetAnimAttributeDispatch<FString>;
	}
	if (ValueTypeIndex == Registry.GetTypeIndex_NoLock<FTransform>(false))
	{
		return &FTLLRN_RigDispatch_SetAnimAttribute::SetAnimAttributeDispatch<FTransform>;
	}
	if (ValueTypeIndex == Registry.GetTypeIndex_NoLock<FQuat>(false))
	{
		return &FTLLRN_RigDispatch_SetAnimAttribute::SetAnimAttributeDispatch<FQuat>;
	}
	if (ValueTypeIndex == Registry.GetTypeIndex_NoLock<FVector>(false))
	{
		return &FTLLRN_RigDispatch_SetAnimAttribute::SetAnimAttributeDispatch<FVector>;
	}
	...
	if (UScriptStruct* ScriptStruct = Cast<UScriptStruct>(ValueType.CPPTypeObject))
	{
		return &FTLLRN_RigDispatch_SetAnimAttribute::SetAnimAttributeDispatch;
	}
