...
#include "Units/Collision/TLLRN_RigUnit_WorldCollision.h"
#include "Engine/World.h"
#include "Math/TLLRN_ControlRigMathLibrary.h"
#include "Units/TLLRN_RigUnitContext.h"
#include "Components/PrimitiveComponent.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(TLLRN_RigUnit_WorldCollision)

FTLLRN_RigUnit_SphereTraceWorld_Execute()
{
...
FRigVMStructUpgradeInfo FTLLRN_RigUnit_SphereTraceWorld::GetUpgradeInfo() const
{
	FTLLRN_RigUnit_SphereTraceByTraceChannel NewNode;
	NewNode.Start = Start;
	NewNode.End = End;
...
FTLLRN_RigUnit_SphereTraceByTraceChannel_Execute()
{
	DECLARE_SCOPE_HIERARCHICAL_COUNTER_RIGUNIT()
...
FTLLRN_RigUnit_SphereTraceByObjectTypes_Execute()
{
	DECLARE_SCOPE_HIERARCHICAL_COUNTER_RIGUNIT()
