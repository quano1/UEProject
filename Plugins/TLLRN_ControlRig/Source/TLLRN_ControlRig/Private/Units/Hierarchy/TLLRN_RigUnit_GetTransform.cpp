...
#include UE_INLINE_GENERATED_CPP_BY_NAME(TLLRN_RigUnit_GetTransform)

FString FTLLRN_RigUnit_GetTransform::GetUnitLabel() const
{
...
FTLLRN_RigUnit_GetTransform_Execute()
{
...
FTLLRN_RigUnit_GetTransformArray_Execute()
{
	FTLLRN_RigUnit_GetTransformItemArray::StaticExecute(ExecuteContext, Items.Keys, Space, bInitial, Transforms, CachedIndex);
}

FRigVMStructUpgradeInfo FTLLRN_RigUnit_GetTransformArray::GetUpgradeInfo() const
{
	FTLLRN_RigUnit_GetTransformItemArray NewNode;
...
FTLLRN_RigUnit_GetTransformItemArray_Execute()
{
    DECLARE_SCOPE_HIERARCHICAL_COUNTER_RIGUNIT()
	...
	{
		FTLLRN_RigUnit_GetTransform::StaticExecute(ExecuteContext, Items[Index], Space, bInitial, Transforms[Index], CachedIndex[Index]);
