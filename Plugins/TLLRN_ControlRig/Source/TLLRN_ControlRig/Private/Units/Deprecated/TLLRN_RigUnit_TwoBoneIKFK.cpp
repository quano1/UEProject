...
#include "Units/Deprecated/TLLRN_RigUnit_TwoBoneIKFK.h"
#include "Units/TLLRN_RigUnitContext.h"
#include "HelperUtil.h"
#include "TwoBoneIK.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(TLLRN_RigUnit_TwoBoneIKFK)

FTLLRN_RigUnit_TwoBoneIKFK_Execute()
{
	...
	if (!bIsInitialized)
	{
		...
		if (Hierarchy)
		{
			...
			const FTLLRN_RigElementKey StartJointKey(StartJoint, ETLLRN_RigElementType::Bone);
			const FTLLRN_RigElementKey EndJointKey(EndJoint, ETLLRN_RigElementType::Bone);
...
FRigVMStructUpgradeInfo FTLLRN_RigUnit_TwoBoneIKFK::GetUpgradeInfo() const
{
