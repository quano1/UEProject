...
#include "Units/Deprecated/TLLRN_RigUnit_BlendTransform.h"
#include "Units/TLLRN_RigUnitContext.h"
#include "AnimationRuntime.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(TLLRN_RigUnit_BlendTransform)

FTLLRN_RigUnit_BlendTransform_Execute()
{
...
FRigVMStructUpgradeInfo FTLLRN_RigUnit_BlendTransform::GetUpgradeInfo() const
{
