...
#include "Units/Debug/TLLRN_RigUnit_DebugTransform.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(TLLRN_RigUnit_DebugTransform)

FTLLRN_RigUnit_DebugTransform_Execute()
{
	...
	{
		DrawTransform = Transform * ExecuteContext.Hierarchy->GetGlobalTransform(FTLLRN_RigElementKey(Space, ETLLRN_RigElementType::Bone));
	}
...
FRigVMStructUpgradeInfo FTLLRN_RigUnit_DebugTransform::GetUpgradeInfo() const
{
...
FTLLRN_RigUnit_DebugTransformMutable_Execute()
{
	FTLLRN_RigUnit_DebugTransformMutableItemSpace::StaticExecute(
		ExecuteContext, 
		Transform,
		Mode,
		Color,
...
FRigVMStructUpgradeInfo FTLLRN_RigUnit_DebugTransformMutable::GetUpgradeInfo() const
{
	FRigVMFunction_DebugTransformMutableNoSpace NewNode;
	NewNode.Transform = Transform;
	NewNode.Mode = Mode;
...
FRigVMStructUpgradeInfo FTLLRN_RigUnit_DebugTransformMutableItemSpace::GetUpgradeInfo() const
{
	FRigVMFunction_DebugTransformMutableNoSpace NewNode;
	NewNode.Transform = Transform;
	NewNode.Mode = Mode;
...
FTLLRN_RigUnit_DebugTransformMutableItemSpace_Execute()
{
    DECLARE_SCOPE_HIERARCHICAL_COUNTER_RIGUNIT()
	if (ExecuteContext.GetDrawInterface() == nullptr || !bEnabled)
	{
...
FTLLRN_RigUnit_DebugTransformArrayMutable_Execute()
{
    DECLARE_SCOPE_HIERARCHICAL_COUNTER_RIGUNIT()
	if (ExecuteContext.GetDrawInterface() == nullptr || !bEnabled)
	{
	...
	{
		FTransform SpaceTransform = ExecuteContext.Hierarchy->GetGlobalTransform(FTLLRN_RigElementKey(Space, ETLLRN_RigElementType::Bone));
...
FRigVMStructUpgradeInfo FTLLRN_RigUnit_DebugTransformArrayMutable::GetUpgradeInfo() const
{
...
FRigVMStructUpgradeInfo FTLLRN_RigUnit_DebugTransformArrayMutableItemSpace::GetUpgradeInfo() const
{
	FRigVMFunction_DebugTransformArrayMutableNoSpace NewNode;
	NewNode.Transforms = Transforms;
	NewNode.Mode = Mode;
...
FTLLRN_RigUnit_DebugTransformArrayMutableItemSpace_Execute()
{
	DECLARE_SCOPE_HIERARCHICAL_COUNTER_RIGUNIT()
