...
#include "Units/Highlevel/Hierarchy/TLLRN_RigUnit_SphericalPoseReader.h"
#include "Kismet/KismetMathLibrary.h"
#include "Units/TLLRN_RigUnitContext.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(TLLRN_RigUnit_SphericalPoseReader)

FTLLRN_RigUnit_SphericalPoseReader_Execute()
{
	...
	RemapAndConvertInputs(
		...
		OuterRegion,
		ActiveRegionSize,
		ActiveTLLRN_RegionScaleFactors,
		FalloffSize,
		FalloffTLLRN_RegionScaleFactors,
		FlipWidthScaling,
		FlipHeightScaling);
...
void FTLLRN_RigUnit_SphericalPoseReader::RemapAndConvertInputs(
	...
	const bool FlipHeight)
{
	...
	InnerRegion.ScaleFactors = ActiveTLLRN_RegionScaleFactors;
	...
	//
	const float PosWidthMin = (InnerRegion.RegionAngleRadians * ActiveTLLRN_RegionScaleFactors.PositiveWidth) * InvOuterAngleRadians;
	OuterRegion.ScaleFactors.PositiveWidth = FMath::Lerp(PosWidthMin, 1.0f, FalloffTLLRN_RegionScaleFactors.PositiveWidth);
	//
	const float NegWidthMin = (InnerRegion.RegionAngleRadians * ActiveTLLRN_RegionScaleFactors.NegativeWidth) * InvOuterAngleRadians;
	OuterRegion.ScaleFactors.NegativeWidth = FMath::Lerp(NegWidthMin, 1.0f, FalloffTLLRN_RegionScaleFactors.NegativeWidth);
	//
	const float PosHeightMin = (InnerRegion.RegionAngleRadians * ActiveTLLRN_RegionScaleFactors.PositiveHeight) * InvOuterAngleRadians;
	OuterRegion.ScaleFactors.PositiveHeight = FMath::Lerp(PosHeightMin, 1.0f, FalloffTLLRN_RegionScaleFactors.PositiveHeight);
	//
	const float NegHeightMin = (InnerRegion.RegionAngleRadians * ActiveTLLRN_RegionScaleFactors.NegativeHeight) * InvOuterAngleRadians;
	OuterRegion.ScaleFactors.NegativeHeight = FMath::Lerp(NegHeightMin, 1.0f, FalloffTLLRN_RegionScaleFactors.NegativeHeight);
...
float FTLLRN_RigUnit_SphericalPoseReader::CalcOutputParam(
...
void FTLLRN_RigUnit_SphericalPoseReader::DistanceToEllipse(
	const float InX,
	const float InY,
	const float SizeX,
	const float SizeY,
...
float FTLLRN_RigUnit_SphericalPoseReader::RemapRange(
	const float T,
	const float AStart,
	const float AEnd,
	const float BStart,
