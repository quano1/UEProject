...
#include "BakeToTLLRN_ControlRigSettings.generated.h"

UCLASS(BlueprintType, config = EditorSettings)
class  UBakeToTLLRN_ControlRigSettings : public UObject
{
public:
	UBakeToTLLRN_ControlRigSettings(const FObjectInitializer& Initializer);
