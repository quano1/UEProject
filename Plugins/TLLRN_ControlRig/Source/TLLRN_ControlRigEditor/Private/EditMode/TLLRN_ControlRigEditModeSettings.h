...
#include "TLLRN_ControlRigEditModeSettings.generated.h"
...
class UTLLRN_ControlRigEditModeSettings : public UObject
{
	GENERATED_BODY()

	UTLLRN_ControlRigEditModeSettings()
		...
		, bOnlySelectTLLRN_RigControls(false)
...
public:
	...
	UPROPERTY(config, EditAnywhere, Category = "Animation Settings")
	bool bOnlySelectTLLRN_RigControls;
	...
	DECLARE_MULTICAST_DELEGATE_OneParam(FOnUpdateSettings, const UTLLRN_ControlRigEditModeSettings*);
