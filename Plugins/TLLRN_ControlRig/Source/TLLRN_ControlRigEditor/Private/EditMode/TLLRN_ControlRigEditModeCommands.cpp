...
#define LOCTEXT_NAMESPACE "TLLRN_ControlRigEditModeCommands"

void FTLLRN_ControlRigEditModeCommands::RegisterCommands()
{
	...
	UI_COMMAND(SetTLLRN_AnimLayerPassthroughKey," Set Anim Layer Passthrough Key","Set previous layer value on current selected anim layer", EUserInterfaceActionType::Button, FInputChord());
