...
class FTLLRN_ControlRigAnimNodeEventNameDetails : public IPropertyTypeCustomization
{
public:

	static TSharedRef<IPropertyTypeCustomization> MakeInstance()
	{
		return MakeShareable(new FTLLRN_ControlRigAnimNodeEventNameDetails);
	}
...
protected:
	...
	FAnimNode_TLLRN_ControlRigBase* AnimNodeBeingCustomized;
};