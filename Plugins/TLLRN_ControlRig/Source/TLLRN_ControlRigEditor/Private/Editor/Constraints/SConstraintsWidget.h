...
class TLLRN_CONTROLRIGEDITOR_API FBaseConstraintListWidget : public FEditorUndoClient
{
public:
...
class TLLRN_CONTROLRIGEDITOR_API SConstraintsEditionWidget : public SCompoundWidget, public FBaseConstraintListWidget
{
public:
...
class TLLRN_CONTROLRIGEDITOR_API SConstraintBakeWidget : public SCompoundWidget, public FBaseConstraintListWidget
{
public:
