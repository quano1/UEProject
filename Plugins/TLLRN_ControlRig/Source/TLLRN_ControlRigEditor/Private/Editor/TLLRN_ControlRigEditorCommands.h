...
class FTLLRN_ControlRigEditorCommands : public TCommands<FTLLRN_ControlRigEditorCommands>
{
public:
	FTLLRN_ControlRigEditorCommands() : TCommands<FTLLRN_ControlRigEditorCommands>
	(
		"TLLRN_ControlRigBlueprint",
