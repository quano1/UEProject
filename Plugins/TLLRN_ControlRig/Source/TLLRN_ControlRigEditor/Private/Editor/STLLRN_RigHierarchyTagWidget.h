...
DECLARE_DELEGATE_OneParam(FOnRigTreeElementKeyTagDragDetected, const FTLLRN_RigElementKey&);

class STLLRN_RigHierarchyTagWidget : public SCompoundWidget
{
public:
	SLATE_BEGIN_ARGS(STLLRN_RigHierarchyTagWidget)
		: _Text()
		, _TooltipText()
		, _Icon(nullptr)
...
private:
	...
	friend class FTLLRN_RigHierarchyTagDragDropOp;
};
