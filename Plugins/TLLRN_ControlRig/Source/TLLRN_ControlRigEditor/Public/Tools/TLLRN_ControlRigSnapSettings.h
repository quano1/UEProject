...
#include "TLLRN_ControlRigSnapSettings.generated.h"


UCLASS(config = EditorPerProjectUserSettings)
class TLLRN_CONTROLRIGEDITOR_API UTLLRN_ControlRigSnapSettings : public UObject
{

public:
	GENERATED_BODY()

	UTLLRN_ControlRigSnapSettings();
