...
struct FAnimSliderObjectSelection
{
	...
	bool Setup(TWeakPtr<ISequencer>& InSequencer, TWeakPtr<class FTLLRN_ControlRigEditMode>& InEditMode);
	bool Setup(const TArray<UTLLRN_ControlRig*>& SelectedTLLRN_ControlRigs, TWeakPtr<ISequencer>& InSequencer);
...
private:
	...
	TArray<UTLLRN_ControlRig*> GetTLLRN_ControlRigs(TWeakPtr<class FTLLRN_ControlRigEditMode>& InEditMode);
};
...
struct FBaseAnimSlider
{
	...
	*/
	virtual bool Setup(TWeakPtr<ISequencer>& InSequencer, TWeakPtr<FTLLRN_ControlRigEditMode>& InEditMode);
...
struct FControlsToTween :public FBasicBlendSlider
{
	...
	virtual bool Setup(TWeakPtr<ISequencer>& InSequencer, TWeakPtr<FTLLRN_ControlRigEditMode>& InEditMode) override;
