...
class FTLLRN_ControlTLLRN_RigSpaceChannelCurveModel : public FKeyBarCurveModel
{
public:
	static ECurveEditorViewID ViewID;

	FTLLRN_ControlTLLRN_RigSpaceChannelCurveModel(TMovieSceneChannelHandle<FMovieSceneTLLRN_ControlTLLRN_RigSpaceChannel> InChannel, UMovieSceneSection* InOwningSection, TWeakPtr<ISequencer> InWeakSequencer);
	~FTLLRN_ControlTLLRN_RigSpaceChannelCurveModel();
	//FCurveModel
...
private:
	void FixupCurve();
private:
	TMovieSceneChannelHandle<FMovieSceneTLLRN_ControlTLLRN_RigSpaceChannel> ChannelHandle;
