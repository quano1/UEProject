...
#include "AnimGraphNode_TLLRN_ControlRig.generated.h"

struct FRigVMVariableMappingInfo;

UCLASS(MinimalAPI)
class UAnimGraphNode_TLLRN_ControlRig : public UAnimGraphNode_CustomProperty
{
	GENERATED_UCLASS_BODY()

	UPROPERTY(EditAnywhere, Category = Settings)
	FAnimNode_TLLRN_ControlRig Node;
...
private:
	...
	UAnimGraphNode_TLLRN_ControlRig::FControlsInfo* FindControlElement(const FName& InControlName) const;
};
