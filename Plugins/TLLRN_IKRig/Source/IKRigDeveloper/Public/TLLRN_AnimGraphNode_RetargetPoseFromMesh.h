...
#include "TLLRN_AnimGraphNode_RetargetPoseFromMesh.generated.h"
...
UCLASS()
class TLLRN_IKRIGDEVELOPER_API UTLLRN_AnimGraphNode_RetargetPoseFromMesh : public UAnimGraphNode_Base
{
	GENERATED_BODY()

	UPROPERTY(EditAnywhere, Category = Settings)
	FTLLRN_AnimNode_RetargetPoseFromMesh Node;
