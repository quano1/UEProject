...
#include "TLLRN_IKRetargetSettings.generated.h"
...
struct TLLRN_IKRIG_API FTLLRN_TargetChainSpeedPlantSettings
{
	GENERATED_BODY()
	...
	*  The target IK goal will not be allowed to move whenever the source bone speed drops below this threshold speed. */
	...
	bool operator==(const FTLLRN_TargetChainSpeedPlantSettings& Other) const;
};

USTRUCT(BlueprintType)
struct TLLRN_IKRIG_API FTLLRN_TargetChainFKSettings
{
	GENERATED_BODY()
	...
	* None: The rotation of each target bone in the chain is left at the reference pose. */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "FK Adjustments")
	ETLLRN_RetargetRotationMode RotationMode = ETLLRN_RetargetRotationMode::Interpolated;
	...
	* Absolute: Translation of target bone is set to the absolute position of the source bone. */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "FK Adjustments")
	ETLLRN_RetargetTranslationMode TranslationMode = ETLLRN_RetargetTranslationMode::None;
	...
	*  At 1, the root bone of the chain will be twist-rotated in the pole direction to match the orientation of the source chain.*/
	...
	bool operator==(const FTLLRN_TargetChainFKSettings& Other) const;
};

USTRUCT(BlueprintType)
struct TLLRN_IKRIG_API FTLLRN_TargetChainIKSettings
{
	GENERATED_BODY()
	...
	*  Values greater than 1 will stretch the chain beyond the retargeted length. */
	...
	bool operator==(const FTLLRN_TargetChainIKSettings& Other) const;
};

USTRUCT(BlueprintType)
struct TLLRN_IKRIG_API FTLLRN_TargetChainSettings
{
	GENERATED_BODY()
...
public:
	...
	FTLLRN_TargetChainFKSettings FK;
	...
	FTLLRN_TargetChainIKSettings IK;
	...
	FTLLRN_TargetChainSpeedPlantSettings SpeedPlanting;
	
	bool operator==(const FTLLRN_TargetChainSettings& Other) const;
};

USTRUCT(BlueprintType)
struct TLLRN_IKRIG_API FTLLRN_TargetRootSettings
{
	GENERATED_BODY()
...
UENUM()
enum class ETLLRN_WarpingDirectionSource
{
	Goals,
	Chain,
	RootBone
...
USTRUCT(BlueprintType)
struct TLLRN_IKRIG_API FTLLRN_RetargetGlobalSettings
{
	GENERATED_BODY()
	...
	* Note: the retargeting order is: Root > FK > IK > Post
	 ...
	 */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Warping)
	ETLLRN_WarpingDirectionSource DirectionSource = ETLLRN_WarpingDirectionSource::Goals;
	
	/** The world space axis that represents the forward facing direction for your character. By default, in Unreal, this is +Y.  */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Warping)
	ETLLRN_BasicAxis ForwardDirection = ETLLRN_BasicAxis::Y;
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Warping, meta=(EditCondition="DirectionSource == ETLLRN_WarpingDirectionSource::Chain"))
	...
	static FVector GetAxisVector(const ETLLRN_BasicAxis& Axis)
	{
		switch (Axis)
		{
		case ETLLRN_BasicAxis::X:
			return FVector::XAxisVector;
		case ETLLRN_BasicAxis::Y:
			return FVector::YAxisVector;
		case ETLLRN_BasicAxis::Z:
			return FVector::ZAxisVector;
		case ETLLRN_BasicAxis::NegX:
			return -FVector::XAxisVector;
		case ETLLRN_BasicAxis::NegY:
			return -FVector::YAxisVector;
		case ETLLRN_BasicAxis::NegZ:
			return -FVector::ZAxisVector;
		default:
			checkNoEntry();
