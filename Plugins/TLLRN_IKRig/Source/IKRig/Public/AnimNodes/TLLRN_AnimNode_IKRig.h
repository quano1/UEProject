...
#include "TLLRN_AnimNode_IKRig.generated.h"
...
struct TLLRN_IKRIG_API FTLLRN_AnimNode_IKRig : public FAnimNode_CustomProperty
{
	GENERATED_BODY()

	FTLLRN_AnimNode_IKRig();
	...
	TObjectPtr<UTLLRN_IKRigDefinition> RigDefinitionAsset = nullptr;
...
private:
	...
	TArray<ITLLRN_IKGoalCreatorInterface*> GoalCreators;
	TMap<FName, FTLLRN_IKRigGoal> GoalsFromGoalCreators;
...
public:
	...
	void CreateTLLRN_IKRigProcessorIfNeeded(UObject* Outer);
	UTLLRN_IKRigProcessor* GetTLLRN_IKRigProcessor();
...
private:
	...
	friend class UTLLRN_AnimGraphNode_IKRig;
};
