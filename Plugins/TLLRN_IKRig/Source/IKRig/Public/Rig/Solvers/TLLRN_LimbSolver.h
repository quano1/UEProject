...
#include "TLLRN_LimbSolver.generated.h"

USTRUCT()
struct TLLRN_IKRIG_API FTLLRN_LimbSolverSettings
{
	GENERATED_BODY()
...
struct FTLLRN_LimbLink
{
	...
	FTLLRN_LimbLink(const FVector& InLocation, int32 InBoneIndex)
		: Location(InLocation)
		, Length(0.f)
