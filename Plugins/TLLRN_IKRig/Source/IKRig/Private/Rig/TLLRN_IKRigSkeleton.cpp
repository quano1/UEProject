...
#include UE_INLINE_GENERATED_CPP_BY_NAME(TLLRN_IKRigSkeleton)
...
FTLLRN_IKRigInputSkeleton::FTLLRN_IKRigInputSkeleton(const USkeletalMesh* SkeletalMesh)
{
	Initialize(SkeletalMesh);
}

void FTLLRN_IKRigInputSkeleton::Initialize(const USkeletalMesh* SkeletalMesh)
{
	Reset();
...
void FTLLRN_IKRigInputSkeleton::Reset()
{
	*this = FTLLRN_IKRigInputSkeleton();
}

void FTLLRN_IKRigSkeleton::SetInputSkeleton(const USkeletalMesh* SkeletalMesh, const TArray<FName>& InExcludedBones)
{
...
void FTLLRN_IKRigSkeleton::SetInputSkeleton(const FTLLRN_IKRigInputSkeleton& InputSkeleton, const TArray<FName>& InExcludedBones)
{
...
void FTLLRN_IKRigSkeleton::Reset()
{
	*this = FTLLRN_IKRigSkeleton();
}

int32 FTLLRN_IKRigSkeleton::GetBoneIndexFromName(const FName InName) const
{
...
const FName& FTLLRN_IKRigSkeleton::GetBoneNameFromIndex(const int32 BoneIndex) const
{
...
int32 FTLLRN_IKRigSkeleton::GetParentIndex(const int32 BoneIndex) const
{
	if (!BoneNames.IsValidIndex(BoneIndex))
	{
		return INDEX_NONE;
...
int32 FTLLRN_IKRigSkeleton::GetParentIndexThatIsNotExcluded(const int32 BoneIndex) const
{
...
int32 FTLLRN_IKRigSkeleton::GetChildIndices(const int32 ParentBoneIndex, TArray<int32>& Children) const
{
	Children.Reset();
...
int32 FTLLRN_IKRigSkeleton::GetCachedEndOfBranchIndex(const int32 InBoneIndex) const
{
...
void FTLLRN_IKRigSkeleton::ConvertLocalPoseToGlobal(
...
void FTLLRN_IKRigSkeleton::UpdateAllGlobalTransformFromLocal()
{
...
void FTLLRN_IKRigSkeleton::UpdateGlobalTransformFromLocal(const int32 BoneIndex)
{
...
void FTLLRN_IKRigSkeleton::UpdateAllLocalTransformFromGlobal()
{
...
void FTLLRN_IKRigSkeleton::UpdateLocalTransformFromGlobal(const int32 BoneIndex)
{
	const int32 ParentIndex = ParentIndices[BoneIndex];
	if (ParentIndex == INDEX_NONE)
	{
...
void FTLLRN_IKRigSkeleton::PropagateGlobalPoseBelowBone(const int32 StartBoneIndex)
{
...
bool FTLLRN_IKRigSkeleton::IsBoneInDirectLineage(const FName& Child, const FName& PotentialParent) const
{
...
bool FTLLRN_IKRigSkeleton::IsBoneExcluded(const int32 BoneIndex) const
{
...
void FTLLRN_IKRigSkeleton::NormalizeRotations(TArray<FTransform>& Transforms)
{
...
void FTLLRN_IKRigSkeleton::GetChainsInList(const TArray<int32>& SelectedBones, TArray<FTLLRN_BoneChain>& OutChains) const
{	
    ...
    for (const int32 SelectedBone : SelectedBones)
    {
    	...
    	OutChains.Add(FTLLRN_BoneChain(ChainName, StartBoneName, EndBoneName, GoalName));	
    }
}

bool FTLLRN_IKRigSkeleton::ValidateChainAndGetBones(const FTLLRN_BoneChain& BoneChain, TArray<int32>& OutBoneIndices) const
{
...
bool FTLLRN_IKRigSkeleton::GetMirroredBoneIndices(
