...
class TLLRN_SBaseHierarchyTreeView : public STreeView<TSharedPtr<ItemType>>
{
...
public:
	...
	virtual ~TLLRN_SBaseHierarchyTreeView() {}
...
private:
	...
	/** A temporary snapshot of the SparseItemInfos in STreeView, used during TLLRN_SIKRetargetHierarchy::RefreshTreeView() */
	TSparseItemMap OldSparseItemInfos;

	/** A temporary snapshot of the SelectedItems in SListView, used during TLLRN_SIKRetargetHierarchy::RefreshTreeView() */
