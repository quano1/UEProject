...
#include "TLLRN_IKRetargetEditorStyle.h"

class FTLLRN_IKRetargetCommands : public TCommands<FTLLRN_IKRetargetCommands>
{
public:
	FTLLRN_IKRetargetCommands() : TCommands<FTLLRN_IKRetargetCommands>
	(
		"IKRetarget",
		NSLOCTEXT("Contexts", "IKRetarget", "IK Retarget"),
		NAME_None,
		FTLLRN_IKRetargetEditorStyle::Get().GetStyleSetName() // Icon Style Set
	)
	{}
