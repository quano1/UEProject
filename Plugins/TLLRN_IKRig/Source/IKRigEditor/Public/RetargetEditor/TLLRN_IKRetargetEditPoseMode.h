...
struct FTLLRN_BoneEdit
{
	...
	void Reset()
	{
		*this = FTLLRN_BoneEdit();
	}
};

class FTLLRN_IKRetargetEditPoseMode : public IPersonaEditMode
{
public:
	static FName ModeName;
	
	FTLLRN_IKRetargetEditPoseMode() = default;
