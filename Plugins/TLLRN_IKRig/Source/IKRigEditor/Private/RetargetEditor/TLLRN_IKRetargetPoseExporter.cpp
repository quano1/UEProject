...
#include "RetargetEditor/TLLRN_IKRetargetPoseExporter.h"
...
void FTLLRN_IKRetargetPoseExporter::Initialize(TSharedPtr<FTLLRN_IKRetargetEditorController> InController)
{
	Controller = InController;
}

void FTLLRN_IKRetargetPoseExporter::HandleImportFromPoseAsset()
{
	FTLLRN_IKRetargetEditorController* ControllerPtr = Controller.Pin().Get();
	
	ControllerPtr->SetRetargeterMode(ETLLRN_RetargeterOutputMode::EditRetargetPose);
	...
	AssetPickerConfig.OnShouldFilterAsset = FOnShouldFilterAsset::CreateSP(this, &FTLLRN_IKRetargetPoseExporter::OnShouldFilterPoseToImport);
	AssetPickerConfig.OnAssetSelected = FOnAssetSelected::CreateSP(this, &FTLLRN_IKRetargetPoseExporter::OnPoseAssetSelected);
		...
		[
			...
			[
				...
				[
					...
					.OnGenerateWidget(this, &FTLLRN_IKRetargetPoseExporter::OnGeneratePoseComboWidget)
					.OnSelectionChanged(this, &FTLLRN_IKRetargetPoseExporter::OnSelectPoseFromPoseAsset)
					.OnComboBoxOpening(this, &FTLLRN_IKRetargetPoseExporter::RefreshPoseList)
					[
			...
			[
				...
				[
					...
					.OnClicked(this, &FTLLRN_IKRetargetPoseExporter::ImportPoseAsset)
				]
...
void FTLLRN_IKRetargetPoseExporter::OnPoseAssetSelected(const FAssetData& SelectedAsset)
{
...
TSharedRef<SWidget> FTLLRN_IKRetargetPoseExporter::OnGeneratePoseComboWidget(TSharedPtr<FName> Item) const
{
	return SNew(STextBlock).Text(FText::FromName(*Item.Get()));
}

void FTLLRN_IKRetargetPoseExporter::OnSelectPoseFromPoseAsset(TSharedPtr<FName> Item, ESelectInfo::Type SelectInfo)
{
	if (Item.IsValid())
	{
		SelectedPose = Item;
...
void FTLLRN_IKRetargetPoseExporter::RefreshPoseList()
{
...
FReply FTLLRN_IKRetargetPoseExporter::ImportPoseAsset() const
{
	...
	FTLLRN_IKRetargetEditorController* ControllerPtr = Controller.Pin().Get();
	ETLLRN_RetargetSourceOrTarget SourceOrTarget = ControllerPtr->GetSourceOrTarget();
	...
	const UTLLRN_IKRigDefinition* IKRig = ControllerPtr->AssetController->GetIKRig(SourceOrTarget);
	if (!IKRig)
	{
	...
	FTLLRN_IKRetargetPose& NewPose = ControllerPtr->AssetController->GetRetargetPoses(SourceOrTarget)[NewPoseName];
...
bool FTLLRN_IKRetargetPoseExporter::OnShouldFilterPoseToImport(const FAssetData& AssetData) const
{
...
void FTLLRN_IKRetargetPoseExporter::HandleImportFromSequenceAsset()
{
	FTLLRN_IKRetargetEditorController* ControllerPtr = Controller.Pin().Get();
	...
	AssetPickerConfig.bShowTypeInColumnView = true;
	AssetPickerConfig.DefaultFilterMenuExpansion = EAssetTypeCategories::Animation;
	AssetPickerConfig.OnShouldFilterAsset = FOnShouldFilterAsset::CreateSP(this, &FTLLRN_IKRetargetPoseExporter::OnShouldFilterSequenceToImport);
	AssetPickerConfig.OnAssetSelected = FOnAssetSelected::CreateSP(this, &FTLLRN_IKRetargetPoseExporter::OnSequenceSelectedForPose);
	AssetPickerConfig.bAllowNullSelection = false;
		...
		[
			...
			[
				...
				[
					...
					.OnClicked(this, &FTLLRN_IKRetargetPoseExporter::OnImportPoseFromSequence)
				]
...
bool FTLLRN_IKRetargetPoseExporter::OnShouldFilterSequenceToImport(const FAssetData& AssetData) const
{
...
FReply FTLLRN_IKRetargetPoseExporter::OnImportPoseFromSequence()
{
	...
	FTLLRN_IKRetargetPose& ImportedRetargetPose = ControllerPtr->AssetController->GetRetargetPoses(SourceOrTarget)[NewPose];
...
void FTLLRN_IKRetargetPoseExporter::OnSequenceSelectedForPose(const FAssetData& SelectedAsset)
{
	SequenceToImportAsPose = SelectedAsset.ToSoftObjectPath();
}

void FTLLRN_IKRetargetPoseExporter::HandleExportPoseAsset()
{
	const FTLLRN_IKRetargetEditorController* ControllerPtr = Controller.Pin().Get();

	// get mesh to export pose
	const ETLLRN_RetargetSourceOrTarget SourceOrTarget = ControllerPtr->GetSourceOrTarget();
	USkeletalMesh* Mesh = ControllerPtr->GetSkeletalMesh(SourceOrTarget);
...
void FTLLRN_IKRetargetPoseExporter::NotifyUser(const FText& Message, SNotificationItem::ECompletionState NotificationType)
{
