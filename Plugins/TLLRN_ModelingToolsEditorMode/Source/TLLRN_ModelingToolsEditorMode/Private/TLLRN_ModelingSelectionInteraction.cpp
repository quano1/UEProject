...
void UTLLRN_ModelingSelectionInteraction::Initialize(
	...
	TUniqueFunction<bool(const FInputDeviceRay&)> ExternalHitCaptureCallbackIn)
{
	...
	TransformGizmo = UE::TransformGizmoUtil::CreateCustomRepositionableTransformGizmo( 
		...
		this, TEXT("TLLRN_ModelingSelectionInteraction") );
	...
	TransformProxy->OnTransformChanged.AddUObject(this, &UTLLRN_ModelingSelectionInteraction::OnGizmoTransformChanged);
	TransformProxy->OnBeginTransformEdit.AddUObject(this, &UTLLRN_ModelingSelectionInteraction::OnBeginGizmoTransform);
	TransformProxy->OnEndTransformEdit.AddUObject(this, &UTLLRN_ModelingSelectionInteraction::OnEndGizmoTransform);

	// listen for selection changes to update gizmo
	OnSelectionModifiedDelegate = SelectionManager->OnSelectionModified.AddUObject(this, &UTLLRN_ModelingSelectionInteraction::OnSelectionManager_SelectionModified);
}

void UTLLRN_ModelingSelectionInteraction::Shutdown()
{
...
void UTLLRN_ModelingSelectionInteraction::Render(IToolsContextRenderAPI* RenderAPI)
{
...
void UTLLRN_ModelingSelectionInteraction::DrawHUD(FCanvas* Canvas, IToolsContextRenderAPI* RenderAPI)
{
...
void UTLLRN_ModelingSelectionInteraction::SetActiveDragMode(ETLLRN_ModelingSelectionInteraction_DragMode NewMode)
{
...
void UTLLRN_ModelingSelectionInteraction::SetLocalFrameMode(ETLLRN_ModelingSelectionInteraction_LocalFrameMode NewLocalFrameMode)
{
...
void UTLLRN_ModelingSelectionInteraction::UpdateActiveDragMode()
{
	if (ActiveDragMode == ETLLRN_ModelingSelectionInteraction_DragMode::PathInteraction)
	{
		ClickOrDragBehavior->SetDragTarget(PathSelectionInteraction);
	}
	else if (ActiveDragMode == ETLLRN_ModelingSelectionInteraction_DragMode::RectangleMarqueeInteraction)
	{
...
void UTLLRN_ModelingSelectionInteraction::OnUpdateModifierState(int ModifierID, bool bIsOn)
{
...
void UTLLRN_ModelingSelectionInteraction::ComputeSceneHits(const FInputDeviceRay& ClickPos,
...
FInputRayHit UTLLRN_ModelingSelectionInteraction::IsHitByClick(const FInputDeviceRay& ClickPos)
{
...
void UTLLRN_ModelingSelectionInteraction::OnClicked(const FInputDeviceRay& ClickPos)
{
...
FGeometrySelectionUpdateConfig UTLLRN_ModelingSelectionInteraction::GetActiveSelectionUpdateConfig() const
{
...
FInputRayHit UTLLRN_ModelingSelectionInteraction::BeginHoverSequenceHitTest(const FInputDeviceRay& PressPos)
{
	if ((SelectionManager->GetMeshTopologyMode() == UGeometrySelectionManager::EMeshTopologyMode::None)
		|| (CanChangeSelectionCallback() == false)
...
void UTLLRN_ModelingSelectionInteraction::OnBeginHover(const FInputDeviceRay& DevicePos)
{
	SelectionManager->UpdateSelectionPreviewViaRaycast(DevicePos.WorldRay);
}

bool UTLLRN_ModelingSelectionInteraction::OnUpdateHover(const FInputDeviceRay& DevicePos)
{
	return SelectionManager->UpdateSelectionPreviewViaRaycast(DevicePos.WorldRay);
}

void UTLLRN_ModelingSelectionInteraction::OnEndHover()
{
...
void UTLLRN_ModelingSelectionInteraction::UpdateGizmoOnSelectionChange()
{
	...
	else
	{
		...
		if (LocalFrameMode == ETLLRN_ModelingSelectionInteraction_LocalFrameMode::FromGeometry)
		{
...
void UTLLRN_ModelingSelectionInteraction::OnSelectionManager_SelectionModified()
{
	UpdateGizmoOnSelectionChange();
}
...
void UTLLRN_ModelingSelectionInteraction::OnBeginGizmoTransform(UTransformProxy* Proxy)
{
...
void UTLLRN_ModelingSelectionInteraction::OnEndGizmoTransform(UTransformProxy* Proxy)
{
...
void UTLLRN_ModelingSelectionInteraction::OnGizmoTransformChanged(UTransformProxy* Proxy, FTransform Transform)
{
	if (bInActiveTransform)
	{
...
void UTLLRN_ModelingSelectionInteraction::ApplyPendingTransformInteractions()
{
...
void UTLLRN_ModelingSelectionInteraction::OnMarqueeRectangleFinished(const FCameraRectangle& Rectangle, bool bCancelled)
{
