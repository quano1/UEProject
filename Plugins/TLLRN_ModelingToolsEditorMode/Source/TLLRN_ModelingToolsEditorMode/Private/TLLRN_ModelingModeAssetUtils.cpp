...
#define LOCTEXT_NAMESPACE "TLLRN_ModelingModeAssetUtils"
...
FString UE::Modeling::GetNewAssetPathName(const FString& BaseNameIn, const UWorld* TargetWorld, FString SuggestedFolder)
{
	...
	const ETLLRN_ModelingModeAssetGenerationBehavior AutoGenMode = Settings->GetAssetGenerationMode();
	...
	else
	{
		...
		if (Settings->GetAssetGenerationLocation() == ETLLRN_ModelingModeAssetGenerationLocation::AutoGeneratedWorldRelativeAssetPath)
		{
		...
		if (Settings->GetAssetGenerationLocation() == ETLLRN_ModelingModeAssetGenerationLocation::CurrentAssetBrowserPathIfAvailable)
		{
	...
	if (AutoGenMode == ETLLRN_ModelingModeAssetGenerationBehavior::InteractivePromptToSave || bFallBackToInteractiveSave)
	{
...
{
	const UTLLRN_ModelingToolsEditorModeSettings* Settings = GetDefault<UTLLRN_ModelingToolsEditorModeSettings>();
	ETLLRN_ModelingModeAssetGenerationBehavior AutoGenMode = Settings->GetAssetGenerationMode();
	...
	if (AutoGenMode == ETLLRN_ModelingModeAssetGenerationBehavior::AutoGenerateAndAutosave
		 || AutoGenMode == ETLLRN_ModelingModeAssetGenerationBehavior::InteractivePromptToSave)
	{
		AutoSaveAsset(Asset);
	}
	else if (AutoGenMode == ETLLRN_ModelingModeAssetGenerationBehavior::AutoGenerateButDoNotAutosave)
	{
		Asset->MarkPackageDirty();
		FAssetRegistryModule::AssetCreated(Asset);
	}
