...
#define LOCTEXT_NAMESPACE "TLLRN_ModelingToolsManagerCommands"



FTLLRN_ModelingToolsManagerCommands::FTLLRN_ModelingToolsManagerCommands() :
	TCommands<FTLLRN_ModelingToolsManagerCommands>(
		"TLLRN_ModelingToolsManagerCommands", // Context name for fast lookup
		NSLOCTEXT("Contexts", "TLLRN_ModelingToolsToolCommands", "Modeling Mode - Tools"), // Localized context name for displaying
		NAME_None, // Parent
		FTLLRN_ModelingToolsEditorModeStyle::Get()->GetStyleSetName() // Icon Style Set
		)
{
}
...
TSharedPtr<FUICommandInfo> FTLLRN_ModelingToolsManagerCommands::FindToolByName(FString Name, bool& bFound) const
{
	bFound = false;
...
FText FTLLRN_ModelingToolsManagerCommands::GetCommandLabel(TSharedPtr<const FUICommandInfo> Command, bool bShortName) const
{
...
void FTLLRN_ModelingToolsManagerCommands::RegisterCommands()
{
...
TSharedPtr<FUICommandInfo> FTLLRN_ModelingToolsManagerCommands::RegisterExtensionPaletteCommand(
	FName Name,
	const FText& Label,
	const FText& Tooltip,
	const FSlateIcon& Icon)
{
	if (Instance.IsValid())
	{
		TSharedPtr<FTLLRN_ModelingToolsManagerCommands> Commands = Instance.Pin();
