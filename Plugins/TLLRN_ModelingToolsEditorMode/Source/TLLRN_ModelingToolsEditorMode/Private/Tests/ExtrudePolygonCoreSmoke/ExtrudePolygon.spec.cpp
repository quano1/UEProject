...
void FExtrudePolygonSpec::Define()
{
	Describe("ExtrudePolygon", [this]()
	{
		BeforeEach([this]()
		{
			...
			GLevelEditorModeTools().ActivateMode(UTLLRN_ModelingToolsEditorMode::EM_TLLRN_ModelingToolsEditorModeId);
			EditorMode = GLevelEditorModeTools().GetActiveScriptableMode(UTLLRN_ModelingToolsEditorMode::EM_TLLRN_ModelingToolsEditorModeId);
			if (EditorMode)
			{
