...
#define LOCTEXT_NAMESPACE "TLLRN_ModelingToolsBrushSizeCustomization"



TSharedRef<IPropertyTypeCustomization> FTLLRN_ModelingToolsBrushSizeCustomization::MakeInstance()
{
	return MakeShareable(new FTLLRN_ModelingToolsBrushSizeCustomization);
}

void FTLLRN_ModelingToolsBrushSizeCustomization::CustomizeHeader(TSharedRef<IPropertyHandle> StructPropertyHandle, FDetailWidgetRow& HeaderRow, IPropertyTypeCustomizationUtils& StructCustomizationUtils)
{
...
void FTLLRN_ModelingToolsBrushSizeCustomization::CustomizeChildren(TSharedRef<IPropertyHandle> StructPropertyHandle, class IDetailChildrenBuilder& ChildBuilder, IPropertyTypeCustomizationUtils& StructCustomizationUtils)
{
}
