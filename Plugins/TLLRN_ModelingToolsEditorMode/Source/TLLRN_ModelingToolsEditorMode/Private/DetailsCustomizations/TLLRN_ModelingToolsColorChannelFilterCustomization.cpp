...
#define LOCTEXT_NAMESPACE "TLLRN_ModelingToolsColorChannelFilterCustomization"


TSharedRef<IPropertyTypeCustomization> FTLLRN_ModelingToolsColorChannelFilterCustomization::MakeInstance()
{
	return MakeShareable(new FTLLRN_ModelingToolsColorChannelFilterCustomization);
}

void FTLLRN_ModelingToolsColorChannelFilterCustomization::CustomizeHeader(TSharedRef<IPropertyHandle> StructPropertyHandle, FDetailWidgetRow& HeaderRow, IPropertyTypeCustomizationUtils& StructCustomizationUtils)
{
...
void FTLLRN_ModelingToolsColorChannelFilterCustomization::CustomizeChildren(TSharedRef<IPropertyHandle> StructPropertyHandle, class IDetailChildrenBuilder& ChildBuilder, IPropertyTypeCustomizationUtils& StructCustomizationUtils)
{
}
