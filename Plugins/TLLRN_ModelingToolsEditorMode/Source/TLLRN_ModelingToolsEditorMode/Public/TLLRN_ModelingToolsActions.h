...
class FTLLRN_ModelingModeActionCommands : public TCommands<FTLLRN_ModelingModeActionCommands>
{
public:
	FTLLRN_ModelingModeActionCommands();
	...
	static void RegisterCommandBindings(TSharedPtr<FUICommandList> UICommandList, TFunction<void(ETLLRN_ModelingModeActionCommands)> OnCommandExecuted);
