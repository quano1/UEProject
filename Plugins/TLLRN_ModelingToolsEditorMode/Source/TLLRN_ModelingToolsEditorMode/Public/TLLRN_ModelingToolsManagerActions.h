 ...
 */
class TLLRN_MODELINGTOOLSEDITORMODE_API FTLLRN_ModelingToolsManagerCommands : public TCommands<FTLLRN_ModelingToolsManagerCommands>
{
public:
	FTLLRN_ModelingToolsManagerCommands();
...
public:
	...
	//
	// These commands are set up to launch registered Tools via the ToolManager in TLLRN_ModelingToolsEditorMode.cpp
	//
	...
	// For connecting TLLRN_ModelingMode with UVEditor plugin
