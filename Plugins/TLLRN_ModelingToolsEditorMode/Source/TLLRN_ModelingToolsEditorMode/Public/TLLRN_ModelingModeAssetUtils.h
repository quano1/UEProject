...
// See TLLRN_ModelingToolsEditorMode for usage.
//
 ...
 */
TLLRN_MODELINGTOOLSEDITORMODE_API FString GetNewAssetPathName(const FString& BaseName, const UWorld* TargetWorld, FString SuggestedFolder);
 ...
 */
TLLRN_MODELINGTOOLSEDITORMODE_API FString GetWorldRelativeAssetRootPath(const UWorld* World);

/**
 * Determines the global asset root path.
 * @return Global asset root path.
 */
TLLRN_MODELINGTOOLSEDITORMODE_API FString GetGlobalAssetRootPath();
 ...
 */
TLLRN_MODELINGTOOLSEDITORMODE_API void OnNewAssetCreated(UObject* Asset);
 ...
 */
TLLRN_MODELINGTOOLSEDITORMODE_API bool AutoSaveAsset(UObject* Asset);
