...
#include "TLLRN_ModelingToolsEditorModeSettings.generated.h"
...
UENUM()
enum class ETLLRN_ModelingModeDefaultMeshObjectType
{
...
UENUM()
enum class ETLLRN_ModelingModeAssetGenerationBehavior
{
...
UENUM()
enum class ETLLRN_ModelingModeAssetGenerationLocation
{
...
class TLLRN_MODELINGTOOLSEDITORMODE_API UTLLRN_ModelingToolsEditorModeSettings : public UDeveloperSettings
{
	GENERATED_BODY()
...
public:
	...
	virtual FName GetSectionName() const override { return FName("TLLRN_ModelingMode"); }
...
protected:
	...
	UPROPERTY(config, EditAnywhere, Category = "Modeling Mode|Generated Assets")
	ETLLRN_ModelingModeAssetGenerationBehavior AssetGenerationMode = ETLLRN_ModelingModeAssetGenerationBehavior::AutoGenerateButDoNotAutosave;

public:

	ETLLRN_ModelingModeAssetGenerationLocation GetAssetGenerationLocation() const
	{
		return bRestrictiveMode
				   ? ETLLRN_ModelingModeAssetGenerationLocation::AutoGeneratedGlobalAssetPath
				   : AssetGenerationLocation;
	}

	void SetAssetGenerationLocation(const ETLLRN_ModelingModeAssetGenerationLocation Location)
	{
		AssetGenerationLocation = Location;
	}

	ETLLRN_ModelingModeAssetGenerationBehavior GetAssetGenerationMode() const
	{
		return bRestrictiveMode
					? ETLLRN_ModelingModeAssetGenerationBehavior::AutoGenerateButDoNotAutosave
					: AssetGenerationMode;
	}

	void SetAssetGenerationMode(const ETLLRN_ModelingModeAssetGenerationBehavior Mode)
	{
	...
	ETLLRN_ModelingModeDefaultMeshObjectType DefaultMeshObjectType = ETLLRN_ModelingModeDefaultMeshObjectType::StaticMeshAsset;
	...
	DECLARE_MULTICAST_DELEGATE_TwoParams(UTLLRN_ModelingToolsEditorModeSettingsModified, UObject*, FProperty*);
	UTLLRN_ModelingToolsEditorModeSettingsModified OnModified;
 ...
 */
USTRUCT()
struct FTLLRN_ModelingModeCustomSectionColor
{
	GENERATED_BODY()
 ...
 */
USTRUCT()
struct FTLLRN_ModelingModeCustomToolColor
{
	GENERATED_BODY()
 ...
 */
USTRUCT()
struct FTLLRN_ModelingModeAssetCollectionSet
{
	GENERATED_BODY()
...
UCLASS(config=Editor)
class TLLRN_MODELINGTOOLSEDITORMODE_API UTLLRN_ModelingToolsModeCustomizationSettings : public UDeveloperSettings
{
	GENERATED_BODY()
...
public:
	...
	virtual FName GetSectionName() const { return FName("TLLRN_ModelingMode"); }
...
public:
	...
	UPROPERTY(config, EditAnywhere, Category = "Modeling Mode|UI Customization")
	TArray<FTLLRN_ModelingModeCustomSectionColor> SectionColors;
	 ...
	 */
	UPROPERTY(config, EditAnywhere, Category = "Modeling Mode|UI Customization")
	TArray<FTLLRN_ModelingModeCustomToolColor> ToolColors;
	...
	TArray<FTLLRN_ModelingModeAssetCollectionSet> BrushAlphaSets;
