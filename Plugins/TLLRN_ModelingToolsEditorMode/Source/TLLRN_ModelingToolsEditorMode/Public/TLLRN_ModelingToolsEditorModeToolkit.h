...
#define LOCTEXT_NAMESPACE "TLLRN_ModelingToolsEditorModeToolkit"
...
class FTLLRN_ModelingToolsEditorModeToolkit : public FModeToolkit
{
public:

	FTLLRN_ModelingToolsEditorModeToolkit();
	~FTLLRN_ModelingToolsEditorModeToolkit();
	...
	// in a non-member function in TLLRN_ModelingModeToolkit_Toolbars.cpp
...
private:
	...
	TSharedRef<SWidget> MakeMenu_TLLRN_ModelingModeConfigSettings();
