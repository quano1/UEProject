...
#include "TLLRN_ModelingSelectionInteraction.generated.h"
...
UENUM()
enum class ETLLRN_ModelingSelectionInteraction_DragMode : uint8
{
	NoDragInteraction = 0,
	PathInteraction = 1,
...
UENUM()
enum class ETLLRN_ModelingSelectionInteraction_LocalFrameMode : uint8
{
	FromGeometry = 0,
	FromObject = 1,
};
...
/**
 * UTLLRN_ModelingSelectionInteraction provides element-level selection behavior (ie mesh triangles/edges/vertices)
 ...
 * 
 * In addition to handling selection/deselection behaviors based on user input, the UTLLRN_ModelingSelectionInteraction
 ...
 */
UCLASS()
class UTLLRN_ModelingSelectionInteraction : public UObject, public IInputBehaviorSource, public IClickBehaviorTarget, public IHoverBehaviorTarget
{
	GENERATED_BODY()
...
public:
	...
	ETLLRN_ModelingSelectionInteraction_DragMode GetActiveDragMode() const { return ActiveDragMode; }
	void SetActiveDragMode(ETLLRN_ModelingSelectionInteraction_DragMode NewMode);
	...
	//
	ETLLRN_ModelingSelectionInteraction_LocalFrameMode GetLocalFrameMode() const { return LocalFrameMode; }
	void SetLocalFrameMode(ETLLRN_ModelingSelectionInteraction_LocalFrameMode NewLocalFrameMode);
...
protected:
	ETLLRN_ModelingSelectionInteraction_DragMode ActiveDragMode = ETLLRN_ModelingSelectionInteraction_DragMode::NoDragInteraction;
	void UpdateActiveDragMode();

	ETLLRN_ModelingSelectionInteraction_LocalFrameMode LocalFrameMode = ETLLRN_ModelingSelectionInteraction_LocalFrameMode::FromGeometry;
...
class UPathSelectionInteraction : public UObject, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
public:
	void Setup(UTLLRN_ModelingSelectionInteraction* SelectionInteraction);

protected:
	UPROPERTY()
	TWeakObjectPtr<UTLLRN_ModelingSelectionInteraction> SelectionInteraction = nullptr;
